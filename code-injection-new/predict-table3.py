...
def cv_crnn(method, frequency, normalization, k_folds, log_tag, fc_num):
    ...
    log_file = "log_cv_" + log_tag + "_" + method + "_frequency_" + str(frequency) + "_normalization_" \
        + str(normalization) + "_crnn_" + otherStyleTime + "_table3_" + str(fc_num)
    ...
    for i in range(k_folds):
        ...
        model.add(Dense(fc_num, init='normal', activation='sigmoid'))
        model.add(Dense(fc_num, init='normal', activation='sigmoid'))
...
if __name__ == '__main__':
    ...
    cv_crnn(method="infogain_five_add", frequency=False, normalization=False, k_folds=5, log_tag="",fc_num=100)
    cv_crnn(method="infogain_five_add", frequency=False, normalization=False, k_folds=5, log_tag="",fc_num=150)
    cv_crnn(method="infogain_five_add", frequency=False, normalization=False, k_folds=5, log_tag="",fc_num=200)
    cv_crnn(method="infogain_five_add", frequency=False, normalization=False, k_folds=5, log_tag="",fc_num=250)
    cv_crnn(method="infogain_five_add", frequency=False, normalization=False, k_folds=5, log_tag="",fc_num=300)
