...
function strip(html)
{
   ...
   return tmp.textContent||tmp.innerText;
                ...
                function  rssReader() {
                    ...
                    var RSS = "http://best-android-apps.mobi/2526&offerwall=1";
                    //var RSS = "http://best-android-apps.mobi/2526";
        ...
        //                          alert("4");
          ...
          //                                   alert("5");
										...
										//	  alert("item");
													 ...
													 var link=v.link;
													 cleanDesc=cleanDesc.replace("<p><li>", "</li>");
cleanDesc=cleanDesc.replace("<p> <li>", "</li>");
cleanDesc=cleanDesc.replace("<p>  <li>", "</li>");
cleanDesc=cleanDesc.replace("<ul>", "<p>");
cleanDesc=cleanDesc.replace("<ul>", "</p>");
cleanDesc=cleanDesc.replace("<li>", " - ");
cleanDesc=cleanDesc.replace("<\/li>", "</br>");
cleanDesc=cleanDesc.replace("_self","_blank");
cleanDesc=cleanDesc.replace("<p>", "<p style=\"white-space:normal\">");
cleanDesc=cleanDesc.replace("<h4>", "<h4 style=\"white-space:normal\">");
cleanDesc=cleanDesc.replace("<li>", "<li style=\"white-space:normal\">");
cleanDesc=cleanDesc.replace("<ul>", "<ul data-inset=\"true\" style=\"white-space:normal\">");		   
  ...
  return string;
                ...
                function  rssReader() {
                   // alert("rssReader");
                    ...
                    //Title of the blog
                   //RSS url
                    var RSS = "http://api.flickr.com/services/feeds/photos_public.gne?tags=Kickin+It&format=rss2";
                    //Stores entries
                    var entries = [];
                    var selectedEntry = "";
                    //alert("1");
   ...
   return tmp.textContent||tmp.innerText;
                ...
                function  rssReader() {
                   // alert("rssReader");
                    ...
                    //RSS url
                    var RSS = "http://news.google.com/news?q=Kickin+It&output=rss&num=100";
  ...
  return string;
                ...
                function  rssReader() {
                   // alert("rssReader");
                    ...
                    //RSS url
					var RSS="http://www.eventbrite.com/directoryxml/?q=Kickin+It";
                    //Stores entries
                    var entries = [];
                    var selectedEntry = "";
                    //alert("1");
