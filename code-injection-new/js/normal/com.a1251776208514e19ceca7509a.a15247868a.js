    		...
    		$(document).ready(function() {
                $("a.shareButton").click(function() {
        		    window.plugins.socialsharing.share("Share LSU Football", null, null, "https://play.google.com/store/apps/details?id=com.a1251776208514e19ceca7509a.a15247868a");
    			    return false;
                });
            });
				 ...
				 function onDeviceReadyAdMob() {
				     admob.setOptions( {
                         publisherId: 'ca-app-pub-6101814109861246/8846833642',
                         interstitialAdId: 'ca-app-pub-6101814109861246/3747784045',
				...
				function initFancyPush() {
    				...
    				pushNotification.registerDevice({alert:true, badge:true, sound:true, appid:"312C6BA5-992B-45DA-9CAC-CD8BAC2FF34C", appname:"LSU Football", gcmprojectid:"760995130526"},function(status) {},function(status) {});
				}
...
document.addEventListener("deviceready",onDeviceReadyUpsell,false);
        ...
        $(document).ready(function() {
            $.mobile.loading( "show", {
				...
				$("#rss-content").rssfeed("https://news.google.com/news?q=lsu+football&output=rss&num=100", zRssOptions,
	                               function() {
	                                   $.mobile.loading("hide");
						               resizeRssImages();
	                               }
...
function onRateReminderConfirm(buttonIndex) {
    ...
    switch(btn) {
        case 1:
            //open page
            setAllDone = true;window.open("market://details?id=com.a1251776208514e19ceca7509a.a15247868a", "_system", "location=yes");
            break;
        case 2:
            //grab next reminder
