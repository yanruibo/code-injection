        ...
        items:[
...

            {
                ...
                items:[
                    ...
                    { xtype:'button', text:"Depot d'annonce", itemId:'buttonRequestAdDeposit', cls:['agencypagebutton','phone'] },
                        ...
                        items:[
                            ...
                            },
                            {
                                ...
                                items:[
                                    ...
                                    {xtype:'button',text:"D&eacute;pôt d'annonce", itemId:'buttonRequestAdDeposit' ,cls:['buttongreen','tablet']},
        ...
        items:[
    	    {
                ...
                items:[
	                ...
	                {xtype:'button',cls:['toolbar_button','tablet'] ,itemId:'searchresultslistbuttonsave', text:'Ajouter la recherche à mes favoris' ,align:'right'},
                ],
...
Ext.application({
    ...
    registerPushAndroid: function(){
        ...
        MyApp.myapp = this;
        window.plugins.C2DM.register("acheterlouer.thiriet@gmail.com",    // this is the SENDER GOOGLE ACCOUNT ID
