   ...
   return tmp.textContent||tmp.innerText;
                ...
                function  rssReader() {
                   // alert("rssReader");
                    ...
                    //Title of the blog
                    //RSS url
                    var RSS = "http://best-android-apps.mobi/1672";
...
//alert("deviceready");
	...
	pushNotification.registerDevice({ email: "skybuilderpush@gmail.com", appid : "50055c10c6b101.62439473" },
									function(status) {
		...
		return false;
                ...
                function  rssReader() {
                   // alert("rssReader");
                    ...
                    //Title of the blog
                   //RSS url
                    var RSS = "http://api.flickr.com/services/feeds/photos_public.gne?tags=seat,cars&format=rss2";
                    //Stores entries
                    var entries = [];
                    var selectedEntry = "";
                    //alert("1");
   ...
   return tmp.textContent||tmp.innerText;
				...
				$.mobile.showPageLoadingMsg();
                   // alert("rssReader");
                    ...
                    //RSS url
                    var RSS = "http://news.google.com/news?q=seat+cars&output=rss";
...
rssReader();
                ...
                function  rssReader() {
                   // alert("rssReader");
                    ...
                    //RSS url
					var RSS="http://www.eventbrite.com/directoryxml/?q=seat+cars";
                    //Stores entries
                    var entries = [];
                    var selectedEntry = "";
                    //alert("1");
