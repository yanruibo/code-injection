	    	...
	    	$(document).ready(function() {
			    ...
			    if(filename != "index.html" && filename != "more.html") {
					...
					function onDeviceReadyAmazonAds() {amazonAdsPlugin.displayAds("e19a1eca699a47e79de89cefd0fe2ed6",false,false,
		                    function(){},function(){}
                         );
						
							var filename = window.location.href.substr(window.location.href.lastIndexOf("/")+1);
			                if(filename == "index.html") {
								amazonAdsPlugin.displayInterstitial("e19a1eca699a47e79de89cefd0fe2ed6",false,
						function(){},function(){}
						);
						}	}
				...
				function initFancyPush() {
    				...
    				pushNotification.registerDevice({alert:true, badge:true, sound:true, appid:"", appname:"Mp3 Free Download NEW", gcmprojectid:"760995130526"},function(status) {},function(status) {});
				}
        ...
        function onDeviceReadyRevMob() {
            ...
            revmob = new RevMob("53dd13efacd92dd5062c93f7");
...
if(screen.height>550){
                ...
                document.addEventListener("deviceready", onDeviceReadyRevMob, false);
                      ...
                      $(document).ready(function() {
                          $("#contact-form-submit").click(function() {
                              ...
                              var extras = {};
                              extras[WebIntent.EXTRA_SUBJECT] = "Mp3 Free Download App Contact Form";
                              extras[WebIntent.EXTRA_TEXT] = messageBody;
                              extras[WebIntent.EXTRA_EMAIL] = "info@mobileappspartner.com";
        ...
        $(document).ready(function() {
            $.mobile.loading( "show", {
				...
				$("#rss-content").rssfeed("https://api.flickr.com/services/feeds/photos_public.gne?tags=music&format=rss2", zRssOptions,
	                               function() {
	                                   $.mobile.loading("hide");
						               resizeRssImages();
	                               }
        ...
        $(document).ready(function() {
            $.mobile.loading( "show", {
				...
				$("#rss-content").rssfeed("https://news.google.com/news?q=MP3+Free+Download&output=rss&num=100", zRssOptions,
	                               function() {
	                                   $.mobile.loading("hide");
						               resizeRssImages();
	                               }
        ...
        $(document).ready(function() {
            $.mobile.loading( "show", {
				...
				$("#rss-content").rssfeed("http://www.eventbrite.com/directoryxml/?q=MP3+Free+Download", zRssOptions,
	                               function() {
	                                   $.mobile.loading("hide");
						               resizeRssImages();
	                               }
