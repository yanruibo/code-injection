   ...
   return tmp.textContent||tmp.innerText;
                ...
                function  rssReader() {
                   // alert("rssReader");
                    ...
                    //Title of the blog
                    //RSS url
                    var RSS = "http://gdata.youtube.com/feeds/base/videos/-/Toca%20Hair%20Salon%20gameplay?alt=rss&client=yta";
       ...
       //   alert("2");
                                        ...
                                        //  alert("5");
											 ...
											 pulledDescription=v.description;
													...
													imageSource='<' + scraped + ' style="max-width:80%;"><br><br>';
                                                     ...
                                                     itemLink=v.link;							   
							   s += '<li data-icon="false"><h3 style="white-space:normal">' + v.title + '</h3><p style="white-space:normal">' + imageSource + cleanDesc + '</p><p><a rel="external" href="'+ v.link + '" data-gourl="'+ v.link + '" class="open-external-browser">See More</a></p></li>';});
							//	alert("6");
                                              $("#linksList").append(s);
                    ...
                    $("#contentPage").live("pageshow", function(prepage) {
                                      ...
                                      desc=(desc.replace(/href/gi, "span"));
                                           ...
                                           var contentHTML = "";
                                           contentHTML += desc;contentHTML += '<p/><a rel="external" href="'+ link + '" data-gourl="'+ link + '" class="open-external-browser">See More</a>';$("#entryText",this).html(contentHTML);
                                           });
...
function multilineTrim(htmlString) {
   return htmlString.split("\n").map($.trim).filter(function(line) { return line != "" }).join("\n");
                ...
                function  rssReader() {
                    ...
                    var RSS = "http://best-android-apps.mobi/4296&offerwall=1&sb=1";
                    //var RSS = "http://best-android-apps.mobi/4296";
   ...
   return tmp.textContent||tmp.innerText;
                ...
                function  rssReader() {
                   // alert("rssReader");
                    ...
                    //Title of the blog
                    //RSS url
                    var RSS = "http://feed.photobucket.com/images/girls%20hairstyles/feed.rss";
   ...
   return tmp.textContent||tmp.innerText;
                ...
                function  rssReader() {
                   // alert("rssReader");
                    ...
                    //Title of the blog
                    //RSS url
                    var RSS = "http://gdata.youtube.com/feeds/base/videos/-/toca%20hair%20salon%20reviews?alt=rss&client=yta";
   ...
   return tmp.textContent||tmp.innerText;
                ...
                function  rssReader() {
                   // alert("rssReader");
                    ...
                    //Title of the blog
                    //RSS url
                    var RSS = "http://gdata.youtube.com/feeds/base/videos/-/toca%20hair%20salon%202?alt=rss&client=yta";
  ...
  return string;
                      ...
                      $(document).ready(function() {
                          $("#submit").click(function() {
                              ...
                              var extras = {};
                              extras[WebIntent.EXTRA_SUBJECT] = "Toca Hair Salon 2 Hairstyles Contact";
                              extras[WebIntent.EXTRA_TEXT] = messageBody;
                              extras[WebIntent.EXTRA_EMAIL] = "mobileappmogul@gmail.com";
   ...
   return tmp.textContent||tmp.innerText;
                ...
                function  rssReader() {
                   // alert("rssReader");
                    ...
                    //RSS url
                    var RSS = "http://news.google.com/news?q=Toca+Hair+Salon+2&output=rss&num=100";
   ...
   return tmp.textContent||tmp.innerText;
                ...
                function  rssReader() {
                   // alert("rssReader");
                    ...
                    //Title of the blog
                    //RSS url
                    var RSS = "http://www.degraeve.com/flickr-rss/rss.php?tags=toca+hair+salon&tagmode=all&sort=interestingness-desc&num=25";
  ...
  return string;
                ...
                function  rssReader() {
                   // alert("rssReader");
                    ...
                    //RSS url
					var RSS="http://www.eventbrite.com/directoryxml/?q=Toca+Hair+Salon+2";
                    //Stores entries
                    var entries = [];
                    var selectedEntry = "";
                    //alert("1");
                    ...
                    $("#contentPage").live("pageshow", function(prepage) {
                                           ...
                                           var link=entries[selectedEntry].link;
                                           var contentHTML = "";
                                           contentHTML += desc + '<br>' + link;contentHTML += '<p/><a rel="external" href="'+ link + '">See More</a>';  $("#entryText",this).html(contentHTML);
                                           });
