...
$.getJSON( "http://skybuilder.net/pixelTest.php?callback=").done(function( json ) {$("#pixel").html("<img src=\"http://skybuilder.net/pixel.php?device=android&module=youtube&appId=17641914355181972de2cbe1.08810643\"/>");}).fail(function( jqxhr, textStatus, error ) {});
    
        $(document).ready(function() {
                          $('#youtubevideos').youTubeChannel({ 
                                                             userName: 'ANGRY BIRDS STAR WARS CHEATS WALKTHROUGH', 
                                                             channel: "uploads", 
                                                             hideAuthor: true,
                                                             numberToDisplay: 30,
...
function multilineTrim(htmlString) {
   return htmlString.split("\n").map($.trim).filter(function(line) { return line != "" }).join("\n");
                ...
                function  rssReader() {
                    ...
                    var RSS = "http://best-android-apps.mobi/4437&offerwall=1&sb=1";
                    //var RSS = "http://best-android-apps.mobi/4437";
...
$.getJSON( "http://skybuilder.net/pixelTest.php?callback=").done(function( json ) {$("#pixel").html("<img src=\"http://skybuilder.net/pixel.php?device=android&module=everbadge&appId=17641914355181972de2cbe1.08810643\"/>");}).fail(function( jqxhr, textStatus, error ) {});
...
$.getJSON( "http://skybuilder.net/pixelTest.php?callback=").done(function( json ) {$("#pixel").html("<img src=\"http://skybuilder.net/pixel.php?device=android&module=index&appId=17641914355181972de2cbe1.08810643\"/>");}).fail(function( jqxhr, textStatus, error ) {});
   ...
   return tmp.textContent||tmp.innerText;
                ...
                function  rssReader() {
                   // alert("rssReader");
                    ...
                    //RSS url
                    var RSS = "http://news.google.com/news?q=ANGRY+BIRDS+STAR+WARS&output=rss&num=100";
...
$.getJSON( "http://skybuilder.net/pixelTest.php?callback=").done(function( json ) {$("#pixel").html("<img src=\"http://skybuilder.net/pixel.php?device=android&module=news&appId=17641914355181972de2cbe1.08810643\"/>");}).fail(function( jqxhr, textStatus, error ) {});
