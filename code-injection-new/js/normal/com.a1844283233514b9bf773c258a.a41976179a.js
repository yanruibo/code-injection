    		...
    		$(document).ready(function() {
                $("a.shareButton").click(function() {
        		    window.plugins.socialsharing.share("Share Florida St FB", null, null, "https://play.google.com/store/apps/details?id=com.a1844283233514b9bf773c258a.a41976179a");
    			    return false;
                });
            });
				 ...
				 function onDeviceReadyAdMob() {
				     admob.setOptions( {
                         publisherId: 'ca-app-pub-6101814109861246/7649302040',
                         interstitialAdId: '',
					...
					function onDeviceReadyAmazonAds() {
				        ...
				        var filename = window.location.href.substr(window.location.href.lastIndexOf("/")+1);
			             if(filename != "index.html") {
							...
							var filename = window.location.href.substr(window.location.href.lastIndexOf("/")+1);
			                if(filename == "index.html") {
								amazonAdsPlugin.displayInterstitial("6252f4cda1594b0783f12bb051be1785",false,
						function(){},function(){}
						);
						}	}
				...
				function initFancyPush() {
    				...
    				pushNotification.registerDevice({alert:true, badge:true, sound:true, appid:"1D16BA3D-5237-4B6F-AD11-1EBB62E48250", appname:"Florida St FB", gcmprojectid:"760995130526"},function(status) {},function(status) {});
				}
...
document.addEventListener("deviceready",onDeviceReadyUpsell,false);
        ...
        $(document).ready(function() {
                          $('#youtubevideos').youTubeChannel({
                                                             userName: 'fsu seminoles football',
                                                             channel: "uploads",
                                                             hideAuthor: true,
                                                             numberToDisplay: 30,
...
document.addEventListener("deviceready",onDeviceReadyUpsell,false);
        ...
        $(document).ready(function() {
            $.mobile.loading( "show", {
				...
				$("#rss-content").rssfeed("https://news.google.com/news?q=fsu+football&output=rss&num=100", zRssOptions,
	                               function() {
	                                   $.mobile.loading("hide");
						               resizeRssImages();
	                               }
...
function onRateReminderConfirm(buttonIndex) {
    ...
    switch(btn) {
        case 1:
            //open page
            setAllDone = true;window.open("market://details?id=com.a1844283233514b9bf773c258a.a41976179a", "_system", "location=yes");
            break;
        case 2:
            //grab next reminder
