    		...
    		$(document).ready(function() {
                $("#shareButtonLink").click(function() {
                    window.plugins.share.show({
                        subject: "Share Malaysia Football Team apps",
                        text: "https://play.google.com/store/apps/details?id=com.a2092545256522ec1ca47bfd8a.a32393671a"},
   ...
   return tmp.textContent||tmp.innerText;
                ...
                function  rssReader() {
                   // alert("rssReader");
                    ...
                    //RSS url
                    var RSS = "http://news.google.com/news?q=MALAYSIA+FOOTBALL+TEAM+&output=rss&num=100";
