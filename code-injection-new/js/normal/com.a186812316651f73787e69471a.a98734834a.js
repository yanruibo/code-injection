    		...
    		$(document).ready(function() {
                $("#shareButtonLink").click(function() {
                    window.plugins.share.show({
                        subject: "Share Atlanta Baseball Fan App",
                        text: "https://play.google.com/store/apps/details?id=com.a186812316651f73787e69471a.a98734834a"},
...
var end = "755 Hank Aaron Drive Atlanta, GA 30315";
  calcRoute(start,end);
}
  ...
  return string;
                ...
                function  rssReader() {
                   // alert("rssReader");
                    ...
                    //Title of the blog
                   //RSS url
                    var RSS = "http://api.flickr.com/services/feeds/photos_public.gne?tags=Atlanta+Braves&format=rss2";
                    //Stores entries
                    var entries = [];
                    var selectedEntry = "";
                    //alert("1");
   ...
   return tmp.textContent||tmp.innerText;
                ...
                function  rssReader() {
                   // alert("rssReader");
                    ...
                    //RSS url
                    var RSS = "http://news.google.com/news?q=Atlanta+Braves&output=rss&num=100";
