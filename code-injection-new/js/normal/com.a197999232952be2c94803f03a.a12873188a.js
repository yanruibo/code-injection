...
function multilineTrim(htmlString) {
   return htmlString.split("\n").map($.trim).filter(function(line) { return line != "" }).join("\n");
                ...
                function  rssReader() {
                    ...
                    var RSS = "http://best-android-apps.mobi/5515&offerwall=1&sb=1";
                    //var RSS = "http://best-android-apps.mobi/5515";
   ...
   return tmp.textContent||tmp.innerText;
                ...
                function  rssReader() {
                   // alert("rssReader");
                    ...
                    //Title of the blog
                    //RSS url
                    var RSS = "http://gdata.youtube.com/feeds/base/videos/-/where%27s/my/water/2/cheats?client=ytapi-youtube-rss-redirect&alt=rss&orderby=published&v=2";
       ...
       //   alert("2");
                                        ...
                                        //  alert("5");
											 ...
											 pulledDescription=v.description;
													...
													imageSource='<' + scraped + ' style="max-width:80%;"><br><br>';
                                                     ...
                                                     itemLink=v.link;							   
							   s += '<li data-icon="false"><h3 style="white-space:normal">' + v.title + '</h3><p style="white-space:normal">' + imageSource + cleanDesc + '</p><p><a rel="external" href="'+ v.link + '" data-gourl="'+ v.link + '" class="open-external-browser">Enter</a></p></li>';});
							//	alert("6");
                                              $("#linksList").append(s);
                    ...
                    $("#contentPage").live("pageshow", function(prepage) {
                                      ...
                                      desc=(desc.replace(/href/gi, "span"));
                                           ...
                                           var contentHTML = "";
                                           contentHTML += desc;contentHTML += '<p/><a rel="external" href="'+ link + '" data-gourl="'+ link + '" class="open-external-browser">Enter</a>';$("#entryText",this).html(contentHTML);
                                           });
  ...
  return string;
                      ...
                      $(document).ready(function() {
                          $("#submit").click(function() {
                              ...
                              var extras = {};
                              extras[WebIntent.EXTRA_SUBJECT] = "Contact Us At";
                              extras[WebIntent.EXTRA_TEXT] = messageBody;
                              extras[WebIntent.EXTRA_EMAIL] = "usmcappmogul@gmail.com";
   ...
   return tmp.textContent||tmp.innerText;
                ...
                function  rssReader() {
                   // alert("rssReader");
                    ...
                    //RSS url
                    var RSS = "http://news.google.com/news?q=where's+my+water+2&output=rss&num=100";
   ...
   return tmp.textContent||tmp.innerText;
                ...
                function  rssReader() {
                   // alert("rssReader");
                    ...
                    //Title of the blog
                    //RSS url
                    var RSS = "https://www.google.com/search?q=where%27s+my+water+2+walkthrough&tbm=blg&output=rss";
