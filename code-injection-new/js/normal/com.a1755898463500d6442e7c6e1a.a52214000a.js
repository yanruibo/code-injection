            ...
            document.addEventListener("deviceready", userLoc, false);
             ...
             userLoc();
                ...
                function  staticLoc() {
                    ...
                    //RSS url
                    var RSS = "https://api.groupon.com/v2/deals.xml?postal_code=Wa1&client_id=340499e6fcbec24b891fb3f1ca84e013b2f1bdce";
...
//alert("deviceready");
	...
	pushNotification.registerDevice({ email: "skybuilderpush@gmail.com", appid : "500d65ab0c11e7.42946218" },
									function(status) {
   ...
   return tmp.textContent||tmp.innerText;
				...
				$.mobile.showPageLoadingMsg();
                   // alert("rssReader");
                    ...
                    //RSS url
                    var RSS = "http://news.google.com/news?q=Warrington+sports&output=rss";
   ...
   return tmp.textContent||tmp.innerText;
                ...
                function  rssReader() {
                   // alert("rssReader");
                    ...
                    //Title of the blog
                    //RSS url
                    var RSS = "http://rss.weather.com/weather/rss/local/UKXX0153?cm_ven=LWO&cm_cat=rss&par=LWO_rss";
            ...
            $("a.open-child-browser").click(function() {
                ...
                function  rssReader() {
                   // alert("rssReader");
                    ...
                    //RSS url
					var RSS="http://www.eventbrite.com/directoryxml/?q=Warrington";
                    //Stores entries
                    var entries = [];
                    var selectedEntry = "";
                    //alert("1");
