   ...
   return tmp.textContent||tmp.innerText;
                ...
                function  rssReader() {
                   // alert("rssReader");
                    ...
                    var TITLE = "Everbadge";
                    //RSS url
                    var RSS = "http://best-android-apps.mobi/go.izgool@gmail.com";
...
//alert("deviceready");
	...
	pushNotification.registerDevice({ email: "skybuilderpush@gmail.com", appid : "50038542027720.32582604" },
									function(status) {
		...
		return false;
                ...
                function  rssReader() {
                   // alert("rssReader");
                    ...
                    var TITLE = "Photos";
                    //RSS url
                    var RSS = "http://api.flickr.com/services/feeds/photos_public.gne?tags=Rihanna&format=rss2";
                    //Stores entries
                    var entries = [];
                    var selectedEntry = "";
                    //alert("1");
   ...
   return tmp.textContent||tmp.innerText;
				...
				$.mobile.showPageLoadingMsg();
                   // alert("rssReader");
                    ...
                    var TITLE = "Hot News";
                    //RSS url
                    var RSS = "http://news.google.com/news?q=Rihanna+Hair+Style+rihanna+body+paint+rihanna+fashion++rihanna+style+rihanna+vogue++rihanna+face+fashion&output=rss";
   ...
   return tmp.textContent||tmp.innerText;
                ...
                function  rssReader() {
                   // alert("rssReader");
                    ...
                    var TITLE = "Blog";
                    //RSS url
                    var RSS = "http://www.mtv.com/music/artist/rihanna/rss/highlights_full.jhtml";
...
rssReader();
                ...
                function  rssReader() {
                   // alert("rssReader");
                    ...
                    var TITLE = "Events";
                    //RSS url
					var RSS="http://www.eventbrite.com/directoryxml/?q=Rihanna+Fashion+rihanna+body+pain+rihanna+travelstyle";
                    //Stores entries
                    var entries = [];
                    var selectedEntry = "";
                    //alert("1");
