...
Ext.define('MyApp.store.AgencyHighlight', {
    ...
    config:{
        ...
        proxy:{
            ...
            // PRODUCTION
            url:'http://iphone.acheter-louer.fr/perl/agences/smartphones/multi-gallerie_sthub.pl',
    ...
    config:{
        ...
        proxy: {
                ...
                api:{
                    ...
                    // PRODUCTION
                    read:"http://iphone.acheter-louer.fr/perl/agences/smartphones/multi-info_sthub.pl",
...
Ext.define('MyApp.store.SearchResults', {
    ...
    config:{
        ...
        proxy: {
            ...
            // PRODUCTION
            url:'http://iphone.acheter-louer.fr/perl/agences/smartphones/search_sthub.pl',
...
Ext.define('MyApp.store.SearchDetail', {
    ...
    config:{
        ...
        proxy: {
            ...
            // PRODUCTION
            url: 'http://iphone.acheter-louer.fr/perl/agences/smartphones/multi-searchfiche_sthub.pl',
...
Ext.define('MyApp.store.Location', {
    ...
    config:{
    	...
    	proxy: {
    		...
    		// PRODUCTION
    		url:'http://iphone.acheter-louer.fr/perl/agences/smartphones/ville_sthub.pl',
...
Ext.define('MyApp.store.ListAgence', {
    ...
    config:{
        ...
        proxy: {
            ...
            // PRODUCTION
            url:'http://iphone.acheter-louer.fr/perl/agences/smartphones/listagence_sthub.pl',
	...
	onTapButtonHighlightGo: function(){
		...
		highlightDetailStore.load({
			...
			callback: function(){
				...
				this.global_context='highlight-detail';
...
Ext.define('MyApp.view.HomePage', {
    ...
    setActiveHighlight:function(highlightModel){
		...
		console.log(highlightModel.get('nom'));
    },
});
...
Ext.define('MyApp.controller.phone.Main', {
	...
	onTapButtonSelectAgenceRealestate: function(){
		...
		console.log(agencymodel.get('idagence'));
		var tabpanel = Ext.ComponentQuery.query('#apptabpanel')[0];
		if(tabpanel){
			this.resetSearchSectionToForm();
			this.onStartSearch();
