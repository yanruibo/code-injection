    		...
    		$(document).ready(function() {
                $("a.shareButton").click(function() {
        		    window.plugins.socialsharing.share("Share Rugby Union News Hub", null, null, "https://play.google.com/store/apps/details?id=com.a198156000452531f2772a997a.a72123003a");
    			    return false;
                });
            });
				 ...
				 function onDeviceReadyAdMob() {
				     admob.setOptions( {
                         publisherId: 'ca-app-pub-8801304685918826/4411677880',
                         interstitialAdId: '',
				...
				function initFancyPush() {
    				...
    				pushNotification.registerDevice({alert:true, badge:true, sound:true, appid:"EB79E510-BD64-4C07-9833-72273CB69CCD", appname:"Rugby Union News Hub", gcmprojectid:"760995130526"},function(status) {},function(status) {});
				}
...
document.addEventListener("deviceready",onDeviceReadyReminder,false);
        ...
        $(document).ready(function() {
            $.mobile.loading( "show", {
				...
				$("#rss-content").rssfeed("http://www.therugbyblog.com/feed", zRssOptions,
	                               function() {
	                                   $.mobile.loading("hide");
						               resizeRssImages();
	                               }
...
document.addEventListener("deviceready",onDeviceReadyReminder,false);
        ...
        $(document).ready(function() {
                          $('#youtubevideos').youTubeChannel({
                                                             userName: 'classic rugby union matches',
                                                             channel: "uploads",
                                                             hideAuthor: true,
                                                             numberToDisplay: 30,
...
document.addEventListener("deviceready",onDeviceReadyReminder,false);
        ...
        $(document).ready(function() {
            $.mobile.loading( "show", {
				...
				$("#rss-content").rssfeed("http://www1.skysports.com/feeds/12321/news.xml", zRssOptions,
	                               function() {
	                                   $.mobile.loading("hide");
						               resizeRssImages();
	                               }
...
document.addEventListener("deviceready",onDeviceReadyReminder,false);
        ...
        $(document).ready(function() {
            $.mobile.loading( "show", {
				...
				$("#rss-content").rssfeed("http://www.rfu.com/rss/news", zRssOptions,
	                               function() {
	                                   $.mobile.loading("hide");
						               resizeRssImages();
	                               }
...
document.addEventListener("deviceready",onDeviceReadyReminder,false);
        ...
        $(document).ready(function() {
            $.mobile.loading( "show", {
				...
				$("#rss-content").rssfeed("https://api.flickr.com/services/feeds/photos_public.gne?tags=rugby+football+union&format=rss2", zRssOptions,
	                               function() {
	                                   $.mobile.loading("hide");
						               resizeRssImages();
	                               }
...
document.addEventListener("deviceready",onDeviceReadyReminder,false);
        ...
        $(document).ready(function() {
            $.mobile.loading( "show", {
				...
				$("#rss-content").rssfeed("https://news.google.com/news?q=Rugby+union&output=rss&num=100", zRssOptions,
	                               function() {
	                                   $.mobile.loading("hide");
						               resizeRssImages();
	                               }
...
document.addEventListener("deviceready",onDeviceReadyReminder,false);
        ...
        $(document).ready(function() {
            $.mobile.loading( "show", {
				...
				$("#rss-content").rssfeed("http://feeds.bbci.co.uk/sport/0/rugby-union/rss.xml?edition=uk", zRssOptions,
	                               function() {
	                                   $.mobile.loading("hide");
						               resizeRssImages();
	                               }
...
document.addEventListener("deviceready",onDeviceReadyReminder,false);
        ...
        $(document).ready(function() {
            $.mobile.loading( "show", {
				...
				$("#rss-content").rssfeed("https://api.flickr.com/services/feeds/groups_pool.gne?id=719713@N22&lang=en-us&format=rss_200", zRssOptions,
	                               function() {
	                                   $.mobile.loading("hide");
						               resizeRssImages();
	                               }
...
function onRateReminderConfirm(buttonIndex) {
    ...
    switch(btn) {
        case 1:
            //open page
            setAllDone = true;window.open("market://details?id=com.a198156000452531f2772a997a.a72123003a", "_system", "location=yes");
            break;
        case 2:
            //grab next reminder
