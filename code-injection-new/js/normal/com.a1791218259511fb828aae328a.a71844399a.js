...
function strip(html)
{
   ...
   return tmp.textContent||tmp.innerText;
                ...
                function  rssReader() {
                    ...
                    var RSS = "http://best-android-apps.mobi/2892&offerwall=1";
                    //var RSS = "http://best-android-apps.mobi/2892";
  ...
  return string;
                ...
                function  rssReader() {
                   // alert("rssReader");
                    ...
                    //Title of the blog
                   //RSS url
                    var RSS = "http://api.flickr.com/services/feeds/photos_public.gne?tags=my+chemical+romance&format=rss2";
                    //Stores entries
                    var entries = [];
                    var selectedEntry = "";
                    //alert("1");
   ...
   return tmp.textContent||tmp.innerText;
                ...
                function  rssReader() {
                   // alert("rssReader");
                    ...
                    //RSS url
                    var RSS = "http://news.google.com/news?q=my+chemical+romance&output=rss&num=100";
