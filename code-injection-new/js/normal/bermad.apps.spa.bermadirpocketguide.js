    ...
    $(window).load(function() {
        $(document).bind('deviceready', function () {
            $('.favourite_button').click(function(){
                ...
                navigator.notification.alert('Producto agregado a favoritos', function(){}, 'Favoritos')
            });
            ...
            $('.hide_favourite_button').click(function(){
                ...
                navigator.notification.alert('Producto eliminado de favoritos', function(){}, 'Favoritos')
            });
        ...
        function initialize_image_size_position(){
           if($.mobile.activePage.is('.image_page')){
                ...
                if(content_aspect_ratio > 1){
                    ...
                    if((page_real_height) < window.innerWidth * 1319 / 945){
                        var padding_sides= Math.round((window.innerWidth - (page_real_height) * 945/1319)/2);
                        content_div.css({
            ...
            switch (select_value){
                case 'pressure':
                    ...
                    case 'flow':
                        ...
                        break;
                    case 'length':
                        utf.html('<option value="mm">mm</option><option value="m">m</option><option value="in">pulgadas</option><option value="ft">pies</option>');
                        utt.html('<option value="mm">mm</option><option value="m">m</option><option value="in">pulgadas</option><option value="ft">pies</option>');
                        break;
                    case 'volume':
                        utf.html('<option value="l">l</option><option value="mmm">m&#179;</option><option value="gal">gal</option><option value="fttt">pies cúbicos</option>');
                        utt.html('<option value="l">l</option><option value="mmm">m&#179;</option><option value="gal">gal</option><option value="fttt">pies cúbicos</option>');
                        break;
                    case 'weight':
