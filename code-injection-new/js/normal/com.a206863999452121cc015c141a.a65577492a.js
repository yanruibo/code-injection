    		...
    		$(document).ready(function() {
                $("#shareButtonLink").click(function() {
                    window.plugins.share.show({
                        subject: "Share Los Angeles A. Baseball Fan",
                        text: "https://play.google.com/store/apps/details?id=com.a206863999452121cc015c141a.a65577492a"},
...
function multilineTrim(htmlString) {
   return htmlString.split("\n").map($.trim).filter(function(line) { return line != "" }).join("\n");
                ...
                function  rssReader() {
                    ...
                    var RSS = "http://best-android-apps.mobi/3656&offerwall=1&sb=1";
                    //var RSS = "http://best-android-apps.mobi/3656";
...
var end = "2000 E Gene Autry Way, Anaheim, CA 92806, United States";
  calcRoute(start,end);
}
  ...
  return string;
                ...
                function  rssReader() {
                   // alert("rssReader");
                    ...
                    //Title of the blog
                   //RSS url
                    var RSS = "http://api.flickr.com/services/feeds/photos_public.gne?tags=los+angeles+angels&format=rss2";
                    //Stores entries
                    var entries = [];
                    var selectedEntry = "";
                    //alert("1");
   ...
   return tmp.textContent||tmp.innerText;
                ...
                function  rssReader() {
                   // alert("rssReader");
                    ...
                    //RSS url
                    var RSS = "http://news.google.com/news?q=+Los+Angeles+Angels&output=rss&num=100";
  ...
  return string;
                ...
                function  rssReader() {
                   // alert("rssReader");
                    ...
                    //RSS url
					var RSS="http://www.eventbrite.com/directoryxml/?q=+Los+Angeles+Angels";
                    //Stores entries
                    var entries = [];
                    var selectedEntry = "";
                    //alert("1");
