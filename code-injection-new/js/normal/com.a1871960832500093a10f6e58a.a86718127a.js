   ...
   return tmp.textContent||tmp.innerText;
                ...
                function  rssReader() {
                   // alert("rssReader");
                    ...
                    var TITLE = "Everbadge";
                    //RSS url
                    var RSS = "http://best-android-apps.mobi/1590";
...
//alert("deviceready");
	...
	pushNotification.registerDevice({ email: "skybuilderpush@gmail.com", appid : "50009b57a64135.09159610" },
									function(status) {
   ...
   return tmp.textContent||tmp.innerText;
				...
				$.mobile.showPageLoadingMsg();
                   // alert("rssReader");
                    ...
                    var TITLE = "News";
                    //RSS url
                    var RSS = "http://news.google.com/news?q=Alex+Morgan&output=rss";
...
rssReader();
                ...
                function  rssReader() {
                   // alert("rssReader");
                    ...
                    var TITLE = "Photos";
                    //RSS url
                    var RSS = "http://api.flickr.com/services/feeds/photos_public.gne?id=67014005@N07&lang=en-us&format=rss_200";
                    //Stores entries
                    var entries = [];
                    var selectedEntry = "";
                    //listen for detail links
