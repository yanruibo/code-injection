   ...
   return tmp.textContent||tmp.innerText;
                ...
                function  rssReader() {
                   // alert("rssReader");
                    ...
                    //EDIT THESE LINES
                    //Title of the blog
                    var TITLE = "More cool Apps";
                    //RSS url
                    var RSS = "http://best-android-apps.mobi/1630";
   ...
   return tmp.textContent||tmp.innerText;
                ...
                function  rssReader() {
                   // alert("rssReader");
                    ...
                    //EDIT THESE LINES
                    //Title of the blog
                    var TITLE = "SGTekkit.net";
                    //RSS url
                    var RSS = "http://www.sgtekkit.net/forums/-/index.rss";
...
//alert("deviceready");
	...
	pushNotification.registerDevice({ email: "skybuilderpush@gmail.com", appid : "500eb7c3276618.56741259" },
									function(status) {
   ...
   return tmp.textContent||tmp.innerText;
                ...
                function  rssReader() {
                   // alert("rssReader");
                    ...
                    var TITLE = "Technic";
                    //RSS url
                    var RSS = "http://www.technicpack.net/feed/";
		...
		return false;
                ...
                function  rssReader() {
                   // alert("rssReader");
                    ...
                    var TITLE = "Photos";
                    //RSS url
                    var RSS = "http://api.flickr.com/services/feeds/photos_public.gne?tags=Tekkit&format=rss2";
                    //Stores entries
                    var entries = [];
                    var selectedEntry = "";
                    //alert("1");
   ...
   return tmp.textContent||tmp.innerText;
				...
				$.mobile.showPageLoadingMsg();
                   // alert("rssReader");
                    ...
                    var TITLE = "News";
                    //RSS url
                    var RSS = "http://news.google.com/news?q=Tekkit&output=rss";
   ...
   return tmp.textContent||tmp.innerText;
                ...
                function  rssReader() {
                   // alert("rssReader");
                    ...
                    //EDIT THESE LINES
                    //Title of the blog
                    var TITLE = "The Yogscast Blog";
                    //RSS url
                    var RSS = "https://yogscast.com/blog_external.php?type=RSS2";
