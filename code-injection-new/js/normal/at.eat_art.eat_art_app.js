    ...
    function onDeviceReady() {
        ...
        //var ref = window.open('Speiseplan.html', '_self', 'location=yes');
    }
    ...
    function openMaps(querystring) { 
        ...
        var myLoc = new google.maps.Lat.Lng(lat, lng); 
        maproot = "geo:" + myLoc + "?saddr=" + myLoc;           
        ...
        function onOffline() { 
            alert ('Bitte gehen sie online, um den vollen Funktionsumfang dieser App zu nutzen!'); 
        }
 ...
 */
if(!window.Typekit)window.Typekit={};window.Typekit.config={"f":"//use.edgefonts.net/c/e39327/source-sans-pro:n4:n7:i4:i7.Xd2:F:2,Xcv:F:2,Xcz:F:2,Xcw:F:2/{format}{/extras*}","fn":["source-sans-pro",["n4","n7","i4","i7"]],"p":"//p.typekit.net/p.gif?s=4&h={host}&f=17265.17267.17269.17268&app={app}&_={_}"};
