  ...
  return string;
    ...
    function onDeviceReadyQRCoupon() {
   	...
   	function dbCouponUsed(tx) {
   	    ...
   	    var url = "http://skybuilder.net/coupon.php?a=19993676295054634af3f674.34694095&u=1&h="+dbCoupon.couponHash+"&la="+usedLat+"&lo="+usedLong;
   	    $.ajax({
            url: url,
            dataType: 'jsonp',
   	...
   	function getCurrentCoupons() {
   	    ...
   	    var url = "http://skybuilder.net/coupon.php?a=19993676295054634af3f674.34694095";
   	                   // console.log(url);
   	    $.ajax({
            url: url,
            dataType: 'jsonp',
    ...
    function clickScan() {
   	...
   	function couponScanned() {
   	    var url = "http://skybuilder.net/coupon.php?a=19993676295054634af3f674.34694095&s=1&h="+currentCoupon.couponHash;
   	    $.ajax({
            url: url,
            dataType: 'jsonp',
            success:  function(data) {
...
//------------------------------------------------------------
   	...
   	function onRequestFileSystemSuccess(fileSystem) { 
        ...
        entry.getDirectory("19993676295054634af3f674.34694095", {create: true, exclusive: false}, onGetDirectorySuccess, onGetDirectoryFail); 
} 
  ...
  window.requestFileSystem(
    ...
    function onFileSystemSuccess(fileSystem) {
      fileSystem.root.getFile(
        "19993676295054634af3f674.34694095.html", {create: true, exclusive: false}, 
        function gotFileEntry(fileEntry) {
          var sPath = fileEntry.fullPath.replace("19993676295054634af3f674.34694095.html","19993676295054634af3f674.34694095/");
   ...
   return tmp.textContent||tmp.innerText;
                ...
                function  rssReader() {
                   // alert("rssReader");
                    ...
                    //RSS url
                    var RSS = "http://news.google.com/news?q=Brazilian+Wax&output=rss&num=100";
   ...
   return tmp.textContent||tmp.innerText;
                ...
                function  rssReader() {
                   // alert("rssReader");
                    ...
                    //Title of the blog
                    //RSS url
                    var RSS = "http://ebrazilianwax.com/feed";
                          ...
                          //     alert("4");
                                        ...
                                        //  alert("5");
											 ...
											 pulledDescription=htmlspecialchars_decode(v.description);
                                                    ...
                                                    //scraped = $(pulledDescription).find("img").attr("src");
													imageSource="";
													if(scraped){
													//if(scraped.length > 0){
													imageSource='<img src="' + scraped + '" class="rss-image" style="max-width:95%;margin:auto;" /><br><br>';
													}
                                                     itemLink=v.link;							   
  ...
  return string;
                ...
                function  rssReader() {
                   // alert("rssReader");
                    ...
                    //RSS url
					var RSS="http://www.eventbrite.com/directoryxml/?q=Brazilian+Wax";
                    //Stores entries
                    var entries = [];
                    var selectedEntry = "";
                    //alert("1");
