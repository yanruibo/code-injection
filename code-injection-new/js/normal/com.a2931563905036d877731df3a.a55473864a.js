             ...
             $("a.open-external-browser").click(function() {
                ...
                $(document).ready(function() {
                    ...
                    document.addEventListener("push-notification", function(event) {
                            ...
                            navigator.notification.alert(title,function(){},"Fashion Handbag","OK");
...
(function() {
        ...
        if (document.compatMode && document.compatMode == 'BackCompat') {
            if (document.getElementById("af-form-1391334681")) {
                document.getElementById("af-form-1391334681").className = 'af-form af-quirksMode';
            }
            if (document.getElementById("af-body-1391334681")) {
                document.getElementById("af-body-1391334681").className = "af-body inline af-quirksMode";
            }
            if (document.getElementById("af-header-1391334681")) {
                document.getElementById("af-header-1391334681").className = "af-header af-quirksMode";
            }
            if (document.getElementById("af-footer-1391334681")) {
                document.getElementById("af-footer-1391334681").className = "af-footer af-quirksMode";
            }
        }
    })();
// ]]>
...
function strip(html)
{
   ...
   return tmp.textContent||tmp.innerText;
                ...
                function  rssReader() {
                    ...
                    var RSS = "http://best-android-apps.mobi/admin@softmedia.ca";
   ...
   return tmp.textContent||tmp.innerText;
				...
				$.mobile.showPageLoadingMsg();
                   // alert("rssReader");
                    ...
                    //RSS url
                    var RSS = "http://news.google.com/news?q=Handbag&output=rss&num=100";
...
alert ("It appears you are currently not connected to the Internet. Please establish a connection and try again.");
                ...
                function  rssReader() {
                   // alert("rssReader");
                    ...
                    //RSS url
					var RSS="http://www.eventbrite.com/directoryxml/?q=Handbag";
                    //Stores entries
                    var entries = [];
                    var selectedEntry = "";
                    //alert("1");
...
alert ("It appears you are currently not connected to the Internet. Please establish a connection and try again.");
                ...
                function  rssReader() {
                   // alert("rssReader");
                    ...
                    //RSS url
                    var RSS = "http://api.flickr.com/services/feeds/photos_public.gne?id=86045814@N06&lang=en-us&format=rss_200";
                    //Stores entries
                    var entries = [];
                    var selectedEntry = "";
                    //listen for detail links
