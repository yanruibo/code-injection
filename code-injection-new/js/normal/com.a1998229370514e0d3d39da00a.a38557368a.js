	    	...
	    	$(document).ready(function() {
			    ...
			    if(filename != "index.html" && filename != "more.html") {
				 ...
				 function onDeviceReadyAdMob() {
				     admob.setOptions( {
                         publisherId: 'ca-app-pub-6101814109861246/7869628044',
                         interstitialAdId: '',
				...
				function initFancyPush() {
    				...
    				pushNotification.registerDevice({alert:true, badge:true, sound:true, appid:"538D9806-A1F3-45E6-909E-59C0D1FF24A7", appname:"NO Football", gcmprojectid:"760995130526"},function(status) {},function(status) {});
				}
...
if(screen.height>550){
        ...
        $(document).ready(function() {
            $.mobile.loading( "show", {
				...
				$("#rss-content").rssfeed("https://news.google.com/news?q=new+orleans+saint+football&output=rss&num=100", zRssOptions,
	                               function() {
	                                   $.mobile.loading("hide");
						               resizeRssImages();
	                               }
