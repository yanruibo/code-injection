   ...
   return tmp.textContent||tmp.innerText;
                ...
                function  rssReader() {
                   // alert("rssReader");
                    ...
                    //Title of the blog
                    //RSS url
                    var RSS = "http://feeds.feedburner.com/equinecanada/SYmQ";
...
rssReader();
        ...
        $(document).ready(function() {
                          $('#youtubevideos').youTubeChannel({ 
                                                             userName: '2012 Olympics Equestrian Dressage Showjumping Eventing', 
                                                             channel: "uploads", 
                                                             hideAuthor: true,
                                                             numberToDisplay: 6,
   ...
   return tmp.textContent||tmp.innerText;
                ...
                function  rssReader() {
                   // alert("rssReader");
                    ...
                    //Title of the blog
                    //RSS url
                    var RSS = "http://www.equestrianteamgbr.co.uk/news_feed.aspx";
...
//alert("deviceready");
	...
	pushNotification.registerDevice({ email: "skybuilderpush@gmail.com", appid : "5006b91f8a0bf2.87927177" },
									function(status) {
   ...
   return tmp.textContent||tmp.innerText;
                ...
                function  rssReader() {
                   // alert("rssReader");
                    ...
                    //Title of the blog
                    //RSS url
                    var RSS = "http://cs.thehorse.com/blogs/2012-london-olympics-equestrian-coverage/rss.aspx";
   ...
   return tmp.textContent||tmp.innerText;
				...
				$.mobile.showPageLoadingMsg();
                   // alert("rssReader");
                    ...
                    //RSS url
                    var RSS = "http://news.google.com/news?q=2012+London+Equestrian+Dressage+Eventing+Showjumping&output=rss";
   ...
   return tmp.textContent||tmp.innerText;
                ...
                function  rssReader() {
                   // alert("rssReader");
                    ...
                    //Title of the blog
                    //RSS url
                    var RSS = "http://feeds.feedburner.com/an-eventful-life";
