...
function onDeviceReady() {
  ...
  function showPage(locbar) {
    ...
    window.plugins.childBrowser.showWebPage(
        "http://maps.google.com/maps?saddr=current+location&daddr=33.654289,-84.367855", {
...
function closed() {
  ...
  $('.map').click(function() {
      window.plugins.childBrowser.showWebPage("http://maps.google.com/maps?saddr=current+location&daddr=33.654289,-84.367855");
  };*/
