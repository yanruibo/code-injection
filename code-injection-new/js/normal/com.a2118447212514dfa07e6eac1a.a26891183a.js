	    	...
	    	$(document).ready(function() {
			    ...
			    if(filename != "index.html" && filename != "more.html") {
				 ...
				 function onDeviceReadyAdMob() {
				     admob.setOptions( {
                         publisherId: 'ca-app-pub-6101814109861246/4416634044',
                         interstitialAdId: '',
				...
				function initFancyPush() {
    				...
    				pushNotification.registerDevice({alert:true, badge:true, sound:true, appid:"F1033B06-3C3F-4D7F-A15D-300587AB9E26", appname:"Duke BB", gcmprojectid:"760995130526"},function(status) {},function(status) {});
				}
...
if(screen.height>550){
        ...
        $(document).ready(function() {
            $.mobile.loading( "show", {
				...
				$("#rss-content").rssfeed("https://news.google.com/news?q=duke+basketball&output=rss&num=100", zRssOptions,
	                               function() {
	                                   $.mobile.loading("hide");
						               resizeRssImages();
	                               }
