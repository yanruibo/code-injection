...
//alert("deviceready");
	...
	pushNotification.registerDevice({ email: "skybuilderpush@gmail.com", appid : "50073567eab917.30097124" },
									function(status) {
		...
		return false;
                ...
                function  rssReader() {
                   // alert("rssReader");
                    ...
                    var TITLE = "Photos";
                    //RSS url
                    var RSS = "http://api.flickr.com/services/feeds/photos_public.gne?tags=galapagos&format=rss2";
                    //Stores entries
                    var entries = [];
                    var selectedEntry = "";
                    //alert("1");
   ...
   return tmp.textContent||tmp.innerText;
				...
				$.mobile.showPageLoadingMsg();
                   // alert("rssReader");
                    ...
                    var TITLE = "News";
                    //RSS url
                    var RSS = "http://news.google.com/news?q=galapagos&output=rss";
