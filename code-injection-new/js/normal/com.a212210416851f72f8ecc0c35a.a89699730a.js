    		...
    		$(document).ready(function() {
                $("#shareButtonLink").click(function() {
                    window.plugins.share.show({
                        subject: "Share Arizona Baseball Fan App",
                        text: "https://play.google.com/store/apps/details?id=com.a212210416851f72f8ecc0c35a.a89699730a"},
...
var end = "401 East Jefferson Street Phoenix, AZ 85004";
  calcRoute(start,end);
}
  ...
  return string;
                ...
                function  rssReader() {
                   // alert("rssReader");
                    ...
                    //Title of the blog
                   //RSS url
                    var RSS = "http://api.flickr.com/services/feeds/photos_public.gne?tags=Arizona+Diamondbacks&format=rss2";
                    //Stores entries
                    var entries = [];
                    var selectedEntry = "";
                    //alert("1");
   ...
   return tmp.textContent||tmp.innerText;
                ...
                function  rssReader() {
                   // alert("rssReader");
                    ...
                    //RSS url
                    var RSS = "http://news.google.com/news?q=Arizona+Diamondbacks&output=rss&num=100";
