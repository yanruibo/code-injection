...
//alert("deviceready");
	...
	pushNotification.registerDevice({ email: "skybuilderpush@gmail.com", appid : "5014c907e7bfb8.71206419" },
									function(status) {
            ...
            $("a.open-child-browser").click(function() {
                ...
                function  rssReader() {
                   // alert("rssReader");
                    ...
                    //Title of the blog
                   //RSS url
                    var RSS = "http://api.flickr.com/services/feeds/photos_public.gne?tags=college&format=rss2";
                    //Stores entries
                    var entries = [];
                    var selectedEntry = "";
                    //alert("1");
   ...
   return tmp.textContent||tmp.innerText;
				...
				$.mobile.showPageLoadingMsg();
                   // alert("rssReader");
                    ...
                    //RSS url
                    var RSS = "http://news.google.com/news?q=find+a+college&output=rss";
