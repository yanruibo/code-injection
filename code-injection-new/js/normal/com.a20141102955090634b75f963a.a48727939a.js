...
alert ("It appears you are currently not connected to the Internet. Please establish a connection and try again.");
        ...
        $(document).ready(function() {
                          $('#youtubevideos').youTubeChannel({ 
                                                             userName: 'james arthur x factor', 
                                                             channel: "uploads", 
                                                             hideAuthor: true,
                                                             numberToDisplay: 30,
...
function strip(html)
{
   ...
   return tmp.textContent||tmp.innerText;
                ...
                function  rssReader() {
                    ...
                    var RSS = "http://best-android-apps.mobi/2484&offerwall=1";
                    //var RSS = "http://best-android-apps.mobi/2484";
   ...
   return tmp.textContent||tmp.innerText;
				...
				$.mobile.showPageLoadingMsg();
                   // alert("rssReader");
                    ...
                    //RSS url
                    var RSS = "http://news.google.com/news?q=james+arthur+x+factor&output=rss&num=100";
