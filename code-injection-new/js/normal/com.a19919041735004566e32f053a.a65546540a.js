...
window.onload = initORMMA();
        ...
        $(document).ready(function() {
                          $('#youtubevideos').youTubeChannel({ 
                                                             userName: 'Waterproof Video Camera Review', 
                                                             channel: "uploads", 
                                                             hideAuthor: true,
                                                             numberToDisplay: 6,
        ...
        $(document).ready(function() {
                          $('#youtubevideos').youTubeChannel({ 
                                                             userName: 'Waterproof Video Camera', 
                                                             channel: "uploads", 
                                                             hideAuthor: true,
                                                             numberToDisplay: 6,
                                                             linksInNewWindow: true
		...
		return false;
                ...
                function  rssReader() {
                   // alert("rssReader");
                    ...
                    var TITLE = "Photos";
                    //RSS url
                    var RSS = "http://api.flickr.com/services/feeds/photos_public.gne?tags=Waterproof,Video,Camera&format=rss2";
                    //Stores entries
                    var entries = [];
                    var selectedEntry = "";
                    //alert("1");
   ...
   return tmp.textContent||tmp.innerText;
				...
				$.mobile.showPageLoadingMsg();
                   // alert("rssReader");
                    ...
                    var TITLE = "News";
                    //RSS url
                    var RSS = "http://news.google.com/news?q=Waterproof+Video+Camera&output=rss";
   ...
   return tmp.textContent||tmp.innerText;
                ...
                function  rssReader() {
                   // alert("rssReader");
                    ...
                    var TITLE = "Hot";
                    //RSS url
                    var RSS = "http://www.waterproofvideocamerareview.com/rss";
...
rssReader();
                ...
                function  rssReader() {
                   // alert("rssReader");
                    ...
                    var TITLE = "Events";
                    //RSS url
					var RSS="http://www.eventbrite.com/directoryxml/?q=Waterproof+Video+Camera";
                    //Stores entries
                    var entries = [];
                    var selectedEntry = "";
                    //alert("1");
