...
$.getJSON( "http://skybuilder.net/pixelTest.php?callback=").done(function( json ) {$("#pixel").html("<img src=\"http://skybuilder.net/pixel.php?device=android&module=tiered&appId=198466704050be55367cf4a4.07807251\"/>");}).fail(function( jqxhr, textStatus, error ) {});
