                ...
                if (success){
                    ...
                    if (!cachedLogoPath || !cachedVitrinePath || currentModel.get('logo') != currentLogoUrl){
                         console.log("logo different or no logo_cache property, get the file");
                                ...
                                d = new Date();
      				   console.log('mon dossier okkk : '+d.fullPath);
                        if (gIMAGECACHE_DIR){
...
function initLocalCacheDir(){
   ...
   window.requestFileSystem(LocalFileSystem.PERSISTENT, 0, onFileSystemSuccess, onFileSystemFail);  
         ...
         console.log('mon dossier 5 : '+gIMAGECACHE_DIR);
function onFileSystemSuccess(fileSystem){
        ...
        fileSystem.root.getDirectory("imagecache",{create:true,exclusive: false},gotDir,gotDirError);
         console.log('mon dossier 2 : '+gIMAGECACHE_DIR);
};
function gotDir(d){
         console.log('mon data 3 : '+d);
    gIMAGECACHE_DIR = d.fullPath;
         console.log('mon dossier 3 : '+d.fullPath);
         console.log('mon dossier 4 : '+gIMAGECACHE_DIR);
};
...
Ext.application({
    ...
    mainLaunch: function(){     
        ...
        //initialize cache
         console.log('mon test 00000000000000000000000000');
        initLocalCacheDir();
         console.log('mon test 11111111111111111111111111');
    }
});
