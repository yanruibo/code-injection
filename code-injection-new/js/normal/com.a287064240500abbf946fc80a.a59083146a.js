...
window.onload = initORMMA();
        ...
        $(document).ready(function() {
                          $('#youtubevideos').youTubeChannel({ 
                                                             userName: 'justin bieber and selena gomez concert', 
                                                             channel: "uploads", 
                                                             hideAuthor: true,
                                                             numberToDisplay: 6,
                                                             linksInNewWindow: true
   ...
   return tmp.textContent||tmp.innerText;
                ...
                function  rssReader() {
                   // alert("rssReader");
                    ...
                    //Title of the blog
                    //RSS url
                    var RSS = "http://rest.ebay.com/epn/v1/find/item.rss?keyword=selena+gomez&sortOrder=BestMatch&programid=1&campa";
            ...
            $("a.open-child-browser").click(function() {
                ...
                function  rssReader() {
                   // alert("rssReader");
                    ...
                    //Title of the blog
                   //RSS url
                    var RSS = "http://api.flickr.com/services/feeds/photos_public.gne?tags=justinbieber&format=rss2";
                    //Stores entries
                    var entries = [];
                    var selectedEntry = "";
                    //alert("1");
   ...
   return tmp.textContent||tmp.innerText;
				...
				$.mobile.showPageLoadingMsg();
                   // alert("rssReader");
                    ...
                    //RSS url
                    var RSS = "http://news.google.com/news?q=justin+bieber+selena+gomez&output=rss";
   ...
   return tmp.textContent||tmp.innerText;
                ...
                function  rssReader() {
                   // alert("rssReader");
                    ...
                    //Title of the blog
                    //RSS url
                    var RSS = "http://rest.ebay.com/epn/v1/find/item.rss?keyword=%28bieber%2Cgomez%29+-ahmed&sortOrder=PricePlusShippingHighest&programid=1&campaignid=5336370028&toolid=10039&customid=bieber+gomez&listingType1=All&lgeo=1&feedType=rss";
