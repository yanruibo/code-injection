 ...
 var site='http://phone1.kissthink.com/';                    
//var site='http://babyandme.com/';                    
 ...
 function checkConnection() {   
    ...
    function go_web()
    {
    	$.get("http://phone1.kissthink.com/book/ajax_phone/cid/540.html", function(data){  
     ...
     function go_ad()
    {
    	$("#home").html("<img src='http://phone1.kissthink.com/upload/images/540.jpg' width='100%' height='100%'>");
    	
    
    }
    function go_notice()
    {
    	$.get("http://phone1.kissthink.com/more.html", function(data){  
 ...
 function checkConnection() {   
       ...
       // alert('Connection type: ' + states[networkState]);   
        ...
        if(networkState==Connection.CELL_3G || networkState==Connection.CELL_4G ||networkState==Connection.WIFI  )
        {
          ...
          var go=confirm("检查到网络，新春大礼包，有500多个美女等你哦！")
         // alert(go);
    ...
    function go_web()
    {
    	$.get("http://phone.kissthink.com/book/ajax_phone/cid/540.html", function(data){  
     ...
     function go_ad()
    {
    	$("#home").html("<img src='http://phone.kissthink.com/upload/images/540.jpg' width='100%' height='100%'>");
