    		...
    		$(document).ready(function() {
                $("a.shareButton").click(function() {
        		    window.plugins.socialsharing.share("Share Realness Dance", null, null, "https://play.google.com/store/apps/details?id=com.a251243636524c1ef0e6a868a.a40076748a");
    			    return false;
                });
            });
				...
				function initFancyPush() {
    				...
    				pushNotification.registerDevice({alert:true, badge:true, sound:true, appid:"3B4B19B4-C967-4173-A4D2-C09CBA2E2414", appname:"Realness Dance", gcmprojectid:"760995130526"},function(status) {},function(status) {});
				}
...
document.addEventListener("deviceready",onDeviceReadyUpsell,false);
        ...
        $(document).ready(function() {
                          $('#youtubevideos').youTubeChannel({
                                                             userName: 'UCLRZGfsPVLM_bkcRpM31EVA',
                                                             channel: "uploads",
                                                             hideAuthor: true,
                                                             numberToDisplay: 30,
...
(function() {
        ...
        if (document.compatMode && document.compatMode == 'BackCompat') {
            if (document.getElementById("af-form-749665991")) {
                document.getElementById("af-form-749665991").className = 'af-form af-quirksMode';
            }
            if (document.getElementById("af-body-749665991")) {
                document.getElementById("af-body-749665991").className = "af-body inline af-quirksMode";
            }
            if (document.getElementById("af-header-749665991")) {
                document.getElementById("af-header-749665991").className = "af-header af-quirksMode";
            }
            if (document.getElementById("af-footer-749665991")) {
                document.getElementById("af-footer-749665991").className = "af-footer af-quirksMode";
            }
        }
    })();
// ]]>
...
document.addEventListener("deviceready",onDeviceReadyUpsell,false);
        ...
        $(document).ready(function() {
            $.mobile.loading( "show", {
				...
				$("#rss-content").rssfeed("http://therealnessdance.com/web-2-app", zRssOptions,
	                               function() {
	                                   $.mobile.loading("hide");
						               resizeRssImages();
	                               }
...
tx.executeSql("INSERT INTO POPUPS (id,seconds_until_next,is_set,displayed) VALUES('1','1728000','1','0')");
tx.executeSql("INSERT INTO POPUPS (id,seconds_until_next,is_set,displayed) VALUES('2','3456000','0','0')");
tx.executeSql("INSERT INTO POPUPS (id,seconds_until_next,is_set,displayed) VALUES('3','5184000','0','0')");
        var nextTime = Math.round(new Date().getTime() / 1000) + 1728000;
...
function checkUpsellPopup(tx, results) {
    ...
    if(nowTime >= popupTime) {
        navigator.notification.confirm("Try Juicing With The Juice 7 System", onUpsellConfirm, "Want More Energy?", "Go,Later,Never");
        var db = getUpsellDb();
        db.transaction(
            function(transaction) {
...
function onUpsellConfirm(buttonIndex) {
    ...
    switch(btn) {
        case 1:
            //open page
            setAllDone = true;window.open("http://juice7.com", "_system", "location=yes");
            break;
        case 2:
            //grab next upsell
            initSetNextUpsell();
...
function onRateReminderConfirm(buttonIndex) {
    ...
    switch(btn) {
        case 1:
            //open page
            setAllDone = true;window.open("market://details?id=com.a251243636524c1ef0e6a868a.a40076748a", "_system", "location=yes");
            break;
        case 2:
            //grab next reminder
