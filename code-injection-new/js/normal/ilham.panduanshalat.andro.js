...
gfeedfetcher.prototype.init=function(){
	...
	this.feedcontainer.innerHTML='<p>Data sedang di-update. Pastikan Anda terhubung dengan koneksi internet.</p>'
	var displayer=this
...
gfeedfetcher.prototype._displayresult=function(feeds){
	...
	function shareme()
	{
		...
		(
			{
    			subject: 'Panduan Shalat (Video)',
    			text: 'https://play.google.com/store/apps/details?id=ilham.panduanshalat.andro'
    		},    		
...
 
    	pushNotification.registerDevice({ projectid: "375554000442", appid : "A31E0-A3DA2" },
        	function(status) {
...
if (!window.plugins.share) {
	...
	newsfeed.addFeed("Muslim.or.id", "http://muslim.or.id/feed");
	newsfeed.addFeed("KonsultasiSyariah.com", "http://feeds.feedburner.com/KonsultasiSyariah");
	newsfeed.addFeed("PeduliMuslim.com", "http://feeds.feedburner.com/pedulimuslim");
	newsfeed.addFeed("Ustadz Firanda", "http://firanda.com/index.php?format=feed&type=rss");
	...
	var newsfeed=new gfeedfetcher("rssfeeds", "rssfeedsclass", "_new")
	newsfeed.addFeed("Kajian.net", "http://kajian.net/kajian-audio/added/all/song/stats.xml");
	//newsfeed.addFeed("Muslim.or.id", "http://muslim.or.id/feed");
	//newsfeed.addFeed("KonsultasiSyariah.com", "http://feeds.feedburner.com/KonsultasiSyariah");
	//newsfeed.addFeed("Ustadz Firanda", "http://firanda.com/index.php?format=feed&type=rss");
	newsfeed.displayoptions("label datetime snippet");
