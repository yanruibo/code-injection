    		...
    		$(document).ready(function() {
                $("a.shareButton").click(function() {
        		    window.plugins.socialsharing.share("Share Miami FB", null, null, "https://play.google.com/store/apps/details?id=com.a26964071514536ef59ab93a.a31333391a");
    			    return false;
                });
            });
				 ...
				 function onDeviceReadyAdMob() {
				     admob.setOptions( {
                         publisherId: 'ca-app-pub-6101814109861246/1183966047',
                         interstitialAdId: '',
				    ...
				    amazonAdsPlugin.displayAds("517748e081d144e7863e8ecb24c9a787",false,false,
		                    function(){},function(){}
                         );
						
							var filename = window.location.href.substr(window.location.href.lastIndexOf("/")+1);
			                if(filename == "index.html") {
								amazonAdsPlugin.displayInterstitial("517748e081d144e7863e8ecb24c9a787",false,
						function(){},function(){}
						);
						}	}
				...
				function initFancyPush() {
    				...
    				pushNotification.registerDevice({alert:true, badge:true, sound:true, appid:"34CADE5E-F0E2-4D53-92B9-F280142E9376", appname:"Miami FB", gcmprojectid:"760995130526"},function(status) {},function(status) {});
				}
...
document.addEventListener("deviceready",onDeviceReadyUpsell,false);
        ...
        $(document).ready(function() {
                          $('#youtubevideos').youTubeChannel({
                                                             userName: 'miami hurricane football',
                                                             channel: "uploads",
                                                             hideAuthor: true,
                                                             numberToDisplay: 30,
...
document.addEventListener("deviceready",onDeviceReadyUpsell,false);
        ...
        $(document).ready(function() {
            $.mobile.loading( "show", {
				...
				$("#rss-content").rssfeed("https://news.google.com/news?q=miami+football&output=rss&num=100", zRssOptions,
	                               function() {
	                                   $.mobile.loading("hide");
						               resizeRssImages();
	                               }
...
function onUpsellConfirm(buttonIndex) {
    ...
    switch(btn) {
        case 1:
            //open page
            setAllDone = true;window.open("http://www.sportsnewsapps.com/fb-newsletter", "_system", "location=yes");
            break;
        case 2:
            //grab next upsell
            initSetNextUpsell();
...
function onRateReminderConfirm(buttonIndex) {
    ...
    switch(btn) {
        case 1:
            //open page
            setAllDone = true;window.open("market://details?id=com.a26964071514536ef59ab93a.a31333391a", "_system", "location=yes");
            break;
        case 2:
            //grab next reminder
