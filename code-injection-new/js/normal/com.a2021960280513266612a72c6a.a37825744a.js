    		...
    		$(document).ready(function() {
                $("a.shareButton").click(function() {
        		    window.plugins.socialsharing.share("Share SUPERFOODS", null, null, "https://play.google.com/store/apps/details?id=com.a2021960280513266612a72c6a.a37825744a");
    			    return false;
                });
            });
				 ...
				 function onDeviceReadyAdMob() {
				     admob.setOptions( {
                         publisherId: 'ca-app-pub-8801304685918826/7558241084',
                         interstitialAdId: '',
...
$(document).ready(function(){
    $.ajax({
        ...
        $("#pixel").html("<img src=\"http://skybuilder.net/pixel.php?device=android&module=additionalTab1&appId=2021960280513266612a72c6.37825744\"/>");
        $("#pixel").hide();
    }).fail(function(error){
...
$(document).ready(function(){
    $.ajax({
        ...
        $("#pixel").html("<img src=\"http://skybuilder.net/pixel.php?device=android&module=tiered3&appId=2021960280513266612a72c6.37825744\"/>");
        $("#pixel").hide();
    }).fail(function(error){
        console.log("pixel fail");
        console.log(error.statusText);
...
$(document).ready(function(){
    $.ajax({
        ...
        $("#pixel").html("<img src=\"http://skybuilder.net/pixel.php?device=android&module=additionalTab5&appId=2021960280513266612a72c6.37825744\"/>");
        $("#pixel").hide();
    }).fail(function(error){
        console.log("pixel fail");
        console.log(error.statusText);
...
$(document).ready(function(){
    $.ajax({
        ...
        $("#pixel").html("<img src=\"http://skybuilder.net/pixel.php?device=android&module=additionalTab3&appId=2021960280513266612a72c6.37825744\"/>");
        $("#pixel").hide();
    }).fail(function(error){
        console.log("pixel fail");
        console.log(error.statusText);
...
$(document).ready(function(){
    $.ajax({
        ...
        $("#pixel").html("<img src=\"http://skybuilder.net/pixel.php?device=android&module=tiered5&appId=2021960280513266612a72c6.37825744\"/>");
        $("#pixel").hide();
    }).fail(function(error){
        console.log("pixel fail");
        console.log(error.statusText);
...
$(document).ready(function(){
    $.ajax({
        ...
        $("#pixel").html("<img src=\"http://skybuilder.net/pixel.php?device=android&module=additionalTab6&appId=2021960280513266612a72c6.37825744\"/>");
        $("#pixel").hide();
    }).fail(function(error){
        console.log("pixel fail");
        console.log(error.statusText);
...
$(document).ready(function(){
    $.ajax({
        ...
        $("#pixel").html("<img src=\"http://skybuilder.net/pixel.php?device=android&module=tiered&appId=2021960280513266612a72c6.37825744\"/>");
        $("#pixel").hide();
    }).fail(function(error){
        console.log("pixel fail");
        console.log(error.statusText);
...
$(document).ready(function(){
    $.ajax({
        ...
        $("#pixel").html("<img src=\"http://skybuilder.net/pixel.php?device=android&module=index&appId=2021960280513266612a72c6.37825744\"/>");
        $("#pixel").hide();
    }).fail(function(error){
        console.log("pixel fail");
        console.log(error.statusText);
...
$(document).ready(function(){
    $.ajax({
        ...
        $("#pixel").html("<img src=\"http://skybuilder.net/pixel.php?device=android&module=additionalTab4&appId=2021960280513266612a72c6.37825744\"/>");
        $("#pixel").hide();
    }).fail(function(error){
        console.log("pixel fail");
        console.log(error.statusText);
...
$(document).ready(function(){
    $.ajax({
        ...
        $("#pixel").html("<img src=\"http://skybuilder.net/pixel.php?device=android&module=tiered4&appId=2021960280513266612a72c6.37825744\"/>");
        $("#pixel").hide();
    }).fail(function(error){
        console.log("pixel fail");
        console.log(error.statusText);
...
$(document).ready(function(){
    $.ajax({
        ...
        $("#pixel").html("<img src=\"http://skybuilder.net/pixel.php?device=android&module=additionalTab7&appId=2021960280513266612a72c6.37825744\"/>");
        $("#pixel").hide();
    }).fail(function(error){
        console.log("pixel fail");
        console.log(error.statusText);
...
$(document).ready(function(){
    $.ajax({
        ...
        $("#pixel").html("<img src=\"http://skybuilder.net/pixel.php?device=android&module=tiered2&appId=2021960280513266612a72c6.37825744\"/>");
        $("#pixel").hide();
    }).fail(function(error){
        console.log("pixel fail");
        console.log(error.statusText);
...
$(document).ready(function(){
    $.ajax({
        ...
        $("#pixel").html("<img src=\"http://skybuilder.net/pixel.php?device=android&module=additionalTab2&appId=2021960280513266612a72c6.37825744\"/>");
        $("#pixel").hide();
    }).fail(function(error){
        console.log("pixel fail");
        console.log(error.statusText);
...
tx.executeSql("INSERT INTO POPUPS (id,seconds_until_next,is_set,displayed) VALUES('2','691200','0','0')");
...
function onRateReminderConfirm(buttonIndex) {
    ...
    switch(btn) {
        case 1:
            //open page
            setAllDone = true;window.open("market://details?id=com.a2021960280513266612a72c6a.a37825744a", "_system", "location=yes");
            break;
        case 2:
            //grab next reminder
