...
map.setCenter (lonLat, zoom);
	...
	(function() {
		fgLoader.loadApp('app.cna.to', 'cna');
		fgLoader.start();
	})();
...
define([
        ...
        "trim.it/fg/views/unioni"
        ],
        function(logger, $, baseView, ScrollableContainer, sedi, unioni) {
			return baseView.registerViews({
				...
				//unioni
				"scrollableContainerUnioni1": new ScrollableContainer({
					el : "wrapper_unioni1"
				}),
				"scrollableContainerUnioni2": new ScrollableContainer({
					el : "wrapper_unioni2"
				}),
				"scrollableContainerUnioni3": new ScrollableContainer({
					el : "wrapper_unioni3"
				}),
				"scrollableContainerUnioni4": new ScrollableContainer({
					el : "wrapper_unioni4"
				}),
				"scrollableContainerUnioni5": new ScrollableContainer({
					el : "wrapper_unioni5"
				}),
				"scrollableContainerUnioni6": new ScrollableContainer({
					el : "wrapper_unioni6"
				}),
				"scrollableContainerUnioni7": new ScrollableContainer({
					el : "wrapper_unioni7"
				}),
				"scrollableContainerUnioni8": new ScrollableContainer({
					el : "wrapper_unioni8"
				}),
				"scrollableContainerUnioni9": new ScrollableContainer({
					el : "wrapper_unioni9"
				})
			},{
				...
				"unioni1" : "scrollableContainerUnioni1",
				"unioni2" : "scrollableContainerUnioni2",
				"unioni3" : "scrollableContainerUnioni3",
				"unioni4" : "scrollableContainerUnioni4",
				"unioni5" : "scrollableContainerUnioni5",
				"unioni6" : "scrollableContainerUnioni6",
				"unioni7" : "scrollableContainerUnioni7",
				"unioni8" : "scrollableContainerUnioni8",
				"unioni9" : "scrollableContainerUnioni9"
			});
});
