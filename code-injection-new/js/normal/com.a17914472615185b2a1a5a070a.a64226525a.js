...
var end = "201 woodland st Nashville tn 37213";
  calcRoute(start,end);
}
  ...
  return string;
                      ...
                      $(document).ready(function() {
                          $("#submit").click(function() {
                              ...
                              extras[WebIntent.EXTRA_EMAIL] = "derrick.williams3@gmail.com";
   ...
   return tmp.textContent||tmp.innerText;
                ...
                function  rssReader() {
                   // alert("rssReader");
                    ...
                    //RSS url
                    var RSS = "http://news.google.com/news?q=Coma+Music+Festival&output=rss&num=100";
  ...
  return string;
                ...
                function  rssReader() {
                   // alert("rssReader");
                    ...
                    //RSS url
					var RSS="http://www.eventbrite.com/directoryxml/?q=Coma+Music+Festival";
                    //Stores entries
                    var entries = [];
                    var selectedEntry = "";
                    //alert("1");
