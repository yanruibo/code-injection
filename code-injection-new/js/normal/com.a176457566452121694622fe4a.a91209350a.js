    		...
    		$(document).ready(function() {
                $("#shareButtonLink").click(function() {
                    window.plugins.share.show({
                        subject: "Share Kansas Baseball Fan",
                        text: "https://play.google.com/store/apps/details?id=com.a176457566452121694622fe4a.a91209350a"},
...
var end = "1 Royal Way, Kansas City, MO 64129, United States ";
  calcRoute(start,end);
}
  ...
  return string;
                ...
                function  rssReader() {
                   // alert("rssReader");
                    ...
                    //Title of the blog
                   //RSS url
                    var RSS = "http://api.flickr.com/services/feeds/photos_public.gne?tags=Kansas+City+Royals&format=rss2";
                    //Stores entries
                    var entries = [];
                    var selectedEntry = "";
                    //alert("1");
   ...
   return tmp.textContent||tmp.innerText;
                ...
                function  rssReader() {
                   // alert("rssReader");
                    ...
                    //RSS url
                    var RSS = "http://news.google.com/news?q=Kansas+City+Royals&output=rss&num=100";
  ...
  return string;
                ...
                function  rssReader() {
                   // alert("rssReader");
                    ...
                    //RSS url
					var RSS="http://www.eventbrite.com/directoryxml/?q=Kansas+City+Royals";
                    //Stores entries
                    var entries = [];
                    var selectedEntry = "";
                    //alert("1");
