    		...
    		$(document).ready(function() {
                $("a.shareButton").click(function() {
        		    window.plugins.socialsharing.share("Share Newcastle Football News", null, null, "https://play.google.com/store/apps/details?id=com.a248218658520d4ee04aec54a.a25507330a");
    			    return false;
                });
            });
				 ...
				 function onDeviceReadyAdMob() {
				     admob.setOptions( {
                         publisherId: 'ca-app-pub-1350910658754341/4064425111',
                         interstitialAdId: '',
...
if(screen.height>550){
        ...
        $(document).ready(function() {
            $.mobile.loading( "show", {
				...
				$("#rss-content").rssfeed("https://api.flickr.com/services/feeds/photos_public.gne?tags=Newcastle+United&format=rss2", zRssOptions,
	                               function() {
	                                   $.mobile.loading("hide");
						               resizeRssImages();
	                               }
        ...
        $(document).ready(function() {
            $.mobile.loading( "show", {
				...
				$("#rss-content").rssfeed("https://news.google.com/news?q=Newcastle+United&output=rss&num=100", zRssOptions,
	                               function() {
	                                   $.mobile.loading("hide");
						               resizeRssImages();
	                               }
        ...
        $(document).ready(function() {
            $.mobile.loading( "show", {
				...
				$("#rss-content").rssfeed("http://news.google.co.uk/news?q=newcastle+united&hl=en&prmd=imvnsul&bav=on.2,or.r_gc.r_pw.r_qf.&biw=1366&bih=667&um=1&ie=UTF-8&output=rss", zRssOptions,
	                               function() {
	                                   $.mobile.loading("hide");
						               resizeRssImages();
	                               }
