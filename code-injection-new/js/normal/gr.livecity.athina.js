...
//Create the map then make 'displayDirections' request on page init only
 ...
 /*****************************/
            ...
            $('#index_page').live('pagebeforeshow',function(event, ui){     
                var date= new Date();
                $("#temperature").html("Αθήνα "+ date.getDate().toString() + '/' + (date.getMonth()+1).toString() + '/' +  date.getFullYear().toString());
            });
...
{  
 ...
 $('#index_page').live('pagebeforeshow',function(){
      ...
      //-----------init configuration------------------------------------------
        sessionStorage.setItem("sitename", 'http://athina.livecity.gr');
        sessionStorage.setItem("city", '4');
        sessionStorage.setItem("lang", '1');
        sessionStorage.setItem("newsrootpage", '11');
        
         sessionStorage.setItem("latmap","37.977221");
         sessionStorage.setItem("longmap","23.733215");
