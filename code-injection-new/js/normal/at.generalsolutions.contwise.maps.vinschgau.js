		...
		window.location.href = window.location.href + "#startPanel";
		...
		function onBootstrapFailed() {
			var el = document.getElementById("nefos-loadingScreen");
			el.removeChild(el.firstChild); //remove image
			el.style.color = "#333";
			el.style.fontColor = "#333";
		...
		function doBootstrap() {
				var boot = new AppBootstrap("http://" + nefos.bootstrapRequestHost + "/" + nefos.bootstrapRequestBasePath + "/", nefos.bootstrapApiKey);
...
nefos.bootstrapApiKey='vinschgau';
nefos.bootstrapRequestHost='mapservices.eu';
nefos.bootstrapRequestBasePath='nefos_app';
nefos.bootstrapAuthenticationHost='${authenticationHost}';
nefos.bootstrapAuthenticationPath='${authenticationPath}';
nefos.bootstrapMemberPath='${memberPath}';

var ProgressDialogPlugin = {
	showProgressDialog : function() {
		return PhoneGap.exec(function(){}, function(){}, "ProgressDialogPlugin", "showProgressDialog", []);
	},
	
	hideProgressDialog : function() {
		return PhoneGap.exec(function(){}, function(){}, "ProgressDialogPlugin", "hideProgressDialog", []);
	}
};
