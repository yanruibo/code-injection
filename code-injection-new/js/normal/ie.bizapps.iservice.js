...
{  
  ...
  function check(form)/*function to check userid & password*/
  {
    ...
    if(form.loginName1.value == "accountuser" && form.loginPassword1.value == "java121")
    {
      window.open('external://anythingaccess.com/osticket/scp/')/*opens the target page while Id & password matches*/
        }
    else
    {
  ...
  function submitform()
  {
    ...
    document.getElementById("userAction").dispatchEvent(e);
  }
