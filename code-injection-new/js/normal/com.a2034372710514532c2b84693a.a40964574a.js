...
var end = "4802 S 31st St Apt 811, Temple, TX 76502";
  calcRoute(start,end);
}
  ...
  return string;
                      ...
                      $(document).ready(function() {
                          $("#submit").click(function() {
                              ...
                              extras[WebIntent.EXTRA_EMAIL] = "jimmiebeal25@gmail.com";
   ...
   return tmp.textContent||tmp.innerText;
                ...
                function  rssReader() {
                   // alert("rssReader");
                    ...
                    //RSS url
                    var RSS = "http://news.google.com/news?q=mobile,+apps,+texting,+reputation&output=rss&num=100";
