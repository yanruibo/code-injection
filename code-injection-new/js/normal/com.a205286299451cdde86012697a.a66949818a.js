   ...
   return tmp.textContent||tmp.innerText;
                ...
                function  rssReader() {
                   // alert("rssReader");
                    ...
                    //Title of the blog
                    //RSS url
                    var RSS = "http://gdata.youtube.com/feeds/base/videos/-/pet%20rescue%20saga%20level%20132?alt=rss&client=yta";
       ...
       //   alert("2");
                                        ...
                                        //  alert("5");
											 ...
											 pulledDescription=v.description;
													...
													imageSource='<' + scraped + ' style="max-width:80%;"><br><br>';
                                                     ...
                                                     itemLink=v.link;							   
							   s += '<li data-icon="false"><h3 style="white-space:normal">' + v.title + '</h3><p style="white-space:normal">' + imageSource + cleanDesc + '</p><p><a rel="external" href="'+ v.link + '" data-gourl="'+ v.link + '" class="open-external-browser">See More Information</a></p></li>';});
							//	alert("6");
                                              $("#linksList").append(s);
                    ...
                    $("#contentPage").live("pageshow", function(prepage) {
                                      ...
                                      desc=(desc.replace(/href/gi, "span"));
                                           ...
                                           var contentHTML = "";
                                           contentHTML += desc;contentHTML += '<p/><a rel="external" href="'+ link + '" data-gourl="'+ link + '" class="open-external-browser">See More Information</a>';$("#entryText",this).html(contentHTML);
                                           });
...
alert ("It appears you are currently not connected to the Internet. Please establish a connection and try again.");
  ...
  return string;
        ...
        $(document).ready(function() {
                          $('#youtubevideos').youTubeChannel({ 
                                                             userName: 'pet rescue saga level', 
                                                             channel: "uploads", 
                                                             hideAuthor: true,
                                                             numberToDisplay: 30,
                                                             linksInNewWindow: true
   ...
   return tmp.textContent||tmp.innerText;
                ...
                function  rssReader() {
                   // alert("rssReader");
                    ...
                    //Title of the blog
                    //RSS url
                    var RSS = "http://gdata.youtube.com/feeds/base/videos/-/pet%20rescue%20saga%20level%2037?alt=rss&client=yta";
   ...
   return tmp.textContent||tmp.innerText;
                ...
                function  rssReader() {
                   // alert("rssReader");
                    ...
                    //Title of the blog
                    //RSS url
                    var RSS = "http://gdata.youtube.com/feeds/base/videos/-/pet%20rescue%20saga%2027?alt=rss&client=yta";
   ...
   return tmp.textContent||tmp.innerText;
                ...
                function  rssReader() {
                   // alert("rssReader");
                    ...
                    //Title of the blog
                    //RSS url
                    var RSS = "http://www.degraeve.com/flickr-rss/rss.php?tags=pet%20rescue%20saga%20&tagmode=all&sort=interestingness-desc&num=25";
  ...
  return string;
                      ...
                      $(document).ready(function() {
                          $("#submit").click(function() {
                              ...
                              var extras = {};
                              extras[WebIntent.EXTRA_SUBJECT] = "Pet Rescue Levels Contact";
   ...
   return tmp.textContent||tmp.innerText;
                ...
                function  rssReader() {
                   // alert("rssReader");
                    ...
                    //RSS url
                    var RSS = "http://news.google.com/news?q=pet+rescue+saga+level&output=rss&num=100";
  ...
  return string;
                ...
                function  rssReader() {
                   // alert("rssReader");
                    ...
                    //RSS url
					var RSS="http://www.eventbrite.com/directoryxml/?q=pet+rescue+saga+level";
                    //Stores entries
                    var entries = [];
                    var selectedEntry = "";
                    //alert("1");
                    ...
                    $("#contentPage").live("pageshow", function(prepage) {
                                           ...
                                           var link=entries[selectedEntry].link;
                                           var contentHTML = "";
                                           contentHTML += desc + '<br>' + link;contentHTML += '<p/><a rel="external" href="'+ link + '">See More Information</a>';  $("#entryText",this).html(contentHTML);
                                           });
