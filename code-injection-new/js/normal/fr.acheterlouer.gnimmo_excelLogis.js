    ...
    fillFromForm: function(formValues){
        ...
        */
        ...
        if(formValues['reference'] != ''){
			this.set('reference', formValues['reference']);
		}
        if(formValues['tri'] < 4){
...
Ext.define('MyApp.controller.Main', {
	...
	config: {
		refs: {
			...
			buttonHighlightGo:'button#highlight-go',
...
// 					items: [
// 						// prixa
// 						{ xtype: 'textfield', name: 'reference', label: 'R&eacute;f&eacute;rence', labelWidth:"50%" },
// 					]
// 				},
...
// 		var buttonhighlightgo = this.getButtonHighlightGo();
// 		buttonhighlightgo.disable();
								...
								items:[
									{ xtype:'panel',
										...
										items:[
											...
											{ xtype:'image', flex:1, itemId:'agencyShopImage', docked:'right', width:'80%', mode:'image',  cls:['agencyPageAgencyShopImage','tablet']},
										]
									},
...
// 				console.log('MyApp.view.phone.AgencyPage - setAgencyModel vitrine is ' + agencyDetailModel.get('vitrine'));
			...
			// Button Facebook
             blocSocial=this.down('#blocSocial'); 
			but = this.down('#butAgencyFacebook');
           // var fb=false;
            var panelFacebook=this.down('#panelFacebook');
			if (but && agencyDetailModel.get('facebook')){
