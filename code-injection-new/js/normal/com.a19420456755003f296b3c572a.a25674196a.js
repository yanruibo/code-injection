            ...
            if (__opts.userName != null) {
                ...
                function  rssReader() {
                   // alert("rssReader");
                    ...
                    //EDIT THESE LINES
                    //Title of the blog
                    var TITLE = "Photostream";
                    //RSS url
                    var RSS = "http://api.flickr.com/services/feeds/photos_public.gne?tags=Loving,Hut&format=rss2";
                    //Stores entries
                    var entries = [];
                    var selectedEntry = "";
                    //alert("1");
   ...
   return tmp.textContent||tmp.innerText;
				...
				$.mobile.showPageLoadingMsg();
                   // alert("rssReader");
                    ...
                    var TITLE = "News";
                    //RSS url
                    var RSS = "http://news.google.com/news?q=Loving+Hut+Vegan+lovin+hut&output=rss";
...
rssReader();
                ...
                function  rssReader() {
                   // alert("rssReader");
                    ...
                    var TITLE = "Photos";
                    //RSS url
                    var RSS = "http://api.flickr.com/services/feeds/photos_public.gne?id=82736782@N05&lang=en-us&format=rss_200";
                    //Stores entries
                    var entries = [];
                    var selectedEntry = "";
                    //listen for detail links
