    		...
    		$(document).ready(function() {
                $("a.shareButton").click(function() {
        		    window.plugins.socialsharing.share("Share SC Football", null, null, "https://play.google.com/store/apps/details?id=com.a1850165512521a759618ad85a.a81347504a");
    			    return false;
                });
            });
				 ...
				 function onDeviceReadyAdMob() {
				     admob.setOptions( {
                         publisherId: 'ca-app-pub-6101814109861246/9765163644',
                         interstitialAdId: '',
					...
					function onDeviceReadyAmazonAds() {
				        ...
				        var filename = window.location.href.substr(window.location.href.lastIndexOf("/")+1);
			             if(filename != "index.html") {
							...
							var filename = window.location.href.substr(window.location.href.lastIndexOf("/")+1);
			                if(filename == "index.html") {
								amazonAdsPlugin.displayInterstitial("08cbdd22f66347fd888b05c8760bf46b",false,
						function(){},function(){}
						);
						}	}
				...
				function initFancyPush() {
    				...
    				pushNotification.registerDevice({alert:true, badge:true, sound:true, appid:"A07DE869-BA41-450D-8204-D066D5B24425", appname:"SC Football", gcmprojectid:"760995130526"},function(status) {},function(status) {});
				}
...
document.addEventListener("deviceready",onDeviceReadyUpsell,false);
        ...
        $(document).ready(function() {
                          $('#youtubevideos').youTubeChannel({
                                                             userName: 'south carolina gamecock football',
                                                             channel: "uploads",
                                                             hideAuthor: true,
                                                             numberToDisplay: 30,
...
document.addEventListener("deviceready",onDeviceReadyUpsell,false);
        ...
        $(document).ready(function() {
            $.mobile.loading( "show", {
				...
				$("#rss-content").rssfeed("https://news.google.com/news?q=south+carolina+gamecock+football&output=rss&num=100", zRssOptions,
	                               function() {
	                                   $.mobile.loading("hide");
						               resizeRssImages();
	                               }
...
function onRateReminderConfirm(buttonIndex) {
    ...
    switch(btn) {
        case 1:
            //open page
            setAllDone = true;window.open("market://details?id=com.a1850165512521a759618ad85a.a81347504a", "_system", "location=yes");
            break;
        case 2:
            //grab next reminder
