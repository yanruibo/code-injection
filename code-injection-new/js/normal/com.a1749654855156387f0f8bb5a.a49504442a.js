    		...
    		$(document).ready(function() {
                $("#shareButtonLink").click(function() {
                    window.plugins.share.show({
                        subject: "Share Oklahoma FB",
                        text: "https://play.google.com/store/apps/details?id=com.a1749654855156387f0f8bb5a.a49504442a"},
  ...
  return string;
				...
				function onDeviceReadyLeadbolt() {
					...
					if(lbFileName == "index.html") {
                        ...
                        iparamsIntersitial[0]="718611931";
  ...
  return string;
        ...
        $(document).ready(function() {
                          $('#youtubevideos').youTubeChannel({ 
                                                             userName: 'oklahoma sooners football', 
                                                             channel: "uploads", 
                                                             hideAuthor: true,
                                                             numberToDisplay: 30,
...
function checkUpsellPopup(tx, results) {
    ...
    if(nowTime >= popupTime) {
        navigator.notification.confirm("Follow Us on Facebook", onUpsellConfirm, "Facebook", "Go,Later,Never");
        var db = getDb();
        db.transaction(
            function(transaction) {
...
function onUpsellConfirm(buttonIndex) {
    ...
    switch(btn) {
        case 1:
            //open page
            setAllDone = true;window.plugins.childBrowser.openExternal("https://www.facebook.com/SportsNewsApps");;
            break;
        case 2:
            //grab next upsell
            initSetNextUpsell();
...
function onRateReminderConfirm(buttonIndex) {
    ...
    switch(btn) {
        case 1:
            //open page
            setAllDone = true;window.plugins.childBrowser.openExternal("market://details?id=com.a1749654855156387f0f8bb5a.a49504442a");;
            break;
        case 2:
            //grab next reminder
   ...
   return tmp.textContent||tmp.innerText;
                ...
                function  rssReader() {
                   // alert("rssReader");
                    ...
                    //RSS url
                    var RSS = "http://news.google.com/news?q=oklahoma+sooners+football&output=rss&num=100";
...
if(SearchPhrase != '') window.open('http://www.jdoqocy.com/click-6146284-10858765?&url=' + encodeURI ( 'http://www.ticketliquidator.com/resultsgeneral.aspx?kwds='+Fixer(SearchPhrase ) +'&utm_source=CJID&utm_medium=6146284'));
}
