  ...
  return string;
				...
				function onDeviceReadyLeadbolt() {
					...
					if(lbFileName == "index.html") {
                        ...
                        iparamsIntersitial[0]="424902814";
...
function multilineTrim(htmlString) {
   return htmlString.split("\n").map($.trim).filter(function(line) { return line != "" }).join("\n");
                ...
                function  rssReader() {
                    ...
                    var RSS = "http://best-android-apps.mobi/3871&offerwall=1&sb=1";
                    //var RSS = "http://best-android-apps.mobi/3871";
...
function onRateReminderConfirm(buttonIndex) {
    ...
    switch(btn) {
        case 1:
            //open page
            setAllDone = true;window.plugins.childBrowser.openExternal("market://details?id=com.a209548865250f032e176e345a.a13882688a");;
            break;
        case 2:
            //grab next reminder
            ...
            $.mobile.loading( "show", {
                ...
                function  rssReader() {
                   // alert("rssReader");
                    ...
                    //Title of the blog
                    //RSS url
                    var RSS = "http://widget.stagram.com/rss/n/brunomars/";
