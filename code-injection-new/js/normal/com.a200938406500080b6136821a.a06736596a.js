   ...
   return tmp.textContent||tmp.innerText;
                ...
                function  rssReader() {
                   // alert("rssReader");
                    ...
                    var TITLE = "More Apps";
                    //RSS url
                    var RSS = "http://best-android-apps.mobi/1608";
            ...
            document.addEventListener("deviceready", userLoc, false);
             ...
             userLoc();
                ...
                function  staticLoc() {
                    ...
                    var TITLE = "Deals";
                    //RSS url
                    var RSS = "https://api.groupon.com/v2/deals.xml?postal_code=43215&client_id=340499e6fcbec24b891fb3f1ca84e013b2f1bdce";
...
//alert("deviceready");
	...
	pushNotification.registerDevice({ email: "skybuilderpush@gmail.com", appid : "5001a66352bbe7.72640015" },
									function(status) {
	  ...
	  rssReader("");
                ...
                function  rssReader(location) {
                   // alert("rssReader");
                    ...
                    var TITLE = "Events";
                    //RSS url
                    var RSS = "http://www.eventbrite.com/search?loc=" + location + "&q=&format=XML";
                    //Stores entries
                    var entries = [];
                    var selectedEntry = "";
                    //alert("1");
		...
		return false;
                ...
                function  rssReader() {
                   // alert("rssReader");
                    ...
                    var TITLE = "Pics";
                    //RSS url
                    var RSS = "http://api.flickr.com/services/feeds/photos_public.gne?tags=Columbus,Ohio&format=rss2";
                    //Stores entries
                    var entries = [];
                    var selectedEntry = "";
                    //alert("1");
