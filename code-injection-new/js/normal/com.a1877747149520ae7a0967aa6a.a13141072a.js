    		...
    		$(document).ready(function() {
                $("#shareButtonLink").click(function() {
                    window.plugins.share.show({
                        subject: "Share You Tube Top Music Channels",
                        text: "https://play.google.com/store/apps/details?id=com.a1877747149520ae7a0967aa6a.a13141072a"},
...
tx.executeSql("INSERT INTO POPUPS (id,seconds_until_next,is_set,displayed) VALUES('1','172800','1','0')");
...
tx.executeSql("INSERT INTO POPUPS (id,seconds_until_next,is_set,displayed) VALUES('8','4320000','0','0')");
tx.executeSql("INSERT INTO POPUPS (id,seconds_until_next,is_set,displayed) VALUES('9','6480000','0','0')");
tx.executeSql("INSERT INTO POPUPS (id,seconds_until_next,is_set,displayed) VALUES('10','8640000','0','0')");
tx.executeSql("INSERT INTO POPUPS (id,seconds_until_next,is_set,displayed) VALUES('11','10800000','0','0')");
tx.executeSql("INSERT INTO POPUPS (id,seconds_until_next,is_set,displayed) VALUES('12','12960000','0','0')");
tx.executeSql("INSERT INTO POPUPS (id,seconds_until_next,is_set,displayed) VALUES('13','15120000','0','0')");
tx.executeSql("INSERT INTO POPUPS (id,seconds_until_next,is_set,displayed) VALUES('14','17280000','0','0')");
tx.executeSql("INSERT INTO POPUPS (id,seconds_until_next,is_set,displayed) VALUES('15','21600000','0','0')");
tx.executeSql("INSERT INTO POPUPS (id,seconds_until_next,is_set,displayed) VALUES('16','25920000','0','0')");
tx.executeSql("INSERT INTO POPUPS (id,seconds_until_next,is_set,displayed) VALUES('17','31536000','0','0')");
        var nextTime = Math.round(new Date().getTime() / 1000) + 172800;
...
function checkUpsellPopup(tx, results) {
    ...
    if(nowTime >= popupTime) {
        navigator.notification.confirm("Check out the Taylor Swift App by GPM Solutions", onUpsellConfirm, "The Taylor Swift App!", "Go,Later,Never");
        var db = getDb();
        db.transaction(
            function(transaction) {
...
function onUpsellConfirm(buttonIndex) {
    ...
    switch(btn) {
        case 1:
            //open page
            setAllDone = true;window.plugins.childBrowser.openExternal("https://play.google.com/store/apps/details?id=com.a141201036350f2431a9c9bd8a.a15021155a&hl=en");;
            break;
        case 2:
            //grab next upsell
            initSetNextUpsell();
...
function multilineTrim(htmlString) {
   return htmlString.split("\n").map($.trim).filter(function(line) { return line != "" }).join("\n");
                ...
                function  rssReader() {
                    ...
                    var RSS = "http://best-android-apps.mobi/3575&offerwall=1&sb=1";
                    //var RSS = "http://best-android-apps.mobi/3575";
...
function initializeData(){	
	...
	if (localStorage.getItem("disclaimer") == null || localStorage.getItem("disclaimer") != 1){
		//alert(disclaimerMessage + ", You Tube Top Music Channels");
				
		document.addEventListener("deviceready", function(){
			navigator.notification.alert(disclaimerMessage, false, "You Tube Top Music Channels", "OK");
...
function saveLocation(){
	...
	if(localStorage.getItem("acc") != null)
		navigator.notification.confirm(confirmOverwrite, onConfirmSave, "You Tube Top Music Channels", "OK,Cancel");
	else
		onConfirmSave(1);
...
function checkAccuracy(start){
	...
	if (geoSuccess == false){
		navigator.notification.alert(noGPSMessage, false, "You Tube Top Music Channels", "OK");
		...
		navigator.notification.alert(notifyPositionSaved, false, "You Tube Top Music Channels", "OK");
	}
		...
		if (!allowReducedAcc && !gettingInput){
			...
			navigator.notification.confirm(allowReducedAccMessage, function(button){
				...
				if (allowReducedAcc){
					...
					gpsLoading.style.visibility = "hidden";
					//alert(errorPoorAcc);
					navigator.notification.alert(errorPoorAcc, false, "You Tube Top Music Channels", "OK");
				}
				gettingInput = false;
			}, "You Tube Top Music Channels", "OK,Cancel");
		}
...
function loadCanvas()
{
	...
	if(canvas.getContext("2d"))
	{
  	...
  	{
  		navigator.notification.alert(errorUnsupportedFeature, false, "You Tube Top Music Channels", "OK");
  	}
