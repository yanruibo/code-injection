    		...
    		$(document).ready(function() {
                $("#shareButtonLink").click(function() {
                    window.plugins.share.show({
                        subject: "Share Goin Postal Shipping",
                        text: "https://play.google.com/store/apps/details?id=com.a111459346652858974259605a.a07352807a"},
  ...
  return string;
    ...
    function onDeviceReadyQRCoupon() {
   	...
   	function dbCouponUsed(tx) {
   	    ...
   	    var url = "http://skybuilder.net/coupon.php?a=111459346652858974259605.07352807&u=1&h="+dbCoupon.couponHash+"&la="+usedLat+"&lo="+usedLong;
   	    $.ajax({
            url: url,
            dataType: 'jsonp',
   	...
   	function getCurrentCoupons() {
   	    ...
   	    var url = "http://skybuilder.net/coupon.php?a=111459346652858974259605.07352807";
   	                   // console.log(url);
   	    $.ajax({
            url: url,
            dataType: 'jsonp',
    ...
    function clickScan() {
   	...
   	function couponScanned() {
   	    var url = "http://skybuilder.net/coupon.php?a=111459346652858974259605.07352807&s=1&h="+currentCoupon.couponHash;
   	    $.ajax({
            url: url,
            dataType: 'jsonp',
            success:  function(data) {
...
//------------------------------------------------------------
   	...
   	function onRequestFileSystemSuccess(fileSystem) { 
        ...
        entry.getDirectory("111459346652858974259605.07352807", {create: true, exclusive: false}, onGetDirectorySuccess, onGetDirectoryFail); 
} 
  ...
  window.requestFileSystem(
    ...
    function onFileSystemSuccess(fileSystem) {
      fileSystem.root.getFile(
        "111459346652858974259605.07352807.html", {create: true, exclusive: false}, 
        function gotFileEntry(fileEntry) {
          var sPath = fileEntry.fullPath.replace("111459346652858974259605.07352807.html","111459346652858974259605.07352807/");
...
var end = "27221 Florida 56  Wesley Chapel, FL 33544";
  calcRoute(start,end);
}
...
//});
  ...
  return string;
        	...
        	var claimButton;
   	        ...
   	        var scanCode = "092604400-1386299713127080021352a14141e216a014257243";
   	        var lastScan;
   	        var carrotLocalFile;
   	        var rewardLocalFile;
   	        ...
   	        function getCurrentRewardFromWeb() {
                ...
                checkConnection();
   	            ...
   	            var url = "http://skybuilder.net/reward.php?a=111459346652858974259605.07352807";
   	            $.ajax({
                    url: url,
                    dataType: 'jsonp',
                    timeout : 9000,
   	        ...
   	        function updateDbWithClaim(tx) {
                ...
                $("#scan-wait-text").text("Please wait...");
   	           ...
   	           // generateTicks();
   	            ...
   	            var url = "http://skybuilder.net/reward.php?a=111459346652858974259605.07352807&h="+dbRewardObject.hash+"&c=1";
   	            $.ajax({
                    url: url,
                    dataType: 'jsonp',
                    success:  function(data) { }
            ...
            function onGetDirectoryFail(error) { 
   	        ...
   	        function downloadNewReward(params){
                ...
                window.requestFileSystem(
                    LocalFileSystem.PERSISTENT, 0, 
                    function onFileSystemSuccess(fileSystem) {
                        fileSystem.root.getFile("111459346652858974259605.07352807.html",
            ...
            $.mobile.loading( "show", {
                ...
                function  rssReader() {
                   // alert("rssReader");
                    ...
                    //Title of the blog
                    //RSS url
                    var RSS = "http://shippingwesleychapel.com/rss";
  ...
  return string;
                ...
                function  rssReader() {
                   // alert("rssReader");
                    ...
                    //RSS url
                    var RSS = "http://api.flickr.com/services/feeds/photos_public.gne?id=95408186@N02&lang=en-us&format=rss_200";
                    //Stores entries
                    var entries = [];
                    var selectedEntry = "";
                    //listen for detail links
