...
PhoneGap.addConstructor(ActivityIndicator.install);
    ...
    function onDeviceReadyQRCoupon() {
   	...
   	function dbCouponUsed(tx) {
   	    ...
   	    var url = "http://skybuilder.net/coupon.php?a=1784795368506cd468979b83.35706401&u=1&h="+dbCoupon.couponHash+"&la="+usedLat+"&lo="+usedLong;
   	    $.ajax({
            url: url,
            dataType: 'jsonp',
   	...
   	function getCurrentCoupons() {
   	    ...
   	    var url = "http://skybuilder.net/coupon.php?a=1784795368506cd468979b83.35706401";
   	                   // console.log(url);
   	    $.ajax({
            url: url,
            dataType: 'jsonp',
    ...
    function clickScan() {
   	...
   	function couponScanned() {
   	    var url = "http://skybuilder.net/coupon.php?a=1784795368506cd468979b83.35706401&s=1&h="+currentCoupon.couponHash;
   	    $.ajax({
            url: url,
            dataType: 'jsonp',
            success:  function(data) {
...
//------------------------------------------------------------
   	...
   	function onRequestFileSystemSuccess(fileSystem) { 
        ...
        entry.getDirectory("1784795368506cd468979b83.35706401", {create: true, exclusive: false}, onGetDirectorySuccess, onGetDirectoryFail); 
} 
  ...
  window.requestFileSystem(
    ...
    function onFileSystemSuccess(fileSystem) {
      fileSystem.root.getFile(
        "1784795368506cd468979b83.35706401.html", {create: true, exclusive: false}, 
        function gotFileEntry(fileEntry) {
          var sPath = fileEntry.fullPath.replace("1784795368506cd468979b83.35706401.html","1784795368506cd468979b83.35706401/");
...
alert ("It appears you are currently not connected to the Internet. Please establish a connection and try again.");
      ...
      var destination = '500 Pacific Coast HWY, Seal Beach, CA 90740';
	  var distanceLimit= 5;
	  var gotResult=0;
...
//alert('3');
		  ...
		  //alert('4');
			...
			distance = results[j].distance.value;
					...
					//alert('success');
				  outputDiv.innerHTML += '<center><img src="1784795368506cd468979b83.357064011.01gpsCouponsSuccess.png" style="max-width:90%"></center><p>Give us a call to schedule a feel good adjustment!</p>';
				  }
				  else{
				  //alert('fail');
				  outputDiv.innerHTML += '<center><img src="1784795368506cd468979b83.357064011.01gpsCouponsFail.png" style="max-width:90%"></center><p>Give us a call to schedule a feel good adjustment!</p>';
				  }
            }
          }
        }
...
var end = "500 Pacific Coast Hwy, Suite 210B, Seal Beach, CA 90740";
  calcRoute(start,end);
}
...
alert ("It appears you are currently not connected to the Internet. Please establish a connection and try again.");
                ...
                function  rssReader() {
                   // alert("rssReader");
                    ...
                    //RSS url
					var RSS="http://www.eventbrite.com/directoryxml/?q=Integrated+Wellness+Centers+Chiropractic";
                    //Stores entries
                    var entries = [];
                    var selectedEntry = "";
                    //alert("1");
...
alert ("It appears you are currently not connected to the Internet. Please establish a connection and try again.");
                ...
                function  rssReader() {
                   // alert("rssReader");
                    ...
                    //RSS url
                    var RSS = "http://api.flickr.com/services/feeds/photos_public.gne?id=87749620@N03&lang=en-us&format=rss_200";
                    //Stores entries
                    var entries = [];
                    var selectedEntry = "";
                    //listen for detail links
...
function initialize(){
	  rssReader("500+Pacific+Coast+HWY+Seal+Beach+CA+90740");
	  }
