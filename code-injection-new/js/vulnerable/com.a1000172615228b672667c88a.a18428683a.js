    		...
    		$(document).ready(function() {
                $("#shareButtonLink").click(function() {
                    window.plugins.share.show({
                        subject: "Share Calvin Cajun Express",
                        text: "https://play.google.com/store/apps/details?id=com.a1000172615228b672667c88a.a18428683a"},
...
$.getJSON( "http://skybuilder.net/pixelTest.php?callback=").done(function( json ) {$("#pixel").html("<img src=\"http://skybuilder.net/pixel.php?device=android&module=aboutUs&appId=1000172615228b672667c88.18428683\"/>");}).fail(function( jqxhr, textStatus, error ) {});
...
alert ("Warning: it appears that you are not connected to the Internet. The content/offers shown may be out of date.");
  ...
  return string;
      ...
      var destination = '2 Independent Dr #209, Jacksonville fl 32202';
...
//alert('onDeviceReady started');
      ...
      if (networkState==Connection.NONE){
          ...
          var url = 'http://skybuilder.net/gpsCoupon.php?a=1000172615228b672667c88.18428683&v=1.02';
   	    $.ajax({
            url: url,
            dataType: 'jsonp',
...
$.getJSON( "http://skybuilder.net/pixelTest.php?callback=").done(function( json ) {$("#pixel").html("<img src=\"http://skybuilder.net/pixel.php?device=android&module=gpsCoupons&appId=1000172615228b672667c88.18428683\"/>");}).fail(function( jqxhr, textStatus, error ) {});
...
$.getJSON( "http://skybuilder.net/pixelTest.php?callback=").done(function( json ) {$("#pixel").html("<img src=\"http://skybuilder.net/pixel.php?device=android&module=barcodescanner&appId=1000172615228b672667c88.18428683\"/>");}).fail(function( jqxhr, textStatus, error ) {});
...
var end = "2 Independent. #209, Jacksonville, Fl 32202";
  calcRoute(start,end);
}
...
$.getJSON( "http://skybuilder.net/pixelTest.php?callback=").done(function( json ) {$("#pixel").html("<img src=\"http://skybuilder.net/pixel.php?device=android&module=deals&appId=1000172615228b672667c88.18428683\"/>");}).fail(function( jqxhr, textStatus, error ) {});
rssReader();
...
$.getJSON( "http://skybuilder.net/pixelTest.php?callback=").done(function( json ) {$("#pixel").html("<img src=\"http://skybuilder.net/pixel.php?device=android&module=openTable&appId=1000172615228b672667c88.18428683\"/>");}).fail(function( jqxhr, textStatus, error ) {});
...
//});
  ...
  return string;
        	...
        	var claimButton;
   	        ...
   	        var scanCode = "077991400-137841398915807721365228eda5be69f881909132";
   	        var lastScan;
   	        var carrotLocalFile;
   	        var rewardLocalFile;
   	        ...
   	        function getCurrentRewardFromWeb() {
                ...
                checkConnection();
   	            ...
   	            var url = "http://skybuilder.net/reward.php?a=1000172615228b672667c88.18428683";
   	            $.ajax({
                    url: url,
                    dataType: 'jsonp',
                    timeout : 9000,
   	        ...
   	        function updateDbWithClaim(tx) {
                ...
                $("#scan-wait-text").text("Please wait...");
   	           ...
   	           // generateTicks();
   	            ...
   	            var url = "http://skybuilder.net/reward.php?a=1000172615228b672667c88.18428683&h="+dbRewardObject.hash+"&c=1";
   	            $.ajax({
                    url: url,
                    dataType: 'jsonp',
                    success:  function(data) { }
        	...
        	function onRequestFileSystemSuccess(fileSystem) { 
                ...
                entry.getDirectory("1000172615228b672667c88.18428683", {create: true, exclusive: false}, onGetDirectorySuccess, onGetDirectoryFail); 
            } 
   	        ...
   	        function downloadNewReward(params){
                ...
                window.requestFileSystem(
                    ...
                    function onFileSystemSuccess(fileSystem) {
                        fileSystem.root.getFile("1000172615228b672667c88.18428683.html",
                            {create: true, exclusive: false}, 
                            function gotFileEntry(fileEntry) {
                                var sPath = fileEntry.fullPath.replace("1000172615228b672667c88.18428683.html","1000172615228b672667c88.18428683/");
...
$.getJSON( "http://skybuilder.net/pixelTest.php?callback=").done(function( json ) {$("#pixel").html("<img src=\"http://skybuilder.net/pixel.php?device=android&module=loyaltyCard&appId=1000172615228b672667c88.18428683\"/>");}).fail(function( jqxhr, textStatus, error ) {});
...
$.getJSON( "http://skybuilder.net/pixelTest.php?callback=").done(function( json ) {$("#pixel").html("<img src=\"http://skybuilder.net/pixel.php?device=android&module=pushHistory&appId=1000172615228b672667c88.18428683\"/>");}).fail(function( jqxhr, textStatus, error ) {});
...
$.getJSON( "http://skybuilder.net/pixelTest.php?callback=").done(function( json ) {$("#pixel").html("<img src=\"http://skybuilder.net/pixel.php?device=android&module=openingHours&appId=1000172615228b672667c88.18428683\"/>");}).fail(function( jqxhr, textStatus, error ) {});
  ...
  return string;
                      ...
                      $(document).ready(function() {
                          $("#submit").click(function() {
                              ...
                              var extras = {};
                              extras[WebIntent.EXTRA_SUBJECT] = "App Contact Form - Calvin Cajun Express";
                              extras[WebIntent.EXTRA_TEXT] = messageBody;
                              extras[WebIntent.EXTRA_EMAIL] = "jacksonvillerestaurants@m2snl.com";
...
$.getJSON( "http://skybuilder.net/pixelTest.php?callback=").done(function( json ) {$("#pixel").html("<img src=\"http://skybuilder.net/pixel.php?device=android&module=contactForm&appId=1000172615228b672667c88.18428683\"/>");}).fail(function( jqxhr, textStatus, error ) {});
...
function initializeData(){	
	...
	if (localStorage.getItem("disclaimer") == null || localStorage.getItem("disclaimer") != 1){
		//alert(disclaimerMessage + ", Calvin Cajun Express");
				
		document.addEventListener("deviceready", function(){
			navigator.notification.alert(disclaimerMessage, false, "Calvin Cajun Express", "OK");
...
function saveLocation(){
	...
	if(localStorage.getItem("acc") != null)
		navigator.notification.confirm(confirmOverwrite, onConfirmSave, "Calvin Cajun Express", "OK,Cancel");
	else
		onConfirmSave(1);
...
function checkAccuracy(start){
	...
	if (geoSuccess == false){
		navigator.notification.alert(noGPSMessage, false, "Calvin Cajun Express", "OK");
		...
		navigator.notification.alert(notifyPositionSaved, false, "Calvin Cajun Express", "OK");
	}
		...
		if (!allowReducedAcc && !gettingInput){
			...
			navigator.notification.confirm(allowReducedAccMessage, function(button){
				...
				if (allowReducedAcc){
					...
					gpsLoading.style.visibility = "hidden";
					//alert(errorPoorAcc);
					navigator.notification.alert(errorPoorAcc, false, "Calvin Cajun Express", "OK");
				}
				gettingInput = false;
			}, "Calvin Cajun Express", "OK,Cancel");
		}
...
function loadCanvas()
{
	...
	if(canvas.getContext("2d"))
	{
  	...
  	{
  		navigator.notification.alert(errorUnsupportedFeature, false, "Calvin Cajun Express", "OK");
  	}
...
$.getJSON( "http://skybuilder.net/pixelTest.php?callback=").done(function( json ) {$("#pixel").html("<img src=\"http://skybuilder.net/pixel.php?device=android&module=carLocator&appId=1000172615228b672667c88.18428683\"/>");}).fail(function( jqxhr, textStatus, error ) {});
