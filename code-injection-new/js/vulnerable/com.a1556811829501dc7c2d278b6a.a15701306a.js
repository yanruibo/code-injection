...
alert ("It appears you are currently not connected to the Internet. Please establish a connection and try again.");
                ...
                function  rssReader() {
                   // alert("rssReader");
                    ...
                    //Title of the blog
                   //RSS url
                    var RSS = "http://api.flickr.com/services/feeds/photos_public.gne?tags=Italy&format=rss2";
                    //Stores entries
                    var entries = [];
                    var selectedEntry = "";
                    //alert("1");
...
// <![CDATA[
var cm_uid = '2715f3f0-ddf5-4f82-b491-225db7dc4280';
 var cm_div = 'cm_module_80897';
    
document.write('<sc'+'ript');
document.write(' type="text/javascript"');
document.write(' language="JavaScript"');
document.write(' src="http://classmeteo.weather.com/ClassMeteoOnYourWebsite/cmwidget/WidgetServlet');
document.write('?uid='+cm_uid+"&div="+cm_div+'">');
document.write('</sc'+'ript>');
// ]]>
