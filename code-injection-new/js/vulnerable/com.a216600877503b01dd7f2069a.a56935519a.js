...
// <![CDATA[
document.write('<script language="JavaScript" src="http://www.worldweatheronline.com/widget/v2/weather-widget.ashx?locid=1774917&root_id=1774662&wc=LOCAL_WEATHER&map=~/chaslands-weather-widget/nz.aspx&width=220&custom_header=Chaslands Weather, New Zealand&num_of_day=6&title_bg_color=020202&title_text_color=FFFFFF&widget_bg_color=FFFFFF&widget_text_color=020202&type=js&cb=' + Math.random() + '" type="text/javascript"><\/scr' + 'ipt>');
// ]]>
  ...
  return string;
                      ...
                      $(document).ready(function() {
                          $("#submit").click(function() {
                              ...
                              extras[WebIntent.EXTRA_EMAIL] = "info@catlinsitineraries.com";
   ...
   return tmp.textContent||tmp.innerText;
                ...
                function  rssReader() {
                   // alert("rssReader");
                    ...
                    //RSS url
                    var RSS = "http://news.google.com/news?q=catlins&output=rss&num=100";
