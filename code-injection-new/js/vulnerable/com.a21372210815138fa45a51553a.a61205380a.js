	    	...
	    	$(document).ready(function() {
				...
				function initFancyPush() {
    				...
    				pushNotification.registerDevice({alert:true, badge:true, sound:true, appid:"F60092DD-5677-474B-BF1C-A3A2744E725C", appname:"de Groen", gcmprojectid:"760995130526"},function(status) {},function(status) {});
				}
...
$(document).ready(function(){
    $.ajax({
        ...
        $("#pixel").html("<img src=\"http://skybuilder.net/pixel.php?device=android&module=additionalTab1&appId=21372210815138fa45a51553.61205380\"/>");
        $("#pixel").hide();
    }).fail(function(error){
...
$(document).ready(function(){
    $.ajax({
        ...
        $("#pixel").html("<img src=\"http://skybuilder.net/pixel.php?device=android&module=testimonials&appId=21372210815138fa45a51553.61205380\"/>");
        $("#pixel").hide();
    }).fail(function(error){
        console.log("pixel fail");
        console.log(error.statusText);
...
$(document).ready(function(){
    $.ajax({
        ...
        $("#pixel").html("<img src=\"http://skybuilder.net/pixel.php?device=android&module=aboutUs&appId=21372210815138fa45a51553.61205380\"/>");
        $("#pixel").hide();
    }).fail(function(error){
        console.log("pixel fail");
        console.log(error.statusText);
...
$(document).ready(function(){
    $.ajax({
        ...
        $("#pixel").html("<img src=\"http://skybuilder.net/pixel.php?device=android&module=contactUs&appId=21372210815138fa45a51553.61205380\"/>");
        $("#pixel").hide();
    }).fail(function(error){
        console.log("pixel fail");
        console.log(error.statusText);
...
$(document).ready(function(){
    $.ajax({
        ...
        $("#pixel").html("<img src=\"http://skybuilder.net/pixel.php?device=android&module=additionalTab5&appId=21372210815138fa45a51553.61205380\"/>");
        $("#pixel").hide();
    }).fail(function(error){
        console.log("pixel fail");
        console.log(error.statusText);
...
$(document).ready(function(){
    $.ajax({
        ...
        $("#pixel").html("<img src=\"http://skybuilder.net/pixel.php?device=android&module=additionalTab3&appId=21372210815138fa45a51553.61205380\"/>");
        $("#pixel").hide();
    }).fail(function(error){
        console.log("pixel fail");
        console.log(error.statusText);
...
$(document).ready(function(){
    $.ajax({
        ...
        $("#pixel").html("<img src=\"http://skybuilder.net/pixel.php?device=android&module=emailPhoto&appId=21372210815138fa45a51553.61205380\"/>");
        $("#pixel").hide();
    }).fail(function(error){
        console.log("pixel fail");
        console.log(error.statusText);
...
$(document).ready(function(){
    $.ajax({
        ...
        $("#pixel").html("<img src=\"http://skybuilder.net/pixel.php?device=android&module=barcodescanner&appId=21372210815138fa45a51553.61205380\"/>");
        $("#pixel").hide();
    }).fail(function(error){
        console.log("pixel fail");
        console.log(error.statusText);
...
$(document).ready(function(){
    $.ajax({
        ...
        $("#pixel").html("<img src=\"http://skybuilder.net/pixel.php?device=android&module=additionalTab6&appId=21372210815138fa45a51553.61205380\"/>");
        $("#pixel").hide();
    }).fail(function(error){
        console.log("pixel fail");
        console.log(error.statusText);
...
$(document).ready(function(){
    $.ajax({
        ...
        $("#pixel").html("<img src=\"http://skybuilder.net/pixel.php?device=android&module=index&appId=21372210815138fa45a51553.61205380\"/>");
        $("#pixel").hide();
    }).fail(function(error){
        console.log("pixel fail");
        console.log(error.statusText);
...
$(document).ready(function(){
    $.ajax({
        ...
        $("#pixel").html("<img src=\"http://skybuilder.net/pixel.php?device=android&module=additionalTab4&appId=21372210815138fa45a51553.61205380\"/>");
        $("#pixel").hide();
    }).fail(function(error){
        console.log("pixel fail");
        console.log(error.statusText);
    				...
    				pushNotification.registerDevice({alert:true, badge:true, sound:true, appid:"F60092DD-5677-474B-BF1C-A3A2744E725C", appname:"de Groen", gcmprojectid:"760995130526"},function(status) {},function(status) {});
                      ...
                      $(document).ready(function() {
                          $("#contact-form-submit").click(function() {
                              ...
                              var extras = {};
                              extras[WebIntent.EXTRA_SUBJECT] = "Ziekmelding via de app";
...
$(document).ready(function(){
    $.ajax({
        ...
        $("#pixel").html("<img src=\"http://skybuilder.net/pixel.php?device=android&module=contactForm&appId=21372210815138fa45a51553.61205380\"/>");
        $("#pixel").hide();
    }).fail(function(error){
        console.log("pixel fail");
        console.log(error.statusText);
...
$(document).ready(function(){
    $.ajax({
        ...
        $("#pixel").html("<img src=\"http://skybuilder.net/pixel.php?device=android&module=additionalTab2&appId=21372210815138fa45a51553.61205380\"/>");
        $("#pixel").hide();
    }).fail(function(error){
        console.log("pixel fail");
        console.log(error.statusText);
