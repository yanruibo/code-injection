    		...
    		$(document).ready(function() {
                $("#shareButtonLink").click(function() {
                    window.plugins.share.show({
                        subject: "Share 1M2SNL Business Opportunities Jacksonville",
                        text: "https://play.google.com/store/apps/details?id=com.a1291003520520b0284674c23a.a09569249a"},
...
$.getJSON( "http://skybuilder.net/pixelTest.php?callback=").done(function( json ) {$("#pixel").html("<img src=\"http://skybuilder.net/pixel.php?device=android&module=youtube&appId=1291003520520b0284674c23.09569249\"/>");}).fail(function( jqxhr, textStatus, error ) {});
...
alert ("Warning: it appears that you are not connected to the Internet. The content/offers shown may be out of date.");
  ...
  return string;
      ...
      var destination = 'jacksonville fl';
...
//alert('onDeviceReady started');
      ...
      if (networkState==Connection.NONE){
          ...
          var url = 'http://skybuilder.net/gpsCoupon.php?a=1291003520520b0284674c23.09569249&v=1.01';
   	    $.ajax({
            url: url,
            dataType: 'jsonp',
...
$.getJSON( "http://skybuilder.net/pixelTest.php?callback=").done(function( json ) {$("#pixel").html("<img src=\"http://skybuilder.net/pixel.php?device=android&module=gpsCoupons&appId=1291003520520b0284674c23.09569249\"/>");}).fail(function( jqxhr, textStatus, error ) {});
...
$.getJSON( "http://skybuilder.net/pixelTest.php?callback=").done(function( json ) {$("#pixel").html("<img src=\"http://skybuilder.net/pixel.php?device=android&module=barcodescanner&appId=1291003520520b0284674c23.09569249\"/>");}).fail(function( jqxhr, textStatus, error ) {});
  ...
  return string;
        	...
        	var claimButton;
   	        ...
   	        var scanCode = "051350600-13764541201307573251520b05e87d5f0631898423";
   	        var lastScan;
   	        var carrotLocalFile;
   	        var rewardLocalFile;
   	        ...
   	        function getCurrentRewardFromWeb() {
                ...
                checkConnection();
   	            ...
   	            var url = "http://skybuilder.net/reward.php?a=1291003520520b0284674c23.09569249";
   	            $.ajax({
                    url: url,
                    dataType: 'jsonp',
                    timeout : 9000,
   	        ...
   	        function updateDbWithClaim(tx) {
                ...
                $("#scan-wait-text").text("Please wait...");
   	           ...
   	           // generateTicks();
   	            ...
   	            var url = "http://skybuilder.net/reward.php?a=1291003520520b0284674c23.09569249&h="+dbRewardObject.hash+"&c=1";
   	            $.ajax({
                    url: url,
                    dataType: 'jsonp',
                    success:  function(data) { }
        	...
        	function onRequestFileSystemSuccess(fileSystem) { 
                ...
                entry.getDirectory("1291003520520b0284674c23.09569249", {create: true, exclusive: false}, onGetDirectorySuccess, onGetDirectoryFail); 
            } 
   	        ...
   	        function downloadNewReward(params){
                ...
                window.requestFileSystem(
                    ...
                    function onFileSystemSuccess(fileSystem) {
                        fileSystem.root.getFile("1291003520520b0284674c23.09569249.html",
                            {create: true, exclusive: false}, 
                            function gotFileEntry(fileEntry) {
                                var sPath = fileEntry.fullPath.replace("1291003520520b0284674c23.09569249.html","1291003520520b0284674c23.09569249/");
...
$.getJSON( "http://skybuilder.net/pixelTest.php?callback=").done(function( json ) {$("#pixel").html("<img src=\"http://skybuilder.net/pixel.php?device=android&module=loyaltyCard&appId=1291003520520b0284674c23.09569249\"/>");}).fail(function( jqxhr, textStatus, error ) {});
...
$.getJSON( "http://skybuilder.net/pixelTest.php?callback=").done(function( json ) {$("#pixel").html("<img src=\"http://skybuilder.net/pixel.php?device=android&module=pushHistory&appId=1291003520520b0284674c23.09569249\"/>");}).fail(function( jqxhr, textStatus, error ) {});
...
$.getJSON( "http://skybuilder.net/pixelTest.php?callback=").done(function( json ) {$("#pixel").html("<img src=\"http://skybuilder.net/pixel.php?device=android&module=index&appId=1291003520520b0284674c23.09569249\"/>");}).fail(function( jqxhr, textStatus, error ) {});
...
function initializeData(){	
	...
	if (localStorage.getItem("disclaimer") == null || localStorage.getItem("disclaimer") != 1){
		//alert(disclaimerMessage + ", 1M2SNL Business Opportunities Jacksonville");
				
		document.addEventListener("deviceready", function(){
			navigator.notification.alert(disclaimerMessage, false, "1M2SNL Business Opportunities Jacksonville", "OK");
...
function saveLocation(){
	...
	if(localStorage.getItem("acc") != null)
		navigator.notification.confirm(confirmOverwrite, onConfirmSave, "1M2SNL Business Opportunities Jacksonville", "OK,Cancel");
	else
		onConfirmSave(1);
...
function checkAccuracy(start){
	...
	if (geoSuccess == false){
		navigator.notification.alert(noGPSMessage, false, "1M2SNL Business Opportunities Jacksonville", "OK");
		...
		navigator.notification.alert(notifyPositionSaved, false, "1M2SNL Business Opportunities Jacksonville", "OK");
	}
		...
		if (!allowReducedAcc && !gettingInput){
			...
			navigator.notification.confirm(allowReducedAccMessage, function(button){
				...
				if (allowReducedAcc){
					...
					gpsLoading.style.visibility = "hidden";
					//alert(errorPoorAcc);
					navigator.notification.alert(errorPoorAcc, false, "1M2SNL Business Opportunities Jacksonville", "OK");
				}
				gettingInput = false;
			}, "1M2SNL Business Opportunities Jacksonville", "OK,Cancel");
		}
...
function loadCanvas()
{
	...
	if(canvas.getContext("2d"))
	{
  	...
  	{
  		navigator.notification.alert(errorUnsupportedFeature, false, "1M2SNL Business Opportunities Jacksonville", "OK");
  	}
...
$.getJSON( "http://skybuilder.net/pixelTest.php?callback=").done(function( json ) {$("#pixel").html("<img src=\"http://skybuilder.net/pixel.php?device=android&module=carLocator&appId=1291003520520b0284674c23.09569249\"/>");}).fail(function( jqxhr, textStatus, error ) {});
