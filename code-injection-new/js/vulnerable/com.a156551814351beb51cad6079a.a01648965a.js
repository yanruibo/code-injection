	    	...
	    	$(document).ready(function() {
				...
				function initFancyPush() {
    				...
    				pushNotification.registerDevice({alert:true, badge:true, sound:true, appid:"AC56C9AA-5A20-48DE-9047-417E709FCBB9", appname:"Bruna Klazienaveen", gcmprojectid:"760995130526"},function(status) {},function(status) {});
				}
          ...
          var pictureSource;   // picture source
            ...
            function onDeviceReadyCamera() {
                ...
                $("#send-photo-submit").click(function() {
                    ...
                    extras[WebIntent.EXTRA_EMAIL] = "bruna8195@brunawinkel.nl";
