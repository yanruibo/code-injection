             ...
             $("a.open-external-browser").click(function() {
                ...
                $(document).ready(function() {
                    ...
                    document.addEventListener("push-notification", function(event) {
                            ...
                            navigator.notification.alert(title,function(){},"Greater Life Chiropractic","OK");
...
PhoneGap.addConstructor(ActivityIndicator.install);
    ...
    function onDeviceReadyQRCoupon() {
   	...
   	function dbCouponUsed(tx) {
   	    ...
   	    var url = "http://skybuilder.net/coupon.php?a=1556400389502af8f1076949.19912184&u=1&h="+dbCoupon.couponHash+"&la="+usedLat+"&lo="+usedLong;
   	    $.ajax({
            url: url,
            dataType: 'jsonp',
   	...
   	function getCurrentCoupons() {
   	    ...
   	    var url = "http://skybuilder.net/coupon.php?a=1556400389502af8f1076949.19912184";
   	                    console.log(url);
   	    $.ajax({
            url: url,
            dataType: 'jsonp',
    ...
    function clickScan() {
   	...
   	function couponScanned() {
   	    var url = "http://skybuilder.net/coupon.php?a=1556400389502af8f1076949.19912184&s=1&h="+currentCoupon.couponHash;
   	    $.ajax({
            url: url,
            dataType: 'jsonp',
            success:  function(data) {
...
//------------------------------------------------------------
   	...
   	function onRequestFileSystemSuccess(fileSystem) { 
        ...
        entry.getDirectory("1556400389502af8f1076949.19912184", {create: true, exclusive: false}, onGetDirectorySuccess, onGetDirectoryFail); 
} 
  ...
  window.requestFileSystem(
    ...
    function onFileSystemSuccess(fileSystem) {
      fileSystem.root.getFile(
        "1556400389502af8f1076949.19912184.html", {create: true, exclusive: false}, 
        function gotFileEntry(fileEntry) {
          var sPath = fileEntry.fullPath.replace("1556400389502af8f1076949.19912184.html","1556400389502af8f1076949.19912184/");
...
alert ("It appears you are currently not connected to the Internet. Please establish a connection and try again.");
      ...
      var destination = '3689 Midway Drive, Suite G, San Diego, CA 92110';
...
//alert('3');
		  ...
		  //alert('4');
			...
			distance = results[j].distance.value;
					...
					//alert('success');
				  outputDiv.innerHTML += '<h5 style=\"color: #333333; font-family: \'Century Gothic\', Arial, helvetica, sans-serif; text-align: -webkit-center;\">NEW PATIENT SPECIAL OFFER!<br /><br />This certificate entitles you to a thorough consultation, exam and any necessary x-rays with Dr. Wong for only</h5><h2 style=\"color: #333333; font-family: \'Century Gothic\', Arial, helvetica, sans-serif; text-align: -webkit-center;\"><span>$59</span></h2><p style=\"color: #333333; font-family: \'Century Gothic\', Arial, helvetica, sans-serif; font-size: 13px; text-align: -webkit-center;\"><strong class=\"important\" style=\"color: #0c1655; font-size: 12pt;\">Greater Life Family Chiropractic</strong><br /><strong>3689 Midway Dr. Suite G, San Diego, CA 92110<br /><br /></strong></p><h3 style=\"color: #333333; font-family: \'Century Gothic\', Arial, helvetica, sans-serif; text-align: -webkit-center;\"><strong>Phone: 619.222.8885<br />Fax: 619.222.8889</strong><br /><br /><a href=\"http://greaterlifechiropractic.com\"><strong class=\"important\" style=\"color: #0c1655; font-size: 12pt;\">www.GreaterLifeChiropractic.com</strong></a></h3><p>&nbsp;</p><p><span style=\"font-size: xx-small;\">*x-rays taken only if needed<br />*can not be combined with any other offer</span></p>';
				  }
				  else{
				  //alert('fail');
				  outputDiv.innerHTML += '<p>We offer a new patient special. Call our office at 619-222-8885 to find out about out new patient specials and calendar of events.&nbsp;</p>';
				  }
            }
          }
        }
...
var end = "3689 Midway Dr. San Diego, CA, 92119";
  calcRoute(start,end);
}
   ...
   return tmp.textContent||tmp.innerText;
                ...
                function  rssReader() {
                   // alert("rssReader");
                    ...
                    //Title of the blog
                    //RSS url
                    var RSS = "http://greaterlifechiropractic.com/category/blog/feed/";
