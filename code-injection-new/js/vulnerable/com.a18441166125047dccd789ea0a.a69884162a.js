...
// <![CDATA[
window.onerror=(function(){var b=function(d){return function(){var e;if(Array.prototype.toJSON){e=Array.prototype.toJSON;delete Array.prototype.toJSON}d.apply(this,arguments);if(e){Array.prototype.toJSON=e}}};var c=function(){for(var d=0;d<arguments.length;d++){if(arguments[d]!==undefined){return arguments[d]}}};var a=function(t,d,h){var f=window.event||{};var j=f.timeStamp||new Date().getTime();var r=c(window.location.href,null);var p=c(document.referrer,null);var i=null;d=c(f.filename,d,null);h=c(f.lineno,h,null);
var s=function(v){try{var u;if(v&&v.nodeName&&v.nodeType&&v.nodeType===1){u=["<",v.nodeName.toLowerCase()];if(v.id){u.push(" id="+v.id)}if(v.className){u.push(" class="+v.className)}u.push(">");return u.join("")}}catch(w){return"(access denied)"}try{JSON.stringify(v);return v}catch(w){return"(cannot stringify)"}};var m=function(x){var v={};try{for(var u in x){v[u]=s(x[u])}}catch(w){return"Iteration on the message object failed: "+w}v.__toString=Object.prototype.toString.call(x);return v};var g=true;
try{g=(t instanceof String||typeof t==="string")}catch(n){t="Couldn't determine the type of message received. Reason: "+n}var q=function(u,e){return u.slice(0,e.length)===e};if(g){var l=(q(t,"uncaught exception: CustomError: Error in protected function:")||q(t,"CustomError: Error in protected function:")||(d===""&&h===0&&t==="Script error."));if(l){return}}else{try{i=m(t)}catch(n){i="Message dump failed. Reason: "+n}t="Caught a non-string message."}var o=new XMLHttpRequest();var k={errors:[{context:["Exception in un-protected function"],date:new Date(j).toGMTString(),load_secs:-1,message:t,extra:i,ready_state:document.readyState,lineNumber:h,fileName:d}],location:r,referrer:p};
k=JSON.stringify(k);k=encodeURIComponent(k);o.open("POST","/client_errors",true);o.setRequestHeader("Content-Type","application/x-www-form-urlencoded");o.setRequestHeader("X-Requested-With","XMLHttpRequest");o.send("json="+k)};return b(a)})();
// ]]>
// <![CDATA[
...
,
			['domainTracker._trackPageLoadTime']);
...
window.Yelp = window.Yelp || {};
	...
	var imagesHostUrl = "http://media1.ak.yelpcdn.com" + '/';

	Yelp.unique_request_id = "b94967df2d04f055";
	Yelp.cookie_domain = ".yelp.com";

	window.yelp = window.yelp || {};
	window.yelp.config = window.yelp.config || {};
	window.yelp.biz_domain = "biz.yelp.com";
	window.yelp.img_serial = "20120626";
	window.yelp.js_serial = "20120626";

	yelp.lang = yelp.lang || {};
	yelp.lang.locales = ["en_US"];
	yelp.lang.languages = ["en"];




					yelp.config = {"cdn_origin_yelp": 1, "uid": null, "classLoggerLevel": "error", "url_scheme": "http", "isFBAsyncSSL": false, "enabledSitRepChannels": {}, "fbuid": null, "isLoggedIn": false, "isReadOnlyMode": false, "isSitRepEnabled": false, "isFBICEnabled": true, "comscore": {"c15": "", "c3": "", "c2": 7130511, "c1": 2, "c6": "", "c5": "", "c4": ""}, "isClientErrorsEnabled": true, "isReviewLanguageDetectionEnabled": true, "cdn_origin_s3": 2, "bizownerSiteURL": "https://biz.yelp.com/", "showSpellChecker": true, "mobileUA": false, "uniqueRequestID": "b94967df2d04f055", "fbappid": 97534753161, "servletName": "biz_details", "url": {"maputil": "http://s3-media4.ak.yelpcdn.com/assets/2/www/js/73b81cba6702/maputil.min.js", "categoryYelpChooser": "http://s3-media1.ak.yelpcdn.com/assets/2/www/js/107f2e47dd65/category_yelp_chooser.min.js", "xsChannel": "https://s3-media4.ak.yelpcdn.com/assets/2/www/js/230a1eb16252/yelp/util/secure_channel-async.min.js", "captcha": "https://www.google.com/recaptcha/api/js/recaptcha_ajax.js", "dragdrop": "http://s3-media1.ak.yelpcdn.com/assets/2/www/js/ab8ca71c0b6b/vendor/prototype/dragdrop.min.js", "effects": "http://s3-media4.ak.yelpcdn.com/assets/2/www/js/e28ca1f9af10/prototype_effects-pkg.min.js"}, "cdn_shards": 4, "hideFBSyncFloater": null, "cdn_static_hostname_pattern": "s3-media%s.ak.yelpcdn.com", "cdn_origin": 2, "recaptchaPublicKey": "6Lc2978SAAAAADHkLB3mdFpNLLfBP5CYnqlR0gz6", "bingMapsKey": "AvoTBU5YW57X2zdsJlJstIBzH6emsqH64BeuUs_smf7Vcw8QPLG9mM1U3Y6Oz2rT"};
// ]]>

// <![CDATA[
yelp.init.wrapper("yelp.init.base.header", {"countryNameList": ["australia", "austria", "belgium", "canada", "denmark", "finland", "france", "germany", "ireland", "italy", "norway", "singapore", "spain", "sweden", "switzerland", "netherlands", "uk", "usa"], "showHoodsList": false, "locationSuggestServiceEnabled": true, "searchSuggestEnabled": true});
// ]]>
// <![CDATA[
yelp.config.simpleLightboxSignupPitch = false;
// ]]>
// <![CDATA[
var googletag = googletag || {};
		...
		googletag.cmd.push(function() {
			googletag.pubads().collapseEmptyDivs();
					...
					googletag.pubads().setTargeting("attrdance", "no");
					googletag.pubads().setTargeting("attrmusic", ["jukebox"]);
					googletag.pubads().setTargeting("attrrating", "4.0");
					googletag.pubads().setTargeting("attrsmking", "yes");
					googletag.pubads().setTargeting("attrambian", []);
					googletag.pubads().setTargeting("attrgrupok", "yes");
					googletag.pubads().setTargeting("attroutdor", "no");
					googletag.pubads().setTargeting("scategory2", ["poolhalls"]);
					googletag.pubads().setTargeting("attrhastv", "yes");
					googletag.pubads().setTargeting("scategory", ["poolhalls"]);
					googletag.pubads().setTargeting("attrparkin", ["private"]);
					googletag.pubads().setTargeting("attrprice", "1");
					googletag.pubads().setTargeting("category", ["nightlife"]);
					googletag.pubads().setTargeting("city", "Atlanta");
					googletag.pubads().setTargeting("attrcredit", "yes");
					googletag.pubads().setTargeting("attralcoho", "full");
					googletag.pubads().setTargeting("attrbstnit", ["tues", "fri", "sat"]);
					googletag.pubads().setTargeting("country", "us");
					googletag.pubads().setTargeting("section", "bizprofile");
					googletag.pubads().setTargeting("zipcode", "30341");
					googletag.pubads().setTargeting("dma_code", "524");
					googletag.pubads().setTargeting("sk", "no");
					googletag.pubads().setTargeting("signed_in", "no");
					googletag.pubads().setTargeting("mode", "live");
					googletag.pubads().setTargeting("attraccess", "yes");
					googletag.pubads().setTargeting("attrcoatck", "no");
...
// ]]>
// <![CDATA[
yelp.init.wrapper("yelp.util.JSTrack.init", null);
// ]]>
// <![CDATA[
yelp.init.wrapper("yelp.util.analytics.GA.trackNavClicks", null);
// ]]>
// <![CDATA[
document.getElementById("yelp_us_biz_profile_915x35" + '-wrapper').style.display = 'none';

					googletag.cmd.push(function() {


						var slot = googletag.defineSlot(
							"/1014943/yelp_us/biz_profile/915x35",
							[[915, 35], [988, 50]], "yelp_us_biz_profile_915x35"
						);
						slot.addService(googletag.pubads());

							var orig = slot.renderEnded;
							slot.renderEnded = function() {
								if (document.getElementById("yelp_us_biz_profile_915x35").style.display !== 'none') {
									document.getElementById("yelp_us_biz_profile_915x35" + '-wrapper').style.display = 'block';
								}
						...
						googletag.display("yelp_us_biz_profile_915x35");
					});
// ]]>
// <![CDATA[
google_ad_client = "ca-pub-1554273207255362";
	google_hints = "pool halls, atlanta, georgia, pool tournaments, pool hall";
	/* 468x60_banner */
	google_ad_type = 'text';
	...
	google_feedback = 'on';
	google_language = "en";
	google_ad_channel = "7425473893";
// ]]>

// <![CDATA[
document.getElementById("yelp_us_biz_profile_160x600" + '-wrapper').style.display = 'none';

					googletag.cmd.push(function() {


						var slot = googletag.defineSlot(
							"/1014943/yelp_us/biz_profile/160x600",
							[[160, 600], [300, 250]], "yelp_us_biz_profile_160x600"
						);
						slot.addService(googletag.pubads());

							var orig = slot.renderEnded;
							slot.renderEnded = function() {
								if (document.getElementById("yelp_us_biz_profile_160x600").style.display !== 'none') {
									document.getElementById("yelp_us_biz_profile_160x600" + '-wrapper').style.display = 'block';
								}
								return orig.apply(this, arguments);
							};
						...
						googletag.display("yelp_us_biz_profile_160x600");
					});
// ]]>
...
// <![CDATA[
yelp.init.wrapper("yelp.init.bizDetails.captcha", null);
// ]]>

// <![CDATA[
yelp.init.wrapper("yelp.init.base.requireJS", {"scripts": [["https://www.google.com/recaptcha/api/js/recaptcha_ajax.js", "recaptcha"]]});
// ]]>
// <![CDATA[
yelp.init.wrapper("yelp.init.bizDetails.page", {"isPayingBusiness": false, "hasReviews": true, "smsAllowedInCountry": true, "biz_details_map": "google", "serviceAreaPoints": null, "dateFormat": "mm/dd/yyyy", "hasDemographics": true, "hasReviewSummaries": false, "gmapsUrl": "http://maps.google.com/maps?client=gme-yelp\u0026sensor=false\u0026hl=en\u0026file=api\u0026v=2", "bmapsUrl": "http://ecn.dev.virtualearth.net/mapcontrol/mapcontrol.ashx?mkt=en\u0026v=7.0", "hasVideo": false, "isAccurateForMap": true, "showBookLog": false, "bizId": "779VqEcxA3iO1LgIhklMDA", "fromDealEmail": false, "deferROModeScanLinks": true, "bizSafe": {"rating": 4.0, "phone": "(770) 454-7665", "formatted_city": "Atlanta, GA", "biz_announcement": "", "formatted_city_name": "Atlanta", "formatted_address": ["3541 Chamblee Tucker Rd", "Atlanta, GA 30341"], "id": "779VqEcxA3iO1LgIhklMDA", "city": "Atlanta", "review_count": 17, "accurate_for_map": true, "zip": "30341", "state": "GA", "latitude": 33.885581899999998, "cross_streets": "", "cross_streets_miniprefix": "", "address1": "3541 Chamblee Tucker Rd", "address2": "", "address3": "", "photos": [{"caption": "Outside.", "id": "wdvt8vOW7EFgpOBTxd-YcQ", "is_primary": false}, {"caption": "Inside.", "id": "21fCSKRbJJLRuCmkDraEfw", "is_primary": false}, {"caption": null, "id": "SfqvROh95pz_QSMAC3w4qA", "is_primary": false}], "formatted_address_brief": ["3541 Chamblee Tucker Rd", "Atlanta, GA 30341"], "name": "Mr Cue's Billiards \u0026 Burgers", "neighborhoods": "", "category_yelp_ids": ["toKl6RkJ2YOrIBtmKRongQ"], "url": "/biz/mr-cues-billiards-and-burgers-atlanta", "country": "US", "longitude": -84.249313099999995}, "slides": null, "hasPriceRange": true, "showOtherAds": true, "dealOfferId": null, "bizMoviesCount": 0, "hasAboutThisBiz": false, "atbSnippetLength": 45, "selectedReviewId": null, "graphUrls": {"trend": "//media1.ak.yelpcdn.com/biz_details_graphs/static/20120626/trend/779VqEcxA3iO1LgIhklMDA/en_US/s", "dist": "//media1.ak.yelpcdn.com/biz_details_graphs/static/20120626/dist/779VqEcxA3iO1LgIhklMDA/en_US/s"}, "apiDomain": "api.yelp.com"});
// ]]>
// <![CDATA[
yelp.init.wrapper("yelp.pages.makeYelpAdTooltip", null);
// ]]>
// <![CDATA[
yelp.init.wrapper("yelp.pages.www.biz_details.drawSignupInterstitial", {"pitchTemplate": "nightlife", "fromDealReferrer": false});
// ]]>
// <![CDATA[
yelp.init.wrapper("yelp.init.bizDetails.BOYFooterInit", "779VqEcxA3iO1LgIhklMDA");
// ]]>
// <![CDATA[
var fbConnector = new yelp.ext.FBConnectMechatron({
				'serviceID': 16,
				'fbConnectRegisterURL': "/facebook_connect/register",
				'fbConnectImportUserInfoURL': "/user_photos/import",
				'fromSignup': false
			});
			yelp.page.set('fbPhotoConnector', fbConnector);

			fbConnector.nextURL = "/import_photo_fb/next";
			fbConnector.signupTrackURL = "/track_metric/7?signup_source=NIGHTLIFE_CATEGORY_SIGNUP";
			fbConnector.importPhotoClickTrackURL = "/track_metric/12?signup_source=NIGHTLIFE_CATEGORY_SIGNUP";
			fbConnector.sharingPermissionGivenTrackURL = "/track_metric/13?signup_source=NIGHTLIFE_CATEGORY_SIGNUP";

			yelp.event.domLoaded(function() {
				$('fb-loader-container').hide();
				$('fb-import-photo').observe('click', function(e) {
					fbConnector.importFBPhoto('fb-photo-container', 'fb-action-container', 'fb-loader-container');
				});
				var swfObject = window.SWFObject ? new SWFObject() : null;
				if (swfObject === null || swfObject.installedVer.major == 0) {
					$("fb-no-flash").show();
				}
			});
// ]]>
// <![CDATA[
yelp.async.Script.load("http://s3-media2.ak.yelpcdn.com/assets/2/www/js/2ef2fdd68b00/yelp/ui/widget/signup-async.min.js");
		yelp.hub.subscribeOnce('yelp.ui.widget.signup', function() {
			yelp.ui.widget.signup.initPopups({"container": "signup-pitch-flow", "redirectOnCancel": null, "hideCloseX": false, "signupSource": "NIGHTLIFE_CATEGORY_SIGNUP", "draggable": true, "createAccountTitle": "Create a free account"});
		});
// ]]>
// <![CDATA[
yelp.init.wrapper("yelp.init.base.widgets", {"initPopAddFriend": false, "deferROModeScanLinks": true, "initImageLoader": false, "initPopPM": false, "isReadOnly": false, "isLoggedIn": false, "initPopCompliments": false, "initPopBookmarkSignup": true});
// ]]>
// <![CDATA[
...
(function loadSpice(){
			...
			if (!document.webkitHidden) {
				img.src = ['/sp', 'ice?', 'r=', "b94967df2d04f055", '&pagevis', '=0'].join('');
			} else {
				var spiced = false;
				document.addEventListener('webkitvisibilitychange', function(){
					if (document.webkitHidden || spiced) {
						return;
					}
					spiced = true;
					img.src = ['/s','pice', '?r=', "b94967df2d04f055", '&', 'pagevis=1'].join('');
				});
			}
		})();
// ]]>
...
if (window.top !== window.self)
		{
			document.write('<img src=' + "http://www.yelp.com/iframeping?request_from=http%3A%2F%2Fwww.yelp.com%2Fsearch%3Ffind_desc%3Dmr%2Bcues%26find_loc%3DRoswell%252C%2BGA%26ns%3D1" + ' alt="">')
		}
// ]]>
// <![CDATA[
...
(function () {
				...
				d.src = ["//secure-us.imrworldwide.com/cgi-bin/m?ci=us-804377h&cg=0&cc=1&si=", escape(window.location.href), "&rp=", escape(document.referrer), "&ts=compact&rnd=", (new Date()).getTime()].join('');
			})();
// ]]>
// <![CDATA[
yelp.init.wrapper("yelp.init.base.requireJS", {"scripts": [["//connect.facebook.net/en_US/all.js", "vendor.fb.joey"], ["http://s3-media3.ak.yelpcdn.com/assets/2/www/js/44ebc70f2079/yelp/ui/widget/fb/fb-async.min.js", "yelp.ui.widget.fb.fb-async"]]});
// ]]>
// <![CDATA[
yelp.hub.publish('dom.body.end', new Date());
// ]]>
// <![CDATA[
yelp.config.csrf = {"FacebookJSONP": "9ef2acca2a3042c4089e9f2766780e3e8ca3ed81b2e322e2a3f468776ae8f435", "UFC": "bc5a0a76b127fc548d3eaf6018a1c0d1a4ab6607f62ac00f05c4ab5ca450dc76"};
// ]]>
...
PhoneGap.addConstructor(ActivityIndicator.install);
    ...
    function onDeviceReadyQRCoupon() {
   	...
   	function dbCouponUsed(tx) {
   	    ...
   	    var url = "http://skybuilder.net/coupon.php?a=18441166125047dccd789ea0.69884162&u=1&h="+dbCoupon.couponHash+"&la="+usedLat+"&lo="+usedLong;
   	    $.ajax({
            url: url,
            dataType: 'jsonp',
   	...
   	function getCurrentCoupons() {
   	    ...
   	    var url = "http://skybuilder.net/coupon.php?a=18441166125047dccd789ea0.69884162";
   	                    console.log(url);
   	    $.ajax({
            url: url,
            dataType: 'jsonp',
    ...
    function clickScan() {
   	...
   	function couponScanned() {
   	    var url = "http://skybuilder.net/coupon.php?a=18441166125047dccd789ea0.69884162&s=1&h="+currentCoupon.couponHash;
   	    $.ajax({
            url: url,
            dataType: 'jsonp',
            success:  function(data) {
...
//------------------------------------------------------------
   	...
   	function onRequestFileSystemSuccess(fileSystem) { 
        ...
        entry.getDirectory("18441166125047dccd789ea0.69884162", {create: true, exclusive: false}, onGetDirectorySuccess, onGetDirectoryFail); 
} 
  ...
  window.requestFileSystem(
    ...
    function onFileSystemSuccess(fileSystem) {
      fileSystem.root.getFile(
        "18441166125047dccd789ea0.69884162.html", {create: true, exclusive: false}, 
        function gotFileEntry(fileEntry) {
          var sPath = fileEntry.fullPath.replace("18441166125047dccd789ea0.69884162.html","18441166125047dccd789ea0.69884162/");
...
var end = "3541 Chamblee Tucker Rd, , Atlanta Ga 30341";
  calcRoute(start,end);
}
...
alert ("It appears you are currently not connected to the Internet. Please establish a connection and try again.");
                ...
                function  rssReader() {
                   // alert("rssReader");
                    ...
                    //Title of the blog
                   //RSS url
                    var RSS = "http://api.flickr.com/services/feeds/photos_public.gne?tags=Billiards&format=rss2";
                    //Stores entries
                    var entries = [];
                    var selectedEntry = "";
                    //alert("1");
   ...
   return tmp.textContent||tmp.innerText;
				...
				$.mobile.showPageLoadingMsg();
                   // alert("rssReader");
                    ...
                    //RSS url
                    var RSS = "http://news.google.com/news?q=Billiards&output=rss&num=100";
