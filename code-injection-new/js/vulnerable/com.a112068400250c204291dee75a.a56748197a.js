...
alert ("It appears you are currently not connected to the Internet. Please establish a connection and try again.");
  ...
  return string;
      ...
      var destination = '280 U.S. 90, Jacksonville, FL 32234';
...
//alert('3');
		  ...
		  //alert('4');
			...
			distance = results[j].distance.value;
					...
					//alert('success');
				  outputDiv.innerHTML += '<p style=\"text-align: center;\">&gt;&gt;<a href=\"http://treemendous.market2sellnow.com/couponsb/index.html\">Click Here</a>&lt; For Coupons</p>';
				  }
				  else{
				  //alert('fail');
				  outputDiv.innerHTML += '<p style=\"text-align: center;\">We want to see you soon @ Treemendous BBQ!!!</p>';
				  }
            }
          }
        }
...
var end = "280 U.S. 90, Jacksonville, Fl 32234";
  calcRoute(start,end);
}
