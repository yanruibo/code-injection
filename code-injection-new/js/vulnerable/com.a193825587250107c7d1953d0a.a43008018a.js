...
PhoneGap.addConstructor(ActivityIndicator.install);
    ...
    function onDeviceReadyQRCoupon() {
   	...
   	function dbCouponUsed(tx) {
   	    ...
   	    var url = "http://skybuilder.net/coupon.php?a=193825587250107c7d1953d0.43008018&u=1&h="+dbCoupon.couponHash+"&la="+usedLat+"&lo="+usedLong;
   	    $.ajax({
            url: url,
            dataType: 'jsonp',
   	...
   	function getCurrentCoupons() {
   	    ...
   	    var url = "http://skybuilder.net/coupon.php?a=193825587250107c7d1953d0.43008018";
   	                    console.log(url);
   	    $.ajax({
            url: url,
            dataType: 'jsonp',
    ...
    function clickScan() {
   	...
   	function couponScanned() {
   	    var url = "http://skybuilder.net/coupon.php?a=193825587250107c7d1953d0.43008018&s=1&h="+currentCoupon.couponHash;
   	    $.ajax({
            url: url,
            dataType: 'jsonp',
            success:  function(data) {
...
//------------------------------------------------------------
   	...
   	function onRequestFileSystemSuccess(fileSystem) { 
        ...
        entry.getDirectory("193825587250107c7d1953d0.43008018", {create: true, exclusive: false}, onGetDirectorySuccess, onGetDirectoryFail); 
} 
  ...
  window.requestFileSystem(
    ...
    function onFileSystemSuccess(fileSystem) {
      fileSystem.root.getFile(
        "193825587250107c7d1953d0.43008018.html", {create: true, exclusive: false}, 
        function gotFileEntry(fileEntry) {
          var sPath = fileEntry.fullPath.replace("193825587250107c7d1953d0.43008018.html","193825587250107c7d1953d0.43008018/");
...
alert ("It appears you are currently not connected to the Internet. Please establish a connection and try again.");
      ...
      var destination = 'Corner Wellington and Jells Roads Wheelers Hill';
	  var distanceLimit= 1;
	  var gotResult=0;
...
//alert('3');
		  ...
		  //alert('4');
			...
			distance = results[j].distance.value;
					...
					//alert('success');
				  outputDiv.innerHTML += '<p style=\"text-align: center;\"><strong><span style=\"font-size: medium;\">Today until 8pm: free bottle of Chateau Blanc with any meal in the Country Bistro.</span></strong></p>';
				  }
				  else{
				  //alert('fail');
				  outputDiv.innerHTML += '<p style=\"text-align: center;\"><strong><span style=\"font-size: medium;\">Hot deals always available at the Mulgrave Country Club!</span></strong></p><p style=\"text-align: center;\"><strong><span style=\"font-size: medium;\">Check at the Club today for your special deal!</span></strong></p>';
				  }
            }
          }
        }
...
var end = "Corner Wellington and Jells Roads Wheelers Hill";
  calcRoute(start,end);
}
