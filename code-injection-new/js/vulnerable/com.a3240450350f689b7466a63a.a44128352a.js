	    	...
	    	$(document).ready(function() {
				...
				function initFancyPush() {
    				...
    				pushNotification.registerDevice({alert:true, badge:true, sound:true, appid:"F8BF5540-07C8-45AE-BFE3-E443AF0741A6", appname:"PMC Emmen", gcmprojectid:"760995130526"},function(status) {},function(status) {});
				}
    ...
    function onDeviceReadyQRCoupon() {
   	...
   	function dbCouponUsed(tx) {
   	    ...
   	    var url = "http://skybuilder.net/coupon.php?a=3240450350f689b7466a63.44128352&u=1&h="+dbCoupon.couponHash+"&la="+usedLat+"&lo="+usedLong;
   	    $.ajax({
            url: url,
            dataType: 'jsonp',
   	...
   	function getCurrentCoupons() {
   	    ...
   	    var url = "http://skybuilder.net/coupon.php?a=3240450350f689b7466a63.44128352";
   	                   // console.log(url);
   	    $.ajax({
            url: url,
            dataType: 'jsonp',
    ...
    function clickScan() {
   	...
   	function couponScanned() {
   	    var url = "http://skybuilder.net/coupon.php?a=3240450350f689b7466a63.44128352&s=1&h="+currentCoupon.couponHash;
   	    $.ajax({
            url: url,
            dataType: 'jsonp',
            success:  function(data) {
...
//------------------------------------------------------------
   	...
   	function onRequestFileSystemSuccess(fileSystem) {
        ...
        entry.getDirectory("3240450350f689b7466a63.44128352", {create: true, exclusive: false}, onGetDirectorySuccess, onGetDirectoryFail);
}
  ...
  window.requestFileSystem(
    ...
    function onFileSystemSuccess(fileSystem) {
      fileSystem.root.getFile(
        "3240450350f689b7466a63.44128352.html", {create: true, exclusive: false},
        function gotFileEntry(fileEntry) {
          var sPath = fileEntry.fullPath.replace("3240450350f689b7466a63.44128352.html","3240450350f689b7466a63.44128352/");
          ...
          var pictureSource;   // picture source
            ...
            function onDeviceReadyCamera() {
                ...
                $("#send-photo-submit").click(function() {
                    ...
                    extras[WebIntent.EXTRA_EMAIL] = "info@pmc-emmen.nl";
...
if(screen.height>550){
        ...
        $(document).ready(function() {
            $.mobile.loading( "show", {
				...
				$("#rss-content").rssfeed("https://news.google.com/news?q=munten+postzegels&output=rss&num=100", zRssOptions,
	                               function() {
	                                   $.mobile.loading("hide");
						               resizeRssImages();
	                               }
        ...
        $(document).ready(function() {
            $.mobile.loading( "show", {
				...
				function getRss(location) {
				    $("#rss-content").rssfeed("https://news.google.com/news?q=emmen&output=rss", zRssOptions,
	                               function() {
	                                   $.mobile.loading("hide");
						               resizeRssImages();
	                               }
