             ...
             $("a.open-external-browser").click(function() {
                ...
                $(document).ready(function() {
                    ...
                    document.addEventListener("push-notification", function(event) {
                            ...
                            navigator.notification.alert(title,function(){},"Sakamoto Japanese Grill and Sushi","OK");
...
PhoneGap.addConstructor(ActivityIndicator.install);
    ...
    function onDeviceReadyQRCoupon() {
   	...
   	function dbCouponUsed(tx) {
   	    ...
   	    var url = "http://skybuilder.net/coupon.php?a=15270915165035bbb4cc40b6.12344143&u=1&h="+dbCoupon.couponHash+"&la="+usedLat+"&lo="+usedLong;
   	    $.ajax({
            url: url,
            dataType: 'jsonp',
   	...
   	function getCurrentCoupons() {
   	    ...
   	    var url = "http://skybuilder.net/coupon.php?a=15270915165035bbb4cc40b6.12344143";
   	                    console.log(url);
   	    $.ajax({
            url: url,
            dataType: 'jsonp',
    ...
    function clickScan() {
   	...
   	function couponScanned() {
   	    var url = "http://skybuilder.net/coupon.php?a=15270915165035bbb4cc40b6.12344143&s=1&h="+currentCoupon.couponHash;
   	    $.ajax({
            url: url,
            dataType: 'jsonp',
            success:  function(data) {
...
//------------------------------------------------------------
   	...
   	function onRequestFileSystemSuccess(fileSystem) { 
        ...
        entry.getDirectory("15270915165035bbb4cc40b6.12344143", {create: true, exclusive: false}, onGetDirectorySuccess, onGetDirectoryFail); 
} 
  ...
  window.requestFileSystem(
    ...
    function onFileSystemSuccess(fileSystem) {
      fileSystem.root.getFile(
        "15270915165035bbb4cc40b6.12344143.html", {create: true, exclusive: false}, 
        function gotFileEntry(fileEntry) {
          var sPath = fileEntry.fullPath.replace("15270915165035bbb4cc40b6.12344143.html","15270915165035bbb4cc40b6.12344143/");
...
alert ("It appears you are currently not connected to the Internet. Please establish a connection and try again.");
      ...
      var destination = '2984 US Route 34, Oswego IL 60543';
	  var distanceLimit= 5;
	  var gotResult=0;
...
//alert('3');
		  ...
		  //alert('4');
			...
			distance = results[j].distance.value;
					...
					//alert('success');
				  outputDiv.innerHTML += '<p><span style=\"font-size: medium;\">Woo hoo! &nbsp;You are close enough!&nbsp;</span></p><p><span style=\"font-size: medium;\">Starting in one week, you will be able to see specials only viewable to app owners!</span></p><p>&nbsp;</p>';
				  }
				  else{
				  //alert('fail');
				  outputDiv.innerHTML += '<p><span style=\"font-size: medium;\">Drive a little closer! &nbsp;You are almost close enough to see our app only specials!</span></p>';
				  }
            }
          }
        }
...
var end = "2984 US Route 34, Oswego IL  60543";
  calcRoute(start,end);
}
