...
alert ("It appears you are currently not connected to the Internet. Please establish a connection and try again.");
  ...
  return string;
      ...
      var destination = '9810 W Sample Rd Coral Springs, Fl';
...
//alert('3');
		  ...
		  //alert('4');
			...
			distance = results[j].distance.value;
					...
					//alert('success');
				  outputDiv.innerHTML += '<p style=\"text-align: center;\"><span style=\"color: #ff0000;\"><strong>Hello and Welcome To Coral Springs!</strong></span></p><p style=\"text-align: center;\"><span style=\"color: #ff0000;\"><strong>Coming Soon!!!</strong></span></p>';
				  }
				  else{
				  //alert('fail');
				  outputDiv.innerHTML += '<p><span style=\"color: #ff0000;\"><strong>Hello and Please Visit Coral Springs Soon!</strong></span></p>';
				  }
            }
          }
        }
          ...
          var pictureSource;   // picture source
            ...
            //alert("Device Ready");
                ...
                $("#send-photo-submit").click(function() {
                    ...
                    var extras = {};
                    extras[WebIntent.EXTRA_SUBJECT] = "Photo from 1M2SNL CoralSpringsRestaurants";
                    extras[WebIntent.EXTRA_TEXT] = $("textarea#emailPhotoMessage").val();
                    extras[WebIntent.EXTRA_STREAM] = $("#emailPhotoLocation").val();
                    extras[WebIntent.EXTRA_EMAIL] = "coralspringsrestaurants@m2snl.com";
