...
alert ("It appears you are currently not connected to the Internet. Please establish a connection and try again.");
        ...
        $(document).ready(function() {
                          $('#youtubevideos').youTubeChannel({ 
                                                             userName: 'Sigaretta elettronica manuale', 
                                                             channel: "uploads", 
                                                             hideAuthor: true,
                                                             numberToDisplay: 30,
                                                             linksInNewWindow: true
           ...
           // alert("child-browser");
            ...
            function onDeviceReadyCamera() {
                ...
                $("#send-photo-submit").click(function() {
                    ...
                    var extras = {};
                    extras[WebIntent.EXTRA_SUBJECT] = "Photo from Sigaretta elettronica";
                 ...
                 return false;
                  ...
                  //  $("#mainPage").live("pageinit", function() {
                    ...
                    $("#contentPage").live("pageshow", function(prepage) {
                                           ...
                                           var contentHTML = "";
                                           contentHTML += desc;contentHTML += '<p/><a rel="external" class="open-child-browser-rss" data-gourl="'+ link + '" href="'+ link + '">Continua</a>';  $("#entryText",this).html(contentHTML);
                                           });
...
alert ("It appears you are currently not connected to the Internet. Please establish a connection and try again.");
                ...
                function  rssReader() {
                   // alert("rssReader");
                    ...
                    //Title of the blog
                   //RSS url
                    var RSS = "http://api.flickr.com/services/feeds/photos_public.gne?tags=Sigaretta+elettronica&format=rss2";
                    //Stores entries
                    var entries = [];
                    var selectedEntry = "";
                    //alert("1");
                    ...
                    $("#contentPage").live("pageshow", function(prepage) {
                                      ...
                                      desc=(desc.replace(/href/gi, "span"));
                                           var link=entries[selectedEntry].link;
                                           var contentHTML = "";
                                           contentHTML += desc;contentHTML += '<p/><a rel="external" href="'+ link + '">Continua</a>';$("#entryText",this).html(contentHTML);
                                           });
   ...
   return tmp.textContent||tmp.innerText;
                ...
                function  rssReader() {
                   // alert("rssReader");
                    ...
                    //RSS url
                    var RSS = "http://news.google.com/news?q=Sigaretta+elettronica&output=rss&num=100";
...
$(this).removeClass("ui-btn-up-c").addClass("ui-body-c");
                    ...
                    $("#contentPage").live("pageshow", function(prepage) {
                                      ...
                                      desc=(desc.replace(/href/gi, "span"));
                                           ...
                                           var link=entries[selectedEntry].link;
                                           var contentHTML = "";
                                           contentHTML += desc;contentHTML += '<p/><a rel="external" href="'+ link + '" data-gourl="'+ link + '" class="open-external-browser">Continua</a>';$("#entryText",this).html(contentHTML);
                                           });
   ...
   return tmp.textContent||tmp.innerText;
                ...
                function  rssReader() {
                   // alert("rssReader");
                    ...
                    //Title of the blog
                    //RSS url
                    var RSS = "http://esig.forumfree.it/rss.php?f=10719766";
                                        ...
                                        //  alert("5");
											 ...
											 pulledDescription=v.description;
													...
													imageSource='<' + scraped + ' style="max-width:80%;"><br><br>';
                                                     ...
                                                     itemLink=v.link;							   
							   s += '<li data-icon="false"><h3 style="white-space:normal">' + v.title + '</h3><p style="white-space:normal">' + imageSource + cleanDesc + '</p><p><a rel="external" href="'+ v.link + '" data-gourl="'+ v.link + '" class="open-external-browser">Continua</a></p></li>';});
							//	alert("6");
                                              $("#linksList").append(s);
                                              $("#linksList").listview("refresh");
                                              });
...
alert ("It appears you are currently not connected to the Internet. Please establish a connection and try again.");
                ...
                function  rssReader() {
                   // alert("rssReader");
                    ...
                    //RSS url
					var RSS="http://www.eventbrite.com/directoryxml/?q=Sigaretta+elettronica";
                    //Stores entries
                    var entries = [];
                    var selectedEntry = "";
                    //alert("1");
             ...
             var goUrl = $(this).attr("data-gourl");
                 ...
                 return false;
                    ...
                    $("#contentPage").live("pageshow", function(prepage) {
                                           ...
                                           var link=entries[selectedEntry].link;
                                           var contentHTML = "";
                                           contentHTML += desc + '<br>' + link;contentHTML += '<p/><a rel="external" class="open-child-browser-rss" data-gourl="'+ link + '" href="'+ link + '">Continua</a>';  $("#entryText",this).html(contentHTML);
                                           });
