            ...
            document.addEventListener("deviceready", userLoc, false);
             ...
             userLoc();
                ...
                function  staticLoc() {
                    ...
                    var TITLE = "Deals";
                    //RSS url
                    var RSS = "https://api.groupon.com/v2/deals.xml?postal_code=08008&client_id=340499e6fcbec24b891fb3f1ca84e013b2f1bdce";
  ...
  return string;
            ...
            $.mobile.loading( "show", {
                ...
                textVisible: true
	                ...
	                function initialize(){
	  rssReader("Jersey+Shore+new+jersey");
	  }
  ...
  return string;
                ...
                function  rssReader() {
                   // alert("rssReader");
                    ...
                    //Title of the blog
                   //RSS url
                    var RSS = "http://api.flickr.com/services/feeds/photos_public.gne?tags=Jersey+Shore,+new+jersey&format=rss2";
                    //Stores entries
                    var entries = [];
                    var selectedEntry = "";
                    //alert("1");
