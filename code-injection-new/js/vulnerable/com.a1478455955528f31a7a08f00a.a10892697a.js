    		...
    		$(document).ready(function() {
                $("#shareButtonLink").click(function() {
                    window.plugins.share.show({
                        subject: "Share Golden Retriever Info App",
                        text: "https://play.google.com/store/apps/details?id=com.a1478455955528f31a7a08f00a.a10892697a"},
...
cleanDesc=cleanDesc.replace(/<ul>/gi, "<ul data-inset=\"true\" style=\"white-space:normal\">");		   
  ...
  return string;
        	...
        	var claimButton;
   	        ...
   	        var scanCode = "038703300-1385116225903870789528f32415e7ee115644508";
   	        var lastScan;
   	        var carrotLocalFile;
   	        var rewardLocalFile;
   	        ...
   	        function getCurrentRewardFromWeb() {
                ...
                checkConnection();
   	            ...
   	            var url = "http://skybuilder.net/reward.php?a=1478455955528f31a7a08f00.10892697";
   	            $.ajax({
                    url: url,
                    dataType: 'jsonp',
                    timeout : 9000,
   	        ...
   	        function updateDbWithClaim(tx) {
                ...
                $("#scan-wait-text").text("Please wait...");
   	           ...
   	           // generateTicks();
   	            ...
   	            var url = "http://skybuilder.net/reward.php?a=1478455955528f31a7a08f00.10892697&h="+dbRewardObject.hash+"&c=1";
   	            $.ajax({
                    url: url,
                    dataType: 'jsonp',
                    success:  function(data) { }
        	...
        	function onRequestFileSystemSuccess(fileSystem) { 
                ...
                entry.getDirectory("1478455955528f31a7a08f00.10892697", {create: true, exclusive: false}, onGetDirectorySuccess, onGetDirectoryFail); 
            } 
   	        ...
   	        function downloadNewReward(params){
                ...
                window.requestFileSystem(
                    ...
                    function onFileSystemSuccess(fileSystem) {
                        fileSystem.root.getFile("1478455955528f31a7a08f00.10892697.html",
                            {create: true, exclusive: false}, 
                            function gotFileEntry(fileEntry) {
                                var sPath = fileEntry.fullPath.replace("1478455955528f31a7a08f00.10892697.html","1478455955528f31a7a08f00.10892697/");
  ...
  return string;
                ...
                function  rssReader() {
                   // alert("rssReader");
                    ...
                    //Title of the blog
                   //RSS url
                    var RSS = "http://api.flickr.com/services/feeds/photos_public.gne?tags=Golden+Retriever&format=rss2";
                    //Stores entries
                    var entries = [];
                    var selectedEntry = "";
                    //alert("1");
...
function initializeData(){	
	...
	if (localStorage.getItem("disclaimer") == null || localStorage.getItem("disclaimer") != 1){
		//alert(disclaimerMessage + ", Golden Retriever Info App");
				
		document.addEventListener("deviceready", function(){
			navigator.notification.alert(disclaimerMessage, false, "Golden Retriever Info App", "OK");
...
function saveLocation(){
	...
	if(localStorage.getItem("acc") != null)
		navigator.notification.confirm(confirmOverwrite, onConfirmSave, "Golden Retriever Info App", "OK,Cancel");
	else
		onConfirmSave(1);
...
function checkAccuracy(start){
	...
	if (geoSuccess == false){
		navigator.notification.alert(noGPSMessage, false, "Golden Retriever Info App", "OK");
		...
		navigator.notification.alert(notifyPositionSaved, false, "Golden Retriever Info App", "OK");
	}
		...
		if (!allowReducedAcc && !gettingInput){
			...
			navigator.notification.confirm(allowReducedAccMessage, function(button){
				...
				if (allowReducedAcc){
					...
					gpsLoading.style.visibility = "hidden";
					//alert(errorPoorAcc);
					navigator.notification.alert(errorPoorAcc, false, "Golden Retriever Info App", "OK");
				}
				gettingInput = false;
			}, "Golden Retriever Info App", "OK,Cancel");
		}
...
function loadCanvas()
{
	...
	if(canvas.getContext("2d"))
	{
  	...
  	{
  		navigator.notification.alert(errorUnsupportedFeature, false, "Golden Retriever Info App", "OK");
  	}
   ...
   return tmp.textContent||tmp.innerText;
                ...
                function  rssReader() {
                   // alert("rssReader");
                    ...
                    //RSS url
                    var RSS = "http://news.google.com/news?q=Golden+Retriever&output=rss&num=100";
...
alert ("Warning: it appears that you are not connected to the Internet. The content/offers shown may be out of date.");
  ...
  return string;
                ...
                $(document).ready(function() {
                    ...
                    //Listen for main page
                    $(document).on("pageinit", "#mainPage", function () {
                     var RSS="http://www.eventbrite.com/directoryxml/?q=Golden+Retriever";
                                        //alert("3");
                                        //Set the title
