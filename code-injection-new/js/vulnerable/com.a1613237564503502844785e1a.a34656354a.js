             ...
             $("a.open-external-browser").click(function() {
                ...
                $(document).ready(function() {
                    ...
                    document.addEventListener("push-notification", function(event) {
                            ...
                            navigator.notification.alert(title,function(){},"SclerodermaSclerosis Guide","OK");
...
alert ("It appears you are currently not connected to the Internet. Please establish a connection and try again.");
        ...
        $(document).ready(function() {
                          $('#youtubevideos').youTubeChannel({ 
                                                             userName: 'scleroderma disease+autoimmune disease', 
                                                             channel: "uploads", 
                                                             hideAuthor: true,
                                                             numberToDisplay: 30,
   ...
   return tmp.textContent||tmp.innerText;
				...
				$.mobile.showPageLoadingMsg();
                   // alert("rssReader");
                    ...
                    //RSS url
                    var RSS = "http://news.google.com/news?q=scleroderma+disease+autoimmune+disease&output=rss&num=100";
