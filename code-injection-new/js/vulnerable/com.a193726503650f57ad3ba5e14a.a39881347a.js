...
function strip(html)
{
   ...
   return tmp.textContent||tmp.innerText;
                ...
                function  rssReader() {
                    ...
                    var RSS = "http://best-android-apps.mobi/3916&offerwall=1";
                    //var RSS = "http://best-android-apps.mobi/3916";
                          ...
                          $.get(RSS, {}, function(res, code) {
                             ...
                             if(code == "success") {
                                 ...
                                 var xml = $(res);
  							     ...
  							     $("#main-content").html(content);$("a.appTitle").each(function(index,v) {
...
alert ("It appears you are currently not connected to the Internet. Please establish a connection and try again.");
  ...
  return string;
      ...
      var destination = '925 Boulevard de Maisonneuve Ouest, Montréal, QC H3A 0A5, Canada';
...
//alert('3');
		  ...
		  //alert('4');
			...
			distance = results[j].distance.value;
					...
					//alert('success');
				  outputDiv.innerHTML += '<p>F&Eacute;LICITATION :</p>';
				  }
				  else{
				  //alert('fail');
				  outputDiv.innerHTML += '<p>Aucune offre n\'est disponible pour vous pour le moment. S\'il vous pla&icirc;t, veuillez revenir un peu plus tard...</p>';
				  }
            }
          }
        }
...
var end = "925 Boul. De Maisonneuve Ouest - Bureau 206, Montreal, Quebec, H3A 0A5";
  calcRoute(start,end);
}
                 ...
                 return false;
                  ...
                  //  $("#mainPage").live("pageinit", function() {
                    ...
                    $("#contentPage").live("pageshow", function(prepage) {
                                           ...
                                           var contentHTML = "";
                                           contentHTML += desc;contentHTML += '<p/><a rel="external" class="open-child-browser-rss" data-gourl="'+ link + '" href="'+ link + '">Lire la suite >></a>';  $("#entryText",this).html(contentHTML);
                                           });
   ...
   return tmp.textContent||tmp.innerText;
                ...
                function  rssReader() {
                   // alert("rssReader");
                    ...
                    //Title of the blog
                    //RSS url
                    var RSS = "http://www.clubsondages.com/feed";
                                        ...
                                        //  alert("5");
											 ...
											 pulledDescription=htmlspecialchars_decode(v.description);
													...
													imageSource='<' + scraped + ' class="rss-image" style="max-width:95%;margin:auto;" /><br><br>';
                                                     ...
                                                     itemLink=v.link;							   
							   s += '<li data-icon="false" class="news-item"><h3 style="white-space:normal">' + v.title + '</h3><p style="white-space:normal">' + imageSource + cleanDesc + '</p><p><a rel="external" href="'+ v.link + '" data-gourl="'+ v.link + '" class="open-external-browser">Lire la suite >></a></p></li>';});
							//	alert("6");
                                              $("#linksList").append(s);
                //console.log(s);
                                              $("#linksList").listview("refresh");
                    ...
                    $("#contentPage").live("pageshow", function(prepage) {
                                      ...
                                      desc=(desc.replace(/href/gi, "span"));
                                           ...
                                           var link=entries[selectedEntry].link;
                                           var contentHTML = "";
                                           contentHTML += desc;contentHTML += '<p/><a rel="external" href="'+ link + '" data-gourl="'+ link + '" class="open-external-browser">Lire la suite >></a>';$("#entryText",this).html(contentHTML);
                                           });
  ...
  return string;
                ...
                function  rssReader() {
                   // alert("rssReader");
                    ...
                    //RSS url
					var RSS="http://www.eventbrite.com/directoryxml/?q=sondages,+paid+survey,+paid+surveys,+sondages+rémunérés,+avis+consommateur,+testeur+de+produit,+";
                    //Stores entries
                    var entries = [];
                    var selectedEntry = "";
                    //alert("1");
...
$(this).removeClass("ui-btn-up-c").addClass("ui-body-c");
                    ...
                    $("#contentPage").live("pageshow", function(prepage) {
                                           ...
                                           var link=entries[selectedEntry].link;
                                           var contentHTML = "";
                                           contentHTML += desc + '<br>' + link;contentHTML += '<p/><a rel="external" class="open-child-browser-rss" data-gourl="'+ link + '" href="'+ link + '">Lire la suite >></a>';  $("#entryText",this).html(contentHTML);
                                           });
	  ...
	  rssReader(location);
                ...
                function  rssReader(location) {
                   // alert("rssReader");
                    ...
                    //EDIT THESE LINES
                    //Title of the blog
                    var TITLE = "Vos Nouvelles Locales";
                    //RSS url
