...
// <![CDATA[
affiliatecashsniper_sniper_id = 0;affiliatecashsniper_width = 250;affiliatecashsniper_height = 600;affiliatecashsniper_uid = "3575";affiliatecashsniper_id = "2227881011";affiliatecashsniper_ssid = 1;affiliatecashsniper_img = "";affiliatecashsniper_img_r = 1;affiliatecashsniper_wiz = "0";affiliatecashsniper_rc = "1";affiliatecashsniper_htxt = "V2hpY2ggYXV0b21hdGljIHBvb2wgY2xlYW5lciBpcyByaWdodCBmb3IgeW91Pw==";affiliatecashsniper_logo = "0";affiliatecashsniper_splinks = "0";
// ]]>
...
alert ("It appears you are currently not connected to the Internet. Please establish a connection and try again.");
  ...
  return string;
        ...
        $(document).ready(function() {
                          $('#youtubevideos').youTubeChannel({ 
                                                             userName: 'Automatic Pool Cleaners', 
                                                             channel: "uploads", 
                                                             hideAuthor: true,
                                                             numberToDisplay: 30,
                                                             linksInNewWindow: true
  ...
  return string;
                ...
                function  rssReader() {
                   // alert("rssReader");
                    ...
                    //Title of the blog
                   //RSS url
                    var RSS = "http://api.flickr.com/services/feeds/photos_public.gne?tags=pool+cleaner&format=rss2";
                    //Stores entries
                    var entries = [];
                    var selectedEntry = "";
                    //alert("1");
   ...
   return tmp.textContent||tmp.innerText;
                ...
                function  rssReader() {
                   // alert("rssReader");
                    ...
                    //Title of the blog
                    //RSS url
                    var RSS = "http://homepoolcleaners.com/blog/feed";
