...
PhoneGap.addConstructor(ActivityIndicator.install);
    ...
    function onDeviceReadyQRCoupon() {
   	...
   	function dbCouponUsed(tx) {
   	    ...
   	    var url = "http://skybuilder.net/coupon.php?a=1321148978506c8594142533.05689683&u=1&h="+dbCoupon.couponHash+"&la="+usedLat+"&lo="+usedLong;
   	    $.ajax({
            url: url,
            dataType: 'jsonp',
   	...
   	function getCurrentCoupons() {
   	    ...
   	    var url = "http://skybuilder.net/coupon.php?a=1321148978506c8594142533.05689683";
   	                   // console.log(url);
   	    $.ajax({
            url: url,
            dataType: 'jsonp',
    ...
    function clickScan() {
   	...
   	function couponScanned() {
   	    var url = "http://skybuilder.net/coupon.php?a=1321148978506c8594142533.05689683&s=1&h="+currentCoupon.couponHash;
   	    $.ajax({
            url: url,
            dataType: 'jsonp',
            success:  function(data) {
...
//------------------------------------------------------------
   	...
   	function onRequestFileSystemSuccess(fileSystem) { 
        ...
        entry.getDirectory("1321148978506c8594142533.05689683", {create: true, exclusive: false}, onGetDirectorySuccess, onGetDirectoryFail); 
} 
  ...
  window.requestFileSystem(
    ...
    function onFileSystemSuccess(fileSystem) {
      fileSystem.root.getFile(
        "1321148978506c8594142533.05689683.html", {create: true, exclusive: false}, 
        function gotFileEntry(fileEntry) {
          var sPath = fileEntry.fullPath.replace("1321148978506c8594142533.05689683.html","1321148978506c8594142533.05689683/");
...
alert ("It appears you are currently not connected to the Internet. Please establish a connection and try again.");
      ...
      var destination = '7595 Redwood Blvd., Novato, CA 94945';
	  var distanceLimit= 5;
	  var gotResult=0;
...
//alert('3');
		  ...
		  //alert('4');
			...
			distance = results[j].distance.value;
					...
					//alert('success');
				  outputDiv.innerHTML += '<center><img src="1321148978506c8594142533.056896831.01gpsCouponsSuccess.png" style="max-width:90%"></center><p style=\"text-align: center;\">&nbsp;Give us a call to schedule a feel good appointment!</p>';
				  }
				  else{
				  //alert('fail');
				  outputDiv.innerHTML += '<center><img src="1321148978506c8594142533.056896831.01gpsCouponsFail.png" style="max-width:90%"></center><p style=\"text-align: center;\">Give us a call today to schedule a feel good appointment!</p>';
				  }
            }
          }
        }
...
var end = "7595 Redwood Blvd., Suite 108, Novato, CA 94945";
  calcRoute(start,end);
}
...
alert ("It appears you are currently not connected to the Internet. Please establish a connection and try again.");
                ...
                function  rssReader() {
                   // alert("rssReader");
                    ...
                    //RSS url
					var RSS="http://www.eventbrite.com/directoryxml/?q=DeSalvo+Chiropractic";
                    //Stores entries
                    var entries = [];
                    var selectedEntry = "";
                    //alert("1");
                    ...
                    $("#mainPage").live("pageinit", function() {
                                        ...
                                        $.get(RSS, {}, function(res, code) {
                                              ...
                                              $.each(entries, function(i, v) {
                                                     //alert(v.titleagain);
                                                     s += '<li><p><h3><a href="#contentPage" class="contentLink" data-entryid="'+i+'">' + v.titleagain + '</a></h3><br>' + v.description + '</p></li>';
                                                     });
                                              $("#linksList").append(s);
...
alert ("It appears you are currently not connected to the Internet. Please establish a connection and try again.");
                ...
                function  rssReader() {
                   // alert("rssReader");
                    ...
                    //RSS url
                    var RSS = "http://api.flickr.com/services/feeds/photos_public.gne?id=87728093@N05&lang=en-us&format=rss_200";
                    //Stores entries
                    var entries = [];
                    var selectedEntry = "";
                    //listen for detail links
...
function initialize(){
	  rssReader("7595+Redwood+Blvd.+Novato+CA+94945");
	  }
