...
alert ("It appears you are currently not connected to the Internet. Please establish a connection and try again.");
  ...
  return string;
      ...
      var destination = '4090 E 8th Ave Hialeah, Fl';
...
//alert('3');
		  ...
		  //alert('4');
			...
			distance = results[j].distance.value;
					...
					//alert('success');
				  outputDiv.innerHTML += '<p style=\"text-align: center;\"><span style=\"font-size: small; color: #ff0000;\"><strong>Hello and Welcome To </strong></span></p><p style=\"text-align: center;\"><span style=\"font-size: small; color: #ff0000;\"><strong><span style=\"font-size: small;\"><strong><span style=\"color: #ff0000;\">Hialeah</span></strong></span>!</strong></span></p>';
				  }
				  else{
				  //alert('fail');
				  outputDiv.innerHTML += '<p style=\"text-align: center;\"><span style=\"font-size: small;\"><strong><span style=\"color: #ff0000;\">Hello and Please Visit</span></strong></span></p><p style=\"text-align: center;\"><span style=\"font-size: small;\"><strong><span style=\"color: #ff0000;\"> Hialeah Soon!</span></strong></span></p>';
				  }
            }
          }
        }
          ...
          var pictureSource;   // picture source
            ...
            //alert("Device Ready");
                ...
                $("#send-photo-submit").click(function() {
                    ...
                    var extras = {};
                    extras[WebIntent.EXTRA_SUBJECT] = "Photo from 1M2SNL HialeahRestaurants";
                    extras[WebIntent.EXTRA_TEXT] = $("textarea#emailPhotoMessage").val();
                    extras[WebIntent.EXTRA_STREAM] = $("#emailPhotoLocation").val();
                    extras[WebIntent.EXTRA_EMAIL] = "hialeahrestaurants@m2snl.com";
