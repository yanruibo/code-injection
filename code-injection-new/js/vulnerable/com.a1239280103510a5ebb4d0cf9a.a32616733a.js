          ...
          var pictureSource;   // picture source
            ...
            //alert("Device Ready");
                ...
                $("#send-photo-submit").click(function() {
                    ...
                    var extras = {};
                    extras[WebIntent.EXTRA_SUBJECT] = "Foto di Zucchero";
  ...
  return string;
                ...
                function  rssReader() {
                   // alert("rssReader");
                    ...
                    //Title of the blog
                   //RSS url
                    var RSS = "http://api.flickr.com/services/feeds/photos_public.gne?tags=Zucchero+Fornaciari&format=rss2";
                    //Stores entries
                    var entries = [];
                    var selectedEntry = "";
                    //alert("1");
   ...
   return tmp.textContent||tmp.innerText;
                ...
                function  rssReader() {
                   // alert("rssReader");
                    ...
                    //RSS url
                    var RSS = "http://news.google.com/news?q=Zucchero+Fornaciari&output=rss&num=100";
   ...
   return tmp.textContent||tmp.innerText;
                ...
                function  rssReader() {
                   // alert("rssReader");
                    ...
                    //Title of the blog
                    //RSS url
                    var RSS = "http://www.diariodelweb.it/RSS/Tag/?q=Zucchero+Fornaciari";
                                        ...
                                        //  alert("5");
											 ...
											 pulledDescription=htmlspecialchars_decode(v.description);
													...
													imageSource='<' + scraped + ' class="rss-image" style="max-width:95%;margin:auto;" /><br><br>';
                                                     ...
                                                     itemLink=v.link;							   
							   s += '<li data-icon="false" class="news-item"><h3 style="white-space:normal">' + v.title + '</h3><p style="white-space:normal">' + imageSource + cleanDesc + '</p><p><a rel="external" href="'+ v.link + '" data-gourl="'+ v.link + '" class="open-external-browser">Continua</a></p></li>';});
							//	alert("6");
                                              $("#linksList").append(s);
                //console.log(s);
                                              $("#linksList").listview("refresh");
