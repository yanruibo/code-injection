	    	...
	    	$(document).ready(function() {
			    ...
			    if(filename != "index.html" && filename != "more.html") {
					...
					function onDeviceReadyAdMob() {
					     ...
					     admob.createBannerView(
					         {
                                 'publisherId': 'ca-app-pub-6101814109861246/8148829645',
				...
				function killAdFailCallback() {
					...
					function onDeviceReadyAmazonAds() {amazonAdsPlugin.displayAds("32839f90d4fc482da1448dabd448b325",false,false,
		                    function(){},function(){}
                         );
						
							var filename = window.location.href.substr(window.location.href.lastIndexOf("/")+1);
			                if(filename == "index.html") {
								amazonAdsPlugin.displayInterstitial("32839f90d4fc482da1448dabd448b325",false,
						function(){},function(){}
						);
						}	}
...
if(screen.height>550){
        ...
        $(document).ready(function() {
            $.mobile.loading( "show", {
				...
				$("#rss-content").rssfeed("https://news.google.com/news?q=oakland+athletics+baseball+-mlb.com&output=rss&num=100", zRssOptions,
	                               function() {
	                                   $.mobile.loading("hide");
						               resizeRssImages();
	                               }
