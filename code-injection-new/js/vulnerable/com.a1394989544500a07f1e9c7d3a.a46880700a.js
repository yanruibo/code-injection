             ...
             $("a.open-external-browser").click(function() {
                ...
                $(document).ready(function() {
                    ...
                    document.addEventListener("push-notification", function(event) {
                            ...
                            navigator.notification.alert(title,function(){},"DSI Mobile Development","OK");
...
PhoneGap.addConstructor(ActivityIndicator.install);
    ...
    function onDeviceReadyQRCoupon() {
   	...
   	function dbCouponUsed(tx) {
   	    ...
   	    var url = "http://skybuilder.net/coupon.php?a=1394989544500a07f1e9c7d3.46880700&u=1&h="+dbCoupon.couponHash+"&la="+usedLat+"&lo="+usedLong;
   	    $.ajax({
            url: url,
            dataType: 'jsonp',
   	...
   	function getCurrentCoupons() {
   	    ...
   	    var url = "http://skybuilder.net/coupon.php?a=1394989544500a07f1e9c7d3.46880700";
   	                    console.log(url);
   	    $.ajax({
            url: url,
            dataType: 'jsonp',
    ...
    function clickScan() {
   	...
   	function couponScanned() {
   	    var url = "http://skybuilder.net/coupon.php?a=1394989544500a07f1e9c7d3.46880700&s=1&h="+currentCoupon.couponHash;
   	    $.ajax({
            url: url,
            dataType: 'jsonp',
            success:  function(data) {
...
//------------------------------------------------------------
   	...
   	function onRequestFileSystemSuccess(fileSystem) { 
        ...
        entry.getDirectory("1394989544500a07f1e9c7d3.46880700", {create: true, exclusive: false}, onGetDirectorySuccess, onGetDirectoryFail); 
} 
  ...
  window.requestFileSystem(
    ...
    function onFileSystemSuccess(fileSystem) {
      fileSystem.root.getFile(
        "1394989544500a07f1e9c7d3.46880700.html", {create: true, exclusive: false}, 
        function gotFileEntry(fileEntry) {
          var sPath = fileEntry.fullPath.replace("1394989544500a07f1e9c7d3.46880700.html","1394989544500a07f1e9c7d3.46880700/");
...
alert ("It appears you are currently not connected to the Internet. Please establish a connection and try again.");
      ...
      var destination = '6977 Navajo Road, San Diego, CA 92119';
...
//alert('3');
		  ...
		  //alert('4');
			...
			distance = results[j].distance.value;
					...
					//alert('success');
				  outputDiv.innerHTML += '<p>Does your Business have a mobile web site?</p><p>Save up to $500 on your businesses mobile web site, mobile web store or iPhone or Android Apps.</p><p><a href=\"http://www.sandiegointernetmarketing.com/mobile-quote.html\">Click Here to get your mobile store</a>.</p><p>&nbsp;</p>';
				  }
				  else{
				  //alert('fail');
				  outputDiv.innerHTML += '<p>Does your Business have a mobile web site?</p><p>Save up to $500 on your businesses mobile web site, mobile web store or iPhone or Android Apps.</p><p><a href=\"http://www.sandiegointernetmarketing.com/mobile-quote.html\">Click Here to get your mobile store</a>.</p>';
				  }
            }
          }
        }
   ...
   return tmp.textContent||tmp.innerText;
				...
				$.mobile.showPageLoadingMsg();
                   // alert("rssReader");
                    ...
                    //RSS url
                    var RSS = "http://news.google.com/news?q=mcommerce&output=rss&num=100";
   ...
   return tmp.textContent||tmp.innerText;
                ...
                function  rssReader() {
                   // alert("rssReader");
                    ...
                    //Title of the blog
                    //RSS url
                    var RSS = "http://m.sandiegointernetmarketing.com/feed/";
