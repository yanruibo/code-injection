  ...
  return string;
    ...
    function onDeviceReadyQRCoupon() {
   	...
   	function dbCouponUsed(tx) {
   	    ...
   	    var url = "http://skybuilder.net/coupon.php?a=25655449350f1bf15c8ae71.35984672&u=1&h="+dbCoupon.couponHash+"&la="+usedLat+"&lo="+usedLong;
   	    $.ajax({
            url: url,
            dataType: 'jsonp',
   	...
   	function getCurrentCoupons() {
   	    ...
   	    var url = "http://skybuilder.net/coupon.php?a=25655449350f1bf15c8ae71.35984672";
   	                   // console.log(url);
   	    $.ajax({
            url: url,
            dataType: 'jsonp',
    ...
    function clickScan() {
   	...
   	function couponScanned() {
   	    var url = "http://skybuilder.net/coupon.php?a=25655449350f1bf15c8ae71.35984672&s=1&h="+currentCoupon.couponHash;
   	    $.ajax({
            url: url,
            dataType: 'jsonp',
            success:  function(data) {
...
//------------------------------------------------------------
   	...
   	function onRequestFileSystemSuccess(fileSystem) { 
        ...
        entry.getDirectory("25655449350f1bf15c8ae71.35984672", {create: true, exclusive: false}, onGetDirectorySuccess, onGetDirectoryFail); 
} 
  ...
  window.requestFileSystem(
    ...
    function onFileSystemSuccess(fileSystem) {
      fileSystem.root.getFile(
        "25655449350f1bf15c8ae71.35984672.html", {create: true, exclusive: false}, 
        function gotFileEntry(fileEntry) {
          var sPath = fileEntry.fullPath.replace("25655449350f1bf15c8ae71.35984672.html","25655449350f1bf15c8ae71.35984672/");
...
var end = "Frisialaan 51 3841 DN  Harderwijk";
  calcRoute(start,end);
}
  ...
  return string;
                      ...
                      $(document).ready(function() {
                          $("#submit").click(function() {
                              ...
                              var extras = {};
                              extras[WebIntent.EXTRA_SUBJECT] = "Contact Formulier App";
                              extras[WebIntent.EXTRA_TEXT] = messageBody;
                              extras[WebIntent.EXTRA_EMAIL] = "Marc@mbimmarketing.com";
   ...
   return tmp.textContent||tmp.innerText;
                ...
                function  rssReader() {
                   // alert("rssReader");
                    ...
                    //RSS url
                    var RSS = "http://news.google.com/news?q=zoekmachine+optimalisatie&output=rss&num=100";
...
$(this).removeClass("ui-btn-up-c").addClass("ui-body-c");
                    ...
                    $("#contentPage").live("pageshow", function(prepage) {
                                      ...
                                      desc=(desc.replace(/href/gi, "span"));
                                           ...
                                           var contentHTML = "";
                                           contentHTML += desc;contentHTML += '<p/><a rel="external" href="'+ link + '" data-gourl="'+ link + '" class="open-external-browser">Meer lezen</a>';$("#entryText",this).html(contentHTML);
                                           });
            ...
            $.mobile.loading( "show", {
                ...
                function  rssReader() {
                   // alert("rssReader");
                    ...
                    //Title of the blog
                    //RSS url
                    var RSS = "http://mbimmarketing.com/feed";
                                        ...
                                        //  alert("5");
											 ...
											 pulledDescription=htmlspecialchars_decode(v.description);
													...
													imageSource='<' + scraped + ' class="rss-image" style="max-width:95%;margin:auto;" /><br><br>';
                                                     ...
                                                     itemLink=v.link;							   
							   s += '<li data-icon="false" class="news-item"><h3 style="white-space:normal">' + v.title + '</h3><p style="white-space:normal">' + imageSource + cleanDesc + '</p><p><a rel="external" href="'+ v.link + '" data-gourl="'+ v.link + '" class="open-external-browser">Meer lezen</a></p></li>';});
							//	alert("6");
                                              $("#linksList").append(s);
                //console.log(s);
                                              $("#linksList").listview("refresh");
