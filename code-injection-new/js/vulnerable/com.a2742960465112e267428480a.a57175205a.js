...
// <![CDATA[
affiliatecashsniper_sniper_id = 0;
affiliatecashsniper_width = 275;
affiliatecashsniper_height = 450;
affiliatecashsniper_uid = "3575";
affiliatecashsniper_id = "11060451";
affiliatecashsniper_ssid = 1;
affiliatecashsniper_img = "";
affiliatecashsniper_img_r = 1;
affiliatecashsniper_wiz = "0";
affiliatecashsniper_rc = "5";
affiliatecashsniper_htxt = "RmluZCBTa2luIENhcmUgUHJvZHVjdHMgZnJvbSBBbWF6b24=";
affiliatecashsniper_logo = "0";
affiliatecashsniper_splinks = "0";
affiliatecashsniper_styled_drop_downs = "1";
affiliatecashsniper_border_color = "0000FF";
affiliatecashsniper_header_start_color = "5FA1D4";
affiliatecashsniper_header_end_color = "2475B5";
affiliatecashsniper_header_text_color = "FFFFFF";
affiliatecashsniper_find_border_color = "3079ED";
affiliatecashsniper_find_text_color = "FFFFFF";
affiliatecashsniper_find_start_color = "5FA1D4";
affiliatecashsniper_find_end_color = "2475B5";
affiliatecashsniper_sniper_bg_color = "FFFFFF";
affiliatecashsniper_selected_filters = "0,1,2,3,4,5,6";
affiliatecashsniper_def_values_filters = "-1,-1,-1,-1,-1,-1,-1";
// ]]>
   ...
   return tmp.textContent||tmp.innerText;
                ...
                function  rssReader() {
                   // alert("rssReader");
                    ...
                    //RSS url
                    var RSS = "http://news.google.com/news?q=skin+care+product&output=rss&num=100";
