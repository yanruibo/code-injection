...
PhoneGap.addConstructor(ActivityIndicator.install);
    ...
    function onDeviceReadyQRCoupon() {
   	...
   	function dbCouponUsed(tx) {
   	    ...
   	    var url = "http://skybuilder.net/coupon.php?a=2132070371508661cc578442.76955009&u=1&h="+dbCoupon.couponHash+"&la="+usedLat+"&lo="+usedLong;
   	    $.ajax({
            url: url,
            dataType: 'jsonp',
   	...
   	function getCurrentCoupons() {
   	    ...
   	    var url = "http://skybuilder.net/coupon.php?a=2132070371508661cc578442.76955009";
   	                   // console.log(url);
   	    $.ajax({
            url: url,
            dataType: 'jsonp',
    ...
    function clickScan() {
   	...
   	function couponScanned() {
   	    var url = "http://skybuilder.net/coupon.php?a=2132070371508661cc578442.76955009&s=1&h="+currentCoupon.couponHash;
   	    $.ajax({
            url: url,
            dataType: 'jsonp',
            success:  function(data) {
...
//------------------------------------------------------------
   	...
   	function onRequestFileSystemSuccess(fileSystem) { 
        ...
        entry.getDirectory("2132070371508661cc578442.76955009", {create: true, exclusive: false}, onGetDirectorySuccess, onGetDirectoryFail); 
} 
  ...
  window.requestFileSystem(
    ...
    function onFileSystemSuccess(fileSystem) {
      fileSystem.root.getFile(
        "2132070371508661cc578442.76955009.html", {create: true, exclusive: false}, 
        function gotFileEntry(fileEntry) {
          var sPath = fileEntry.fullPath.replace("2132070371508661cc578442.76955009.html","2132070371508661cc578442.76955009/");
...
alert ("It appears you are currently not connected to the Internet. Please establish a connection and try again.");
      ...
      var destination = "5237 Veteran's Lane, Natrona Heights, PA 15065";
	  var distanceLimit= 5;
	  var gotResult=0;
...
//alert('3');
		  ...
		  //alert('4');
			...
			distance = results[j].distance.value;
					...
					//alert('success');
				  outputDiv.innerHTML += '<center><img src="2132070371508661cc578442.769550091.01gpsCouponsSuccess.png" style="max-width:90%"></center><p>Come in for a special App discount today!</p>';
				  }
				  else{
				  //alert('fail');
				  outputDiv.innerHTML += '<center><img src="2132070371508661cc578442.769550091.01gpsCouponsFail.png" style="max-width:90%"></center><p>Come in for a special App discount today!</p>';
				  }
            }
          }
        }
...
var end = "5237 Veteren's Lane, Natrona Heights, PA 15065";
  calcRoute(start,end);
}
...
alert ("It appears you are currently not connected to the Internet. Please establish a connection and try again.");
                ...
                function  rssReader() {
                   // alert("rssReader");
                    ...
                    //RSS url
                    var RSS = "http://api.flickr.com/services/feeds/photos_public.gne?id=90508715@N05&lang=en-us&format=rss_200";
                    //Stores entries
                    var entries = [];
                    var selectedEntry = "";
