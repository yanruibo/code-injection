...
alert ("It appears you are currently not connected to the Internet. Please establish a connection and try again.");
      ...
      var destination = '6B Chambers St Princeton, NJ 08542';
	  var distanceLimit= 2;
	  var gotResult=0;
...
//alert('3');
		  ...
		  //alert('4');
			...
			distance = results[j].distance.value;
					...
					//alert('success');
				  outputDiv.innerHTML += '<p style=\"text-align: center;\"><strong><span style=\"font-size: medium;\">You Can Get Some Great Deals today!</span></strong></p>';
				  }
				  else{
				  //alert('fail');
				  outputDiv.innerHTML += '<p style=\"text-align: center;\"><span style=\"font-size: medium;\"><strong>&nbsp;Come to Princeton for some Great Deals!</strong></span></p>';
				  }
            }
          }
        }
...
var end = "6B Chambers Street, Princeton, NJ 08542";
  calcRoute(start,end);
}
