	    	...
	    	$(document).ready(function() {
			    ...
			    if(filename != "index.html" && filename != "more.html") {
					...
					function onDeviceReadyAdMob() {
					     ...
					     admob.createBannerView(
					         {
                                 'publisherId': 'ca-app-pub-6101814109861246/5195363249',
				...
				function initFancyPush() {
    				...
    				pushNotification.registerDevice({alert:true, badge:true, sound:true, appid:"", appname:"CHC Baseball", gcmprojectid:"760995130526"},function(status) {},function(status) {});
				}
...
if(screen.height>550){
    				...
    				pushNotification.registerDevice({alert:true, badge:true, sound:true, appid:"", appname:"CHC Baseball", gcmprojectid:"760995130526"},function(status) {},function(status) {});
                      ...
                      $(document).ready(function() {
                          $("#contact-form-submit").click(function() {
                              ...
                              var extras = {};
                              extras[WebIntent.EXTRA_SUBJECT] = "Cubs App Contact Form";
        ...
        $(document).ready(function() {
            $.mobile.loading( "show", {
				...
				$("#rss-content").rssfeed("https://news.google.com/news?q=Chicago+Cubs+-mlb.com+-deadspin.com&output=rss&num=100", zRssOptions,
	                               function() {
	                                   $.mobile.loading("hide");
						               resizeRssImages();
	                               }
