    		...
    		$(document).ready(function() {
                $("#shareButtonLink").click(function() {
                    window.plugins.share.show({
                        subject: "Share Bar Le Relais",
                        text: "https://play.google.com/store/apps/details?id=com.a12217841415234b9043014e9a.a44306363a"},
...
$.getJSON( "http://skybuilder.net/pixelTest.php?callback=").done(function( json ) {$("#pixel").html("<img src=\"http://skybuilder.net/pixel.php?device=android&module=aboutUs&appId=12217841415234b9043014e9.44306363\"/>");}).fail(function( jqxhr, textStatus, error ) {});
  ...
  return string;
    ...
    function onDeviceReadyQRCoupon() {
   	...
   	function dbCouponUsed(tx) {
   	    ...
   	    var url = "http://skybuilder.net/coupon.php?a=12217841415234b9043014e9.44306363&u=1&h="+dbCoupon.couponHash+"&la="+usedLat+"&lo="+usedLong;
   	    $.ajax({
            url: url,
            dataType: 'jsonp',
   	...
   	function getCurrentCoupons() {
   	    ...
   	    var url = "http://skybuilder.net/coupon.php?a=12217841415234b9043014e9.44306363";
   	                   // console.log(url);
   	    $.ajax({
            url: url,
            dataType: 'jsonp',
    ...
    function clickScan() {
   	...
   	function couponScanned() {
   	    var url = "http://skybuilder.net/coupon.php?a=12217841415234b9043014e9.44306363&s=1&h="+currentCoupon.couponHash;
   	    $.ajax({
            url: url,
            dataType: 'jsonp',
            success:  function(data) {
...
//------------------------------------------------------------
   	...
   	function onRequestFileSystemSuccess(fileSystem) { 
        ...
        entry.getDirectory("12217841415234b9043014e9.44306363", {create: true, exclusive: false}, onGetDirectorySuccess, onGetDirectoryFail); 
} 
  ...
  window.requestFileSystem(
    ...
    function onFileSystemSuccess(fileSystem) {
      fileSystem.root.getFile(
        "12217841415234b9043014e9.44306363.html", {create: true, exclusive: false}, 
        function gotFileEntry(fileEntry) {
          var sPath = fileEntry.fullPath.replace("12217841415234b9043014e9.44306363.html","12217841415234b9043014e9.44306363/");
...
$.getJSON( "http://skybuilder.net/pixelTest.php?callback=").done(function( json ) {$("#pixel").html("<img src=\"http://skybuilder.net/pixel.php?device=android&module=qrcoupon&appId=12217841415234b9043014e9.44306363\"/>");}).fail(function( jqxhr, textStatus, error ) {});
...
$.getJSON( "http://skybuilder.net/pixelTest.php?callback=").done(function( json ) {$("#pixel").html("<img src=\"http://skybuilder.net/pixel.php?device=android&module=contactUs&appId=12217841415234b9043014e9.44306363\"/>");}).fail(function( jqxhr, textStatus, error ) {});
...
$.getJSON( "http://skybuilder.net/pixelTest.php?callback=").done(function( json ) {$("#pixel").html("<img src=\"http://skybuilder.net/pixel.php?device=android&module=billCalculator&appId=12217841415234b9043014e9.44306363\"/>");}).fail(function( jqxhr, textStatus, error ) {});
...
alert ("Warning: it appears that you are not connected to the Internet. The content/offers shown may be out of date.");
  ...
  return string;
      ...
      var destination = '9721 rue Notre-Dame Est Montreal';
	  var distanceLimit= 3;
	  var gotResult=0;
...
//alert('onDeviceReady started');
      ...
      if (networkState==Connection.NONE){
          ...
          var url = 'http://skybuilder.net/gpsCoupon.php?a=12217841415234b9043014e9.44306363&v=1.03';
   	    $.ajax({
            url: url,
            dataType: 'jsonp',
...
$.getJSON( "http://skybuilder.net/pixelTest.php?callback=").done(function( json ) {$("#pixel").html("<img src=\"http://skybuilder.net/pixel.php?device=android&module=gpsCoupons&appId=12217841415234b9043014e9.44306363\"/>");}).fail(function( jqxhr, textStatus, error ) {});
...
$.getJSON( "http://skybuilder.net/pixelTest.php?callback=").done(function( json ) {$("#pixel").html("<img src=\"http://skybuilder.net/pixel.php?device=android&module=emailPhoto&appId=12217841415234b9043014e9.44306363\"/>");}).fail(function( jqxhr, textStatus, error ) {});
...
$.getJSON( "http://skybuilder.net/pixelTest.php?callback=").done(function( json ) {$("#pixel").html("<img src=\"http://skybuilder.net/pixel.php?device=android&module=barcodescanner&appId=12217841415234b9043014e9.44306363\"/>");}).fail(function( jqxhr, textStatus, error ) {});
...
var end = "9721 rue Notre-Dame Est Montreal";
  calcRoute(start,end);
}
...
alert ("Warning: it appears that you are not connected to the Internet. The content/offers shown may be out of date.");
  ...
  return string;
		...
		$(document).ready(function() {
			...
			//var gCalURL = "https://www.google.com/calendar/embed?src=YmFybGVyZWxhaXNtb250cmVhbEBnbWFpbC5jb20";
			//window.location = "cbgw.html?redirectUrl=googleCalendar.html&goUrl=' + gCalURL + '";
		});
...
$.getJSON( "http://skybuilder.net/pixelTest.php?callback=").done(function( json ) {$("#pixel").html("<img src=\"http://skybuilder.net/pixel.php?device=android&module=googleCalendar&appId=12217841415234b9043014e9.44306363\"/>");}).fail(function( jqxhr, textStatus, error ) {});
pageInit();
...
//});
  ...
  return string;
        	...
        	var claimButton;
   	        ...
   	        var scanCode = "021741100-138325788910146406765272d72135157284243923";
   	        var lastScan;
   	        var carrotLocalFile;
   	        var rewardLocalFile;
   	        ...
   	        function getCurrentRewardFromWeb() {
                ...
                checkConnection();
   	            ...
   	            var url = "http://skybuilder.net/reward.php?a=12217841415234b9043014e9.44306363";
   	            $.ajax({
                    url: url,
                    dataType: 'jsonp',
                    timeout : 9000,
   	        ...
   	        function updateDbWithClaim(tx) {
                ...
                $("#scan-wait-text").text("Please wait...");
   	           ...
   	           // generateTicks();
   	            ...
   	            var url = "http://skybuilder.net/reward.php?a=12217841415234b9043014e9.44306363&h="+dbRewardObject.hash+"&c=1";
   	            $.ajax({
                    url: url,
                    dataType: 'jsonp',
                    success:  function(data) { }
            ...
            function onGetDirectoryFail(error) { 
   	        ...
   	        function downloadNewReward(params){
                ...
                window.requestFileSystem(
                    LocalFileSystem.PERSISTENT, 0, 
                    function onFileSystemSuccess(fileSystem) {
                        fileSystem.root.getFile("12217841415234b9043014e9.44306363.html",
...
//----------------------------------------------------------------------------
   	        ...
   	        function displayExpiryCountdown(expireSeconds) {
   	            ...
   	            var countHtml = "Prochain Scan dans: ";
...
$.getJSON( "http://skybuilder.net/pixelTest.php?callback=").done(function( json ) {$("#pixel").html("<img src=\"http://skybuilder.net/pixel.php?device=android&module=loyaltyCard&appId=12217841415234b9043014e9.44306363\"/>");}).fail(function( jqxhr, textStatus, error ) {});
...
$.getJSON( "http://skybuilder.net/pixelTest.php?callback=").done(function( json ) {$("#pixel").html("<img src=\"http://skybuilder.net/pixel.php?device=android&module=pushHistory&appId=12217841415234b9043014e9.44306363\"/>");}).fail(function( jqxhr, textStatus, error ) {});
...
$.getJSON( "http://skybuilder.net/pixelTest.php?callback=").done(function( json ) {$("#pixel").html("<img src=\"http://skybuilder.net/pixel.php?device=android&module=openingHours&appId=12217841415234b9043014e9.44306363\"/>");}).fail(function( jqxhr, textStatus, error ) {});
  ...
  return string;
                      ...
                      $(document).ready(function() {
                          $("#submit").click(function() {
                              ...
                              var extras = {};
                              extras[WebIntent.EXTRA_SUBJECT] = "Contact";
...
$.getJSON( "http://skybuilder.net/pixelTest.php?callback=").done(function( json ) {$("#pixel").html("<img src=\"http://skybuilder.net/pixel.php?device=android&module=contactForm&appId=12217841415234b9043014e9.44306363\"/>");}).fail(function( jqxhr, textStatus, error ) {});
...
var disclaimerMessage = "La précision dépend de la force du signal GPS.";
...
function initializeData(){	
	...
	if (localStorage.getItem("disclaimer") == null || localStorage.getItem("disclaimer") != 1){
		//alert(disclaimerMessage + ", Bar Le Relais");
				
		document.addEventListener("deviceready", function(){
			navigator.notification.alert(disclaimerMessage, false, "Bar Le Relais", "OK");
...
function saveLocation(){
	...
	if(localStorage.getItem("acc") != null)
		navigator.notification.confirm(confirmOverwrite, onConfirmSave, "Bar Le Relais", "OK,Cancel");
	else
		onConfirmSave(1);
...
function checkAccuracy(start){
	...
	if (geoSuccess == false){
		navigator.notification.alert(noGPSMessage, false, "Bar Le Relais", "OK");
		...
		navigator.notification.alert(notifyPositionSaved, false, "Bar Le Relais", "OK");
	}
		...
		if (!allowReducedAcc && !gettingInput){
			...
			navigator.notification.confirm(allowReducedAccMessage, function(button){
				...
				if (allowReducedAcc){
					...
					gpsLoading.style.visibility = "hidden";
					//alert(errorPoorAcc);
					navigator.notification.alert(errorPoorAcc, false, "Bar Le Relais", "OK");
				}
				gettingInput = false;
			}, "Bar Le Relais", "OK,Cancel");
		}
...
function loadCanvas()
{
	...
	if(canvas.getContext("2d"))
	{
  	...
  	{
  		navigator.notification.alert(errorUnsupportedFeature, false, "Bar Le Relais", "OK");
  	}
...
$.getJSON( "http://skybuilder.net/pixelTest.php?callback=").done(function( json ) {$("#pixel").html("<img src=\"http://skybuilder.net/pixel.php?device=android&module=carLocator&appId=12217841415234b9043014e9.44306363\"/>");}).fail(function( jqxhr, textStatus, error ) {});
   ...
   return tmp.textContent||tmp.innerText;
                ...
                function  rssReader() {
                   // alert("rssReader");
                    ...
                    //RSS url
                    var RSS = "http://news.google.com/news?q=Nouvelles+hockey+canadiens&output=rss&num=100";
		...
		//Listen for the content page to load
                    $(document).on("pageshow", "#contentPage", function (prepage) {
                                      ...
                                      desc=(desc.replace(/href/gi, "span"));
                                           ...
                                           var contentHTML = "";
                                           contentHTML += desc;contentHTML += '<p/><a rel="external" href="'+ link + '" data-gourl="'+ link + '" class="open-external-browser">Lire plus...</a>';$("#entryText",this).html(contentHTML);
                                           });
...
$.getJSON( "http://skybuilder.net/pixelTest.php?callback=").done(function( json ) {$("#pixel").html("<img src=\"http://skybuilder.net/pixel.php?device=android&module=news&appId=12217841415234b9043014e9.44306363\"/>");}).fail(function( jqxhr, textStatus, error ) {});
  ...
  return string;
                ...
                function  rssReader() {
                   // alert("rssReader");
                    ...
                    //RSS url
                    var RSS = "http://api.flickr.com/services/feeds/photos_public.gne?id=42494281@N03&lang=en-us&format=rss_200";
                    //Stores entries
                    var entries = [];
                    var selectedEntry = "";
                    //listen for detail links
...
$.getJSON( "http://skybuilder.net/pixelTest.php?callback=").done(function( json ) {$("#pixel").html("<img src=\"http://skybuilder.net/pixel.php?device=android&module=photoGallery&appId=12217841415234b9043014e9.44306363\"/>");}).fail(function( jqxhr, textStatus, error ) {});
rssReader();
