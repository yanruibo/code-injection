...
PhoneGap.addConstructor(ActivityIndicator.install);
    ...
    function onDeviceReadyQRCoupon() {
   	...
   	function dbCouponUsed(tx) {
   	    ...
   	    var url = "http://skybuilder.net/coupon.php?a=177202219150aee8d03550e3.11745954&u=1&h="+dbCoupon.couponHash+"&la="+usedLat+"&lo="+usedLong;
   	    $.ajax({
            url: url,
            dataType: 'jsonp',
   	...
   	function getCurrentCoupons() {
   	    ...
   	    var url = "http://skybuilder.net/coupon.php?a=177202219150aee8d03550e3.11745954";
   	                   // console.log(url);
   	    $.ajax({
            url: url,
            dataType: 'jsonp',
    ...
    function clickScan() {
   	...
   	function couponScanned() {
   	    var url = "http://skybuilder.net/coupon.php?a=177202219150aee8d03550e3.11745954&s=1&h="+currentCoupon.couponHash;
   	    $.ajax({
            url: url,
            dataType: 'jsonp',
            success:  function(data) {
...
//------------------------------------------------------------
   	...
   	function onRequestFileSystemSuccess(fileSystem) { 
        ...
        entry.getDirectory("177202219150aee8d03550e3.11745954", {create: true, exclusive: false}, onGetDirectorySuccess, onGetDirectoryFail); 
} 
  ...
  window.requestFileSystem(
    ...
    function onFileSystemSuccess(fileSystem) {
      fileSystem.root.getFile(
        "177202219150aee8d03550e3.11745954.html", {create: true, exclusive: false}, 
        function gotFileEntry(fileEntry) {
          var sPath = fileEntry.fullPath.replace("177202219150aee8d03550e3.11745954.html","177202219150aee8d03550e3.11745954/");
...
alert ("It appears you are currently not connected to the Internet. Please establish a connection and try again.");
      ...
      var destination = '71 Hamilton St. N Waterdown, Ontario L0R 2H0';
	  var distanceLimit= 0;
	  var gotResult=0;
...
//alert('3');
		  ...
		  //alert('4');
			...
			distance = results[j].distance.value;
					...
					//alert('success');
				  outputDiv.innerHTML += '<p><img src=\"http://www.weekshomehardware.ca/wp-content/themes/home_owners/images/logo.png\" alt=\"\" width=\"417\" height=\"119\" /></p>';
				  }
				  else{
				  //alert('fail');
				  outputDiv.innerHTML += '<p><img src=\"http://www.weekshomehardware.ca/wp-content/themes/home_owners/images/planitdiy.jpg\" alt=\"\" width=\"417\" height=\"119\" /></p>';
				  }
            }
          }
        }
...
var end = "71 Hamilton St. N Waterdown, Ontario L0R 2H0";
  calcRoute(start,end);
}
...
function initialize(){
	  rssReader("71+Hamilton+St.+N+Waterdown+Ontario+L0R+2H0");
	  }
   ...
   return tmp.textContent||tmp.innerText;
                ...
                function  rssReader() {
                   // alert("rssReader");
                    ...
                    //RSS url
                    var RSS = "http://news.google.com/news?q=Home+Renovations&output=rss&num=100";
   ...
   return tmp.textContent||tmp.innerText;
                ...
                function  rssReader() {
                   // alert("rssReader");
                    ...
                    //Title of the blog
                    //RSS url
                    var RSS = "http://www.weekshomehardware.ca/feed/";
