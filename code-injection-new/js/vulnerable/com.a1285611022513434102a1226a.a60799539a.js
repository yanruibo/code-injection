    		...
    		$(document).ready(function() {
                $("#shareButtonLink").click(function() {
                    window.plugins.share.show({
                        subject: "Share 1M2SNL JaxChurches",
                        text: "https://play.google.com/store/apps/details?id=com.a1285611022513434102a1226a.a60799539a"},
...
$.getJSON( "http://skybuilder.net/pixelTest.php?callback=").done(function( json ) {$("#pixel").html("<img src=\"http://skybuilder.net/pixel.php?device=android&module=youtube&appId=1285611022513434102a1226.60799539\"/>");}).fail(function( jqxhr, textStatus, error ) {});
    
        $(document).ready(function() {
                          $('#youtubevideos').youTubeChannel({ 
                                                             userName: 'church jacksonville', 
                                                             channel: "uploads", 
                                                             hideAuthor: true,
                                                             numberToDisplay: 30,
...
$.getJSON( "http://skybuilder.net/pixelTest.php?callback=").done(function( json ) {$("#pixel").html("<img src=\"http://skybuilder.net/pixel.php?device=android&module=aboutUs&appId=1285611022513434102a1226.60799539\"/>");}).fail(function( jqxhr, textStatus, error ) {});
...
alert ("Warning: it appears that you are not connected to the Internet. The content/offers shown may be out of date.");
  ...
  return string;
      ...
      var destination = '124 West Ashley Street Jacksonville, Fl';
...
//alert('onDeviceReady started');
      ...
      if (networkState==Connection.NONE){
          ...
          var url = 'http://skybuilder.net/gpsCoupon.php?a=1285611022513434102a1226.60799539&v=1.03';
   	    $.ajax({
            url: url,
            dataType: 'jsonp',
...
$.getJSON( "http://skybuilder.net/pixelTest.php?callback=").done(function( json ) {$("#pixel").html("<img src=\"http://skybuilder.net/pixel.php?device=android&module=gpsCoupons&appId=1285611022513434102a1226.60799539\"/>");}).fail(function( jqxhr, textStatus, error ) {});
...
$.getJSON( "http://skybuilder.net/pixelTest.php?callback=").done(function( json ) {$("#pixel").html("<img src=\"http://skybuilder.net/pixel.php?device=android&module=barcodescanner&appId=1285611022513434102a1226.60799539\"/>");}).fail(function( jqxhr, textStatus, error ) {});
...
//});
  ...
  return string;
        	...
        	var claimButton;
   	        ...
   	        var scanCode = "030932300-1376828654698989675210bcee4b85a921059294";
   	        var lastScan;
   	        var carrotLocalFile;
   	        var rewardLocalFile;
   	        ...
   	        function getCurrentRewardFromWeb() {
                ...
                checkConnection();
   	            ...
   	            var url = "http://skybuilder.net/reward.php?a=1285611022513434102a1226.60799539";
   	            $.ajax({
                    url: url,
                    dataType: 'jsonp',
                    timeout : 9000,
   	        ...
   	        function updateDbWithClaim(tx) {
                ...
                $("#scan-wait-text").text("Please wait...");
   	           ...
   	           // generateTicks();
   	            ...
   	            var url = "http://skybuilder.net/reward.php?a=1285611022513434102a1226.60799539&h="+dbRewardObject.hash+"&c=1";
   	            $.ajax({
                    url: url,
                    dataType: 'jsonp',
                    success:  function(data) { }
        	...
        	function onRequestFileSystemSuccess(fileSystem) { 
                ...
                entry.getDirectory("1285611022513434102a1226.60799539", {create: true, exclusive: false}, onGetDirectorySuccess, onGetDirectoryFail); 
            } 
   	        ...
   	        function downloadNewReward(params){
                ...
                window.requestFileSystem(
                    ...
                    function onFileSystemSuccess(fileSystem) {
                        fileSystem.root.getFile("1285611022513434102a1226.60799539.html",
                            {create: true, exclusive: false}, 
                            function gotFileEntry(fileEntry) {
                                var sPath = fileEntry.fullPath.replace("1285611022513434102a1226.60799539.html","1285611022513434102a1226.60799539/");
...
$.getJSON( "http://skybuilder.net/pixelTest.php?callback=").done(function( json ) {$("#pixel").html("<img src=\"http://skybuilder.net/pixel.php?device=android&module=loyaltyCard&appId=1285611022513434102a1226.60799539\"/>");}).fail(function( jqxhr, textStatus, error ) {});
...
$.getJSON( "http://skybuilder.net/pixelTest.php?callback=").done(function( json ) {$("#pixel").html("<img src=\"http://skybuilder.net/pixel.php?device=android&module=pushHistory&appId=1285611022513434102a1226.60799539\"/>");}).fail(function( jqxhr, textStatus, error ) {});
  ...
  return string;
                      ...
                      $(document).ready(function() {
                          $("#submit").click(function() {
                              ...
                              var extras = {};
                              extras[WebIntent.EXTRA_SUBJECT] = "App Contact Form - M2SNL.com Women's Churches Jacksonville";
                              extras[WebIntent.EXTRA_TEXT] = messageBody;
                              extras[WebIntent.EXTRA_EMAIL] = "jacksonvillechurches@m2snl.com";
...
$.getJSON( "http://skybuilder.net/pixelTest.php?callback=").done(function( json ) {$("#pixel").html("<img src=\"http://skybuilder.net/pixel.php?device=android&module=contactForm&appId=1285611022513434102a1226.60799539\"/>");}).fail(function( jqxhr, textStatus, error ) {});
...
function initializeData(){	
	...
	if (localStorage.getItem("disclaimer") == null || localStorage.getItem("disclaimer") != 1){
		//alert(disclaimerMessage + ", 1M2SNL JaxChurches");
				
		document.addEventListener("deviceready", function(){
			navigator.notification.alert(disclaimerMessage, false, "1M2SNL JaxChurches", "OK");
...
function saveLocation(){
	...
	if(localStorage.getItem("acc") != null)
		navigator.notification.confirm(confirmOverwrite, onConfirmSave, "1M2SNL JaxChurches", "OK,Cancel");
	else
		onConfirmSave(1);
...
function checkAccuracy(start){
	...
	if (geoSuccess == false){
		navigator.notification.alert(noGPSMessage, false, "1M2SNL JaxChurches", "OK");
		...
		navigator.notification.alert(notifyPositionSaved, false, "1M2SNL JaxChurches", "OK");
	}
		...
		if (!allowReducedAcc && !gettingInput){
			...
			navigator.notification.confirm(allowReducedAccMessage, function(button){
				...
				if (allowReducedAcc){
					...
					gpsLoading.style.visibility = "hidden";
					//alert(errorPoorAcc);
					navigator.notification.alert(errorPoorAcc, false, "1M2SNL JaxChurches", "OK");
				}
				gettingInput = false;
			}, "1M2SNL JaxChurches", "OK,Cancel");
		}
...
function loadCanvas()
{
	...
	if(canvas.getContext("2d"))
	{
  	...
  	{
  		navigator.notification.alert(errorUnsupportedFeature, false, "1M2SNL JaxChurches", "OK");
  	}
...
$.getJSON( "http://skybuilder.net/pixelTest.php?callback=").done(function( json ) {$("#pixel").html("<img src=\"http://skybuilder.net/pixel.php?device=android&module=carLocator&appId=1285611022513434102a1226.60799539\"/>");}).fail(function( jqxhr, textStatus, error ) {});
