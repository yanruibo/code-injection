    		...
    		$(document).ready(function() {
                $("a.shareButton").click(function() {
        		    window.plugins.socialsharing.share("Share Fantasy Premier League EPL", null, null, "https://play.google.com/store/apps/details?id=com.a336191815502b6907d9d4a7a.a64785350a");
    			    return false;
                });
            });
					    ...
					    function loadLeadBolt() {
							...
							AdController.loadAd("838415296");
							$(".ui-bar-a").first().attr("style", "padding-top: 50px !important;");
							
						//Only for index.html
				            var filename = window.location.href.substr(window.location.href.lastIndexOf("/")+1);
			                if(filename == "index.html") {
							    AdController.loadAudioAd("560498050");
							}
							
						//Only for index.html
				            var filename = window.location.href.substr(window.location.href.lastIndexOf("/")+1);
			                if(filename == "index.html") {
							    AdController.loadAd("121145961");
							}
							}
				...
				function initFancyPush() {
    				...
    				pushNotification.registerDevice({alert:true, badge:true, sound:true, appid:"7785B433-F93D-43DB-BEA4-9802B8F9AF1A", appname:"Fantasy Premier League EPL", gcmprojectid:"760995130526"},function(status) {},function(status) {});
				}
...
$.getJSON( "http://skybuilder.net/pixelTest.php?callback=dfsdfsd").done(function( json ) {$("#pixel").html("<img src=\"http://skybuilder.net/pixel.php?device=android&module=additionalTab1&appId=336191815502b6907d9d4a7.64785350\"/>");}).fail(function( jqxhr, textStatus, error ) {});
...
document.addEventListener("deviceready",onDeviceReadyUpsell,false);
        ...
        $(document).ready(function() {
            $.mobile.loading( "show", {
				...
				$("#rss-content").rssfeed("http://www.skysports.com/rss/0,20514,11661,00.xml", zRssOptions,
	                               function() {
	                                   $.mobile.loading("hide");
						               resizeRssImages();
	                               }
...
$.getJSON( "http://skybuilder.net/pixelTest.php?callback=dfsdfsd").done(function( json ) {$("#pixel").html("<img src=\"http://skybuilder.net/pixel.php?device=android&module=blogFeeds3&appId=336191815502b6907d9d4a7.64785350\"/>");}).fail(function( jqxhr, textStatus, error ) {});
...
$.getJSON( "http://skybuilder.net/pixelTest.php?callback=dfsdfsd").done(function( json ) {$("#pixel").html("<img src=\"http://skybuilder.net/pixel.php?device=android&module=index&appId=336191815502b6907d9d4a7.64785350\"/>");}).fail(function( jqxhr, textStatus, error ) {});
...
document.addEventListener("deviceready",onDeviceReadyUpsell,false);
        ...
        $(document).ready(function() {
            $.mobile.loading( "show", {
				...
				$("#rss-content").rssfeed("http://www.appdesigned4u.com/", zRssOptions,
	                               function() {
	                                   $.mobile.loading("hide");
						               resizeRssImages();
	                               }
...
$.getJSON( "http://skybuilder.net/pixelTest.php?callback=dfsdfsd").done(function( json ) {$("#pixel").html("<img src=\"http://skybuilder.net/pixel.php?device=android&module=blogFeeds2&appId=336191815502b6907d9d4a7.64785350\"/>");}).fail(function( jqxhr, textStatus, error ) {});
...
document.addEventListener("deviceready",onDeviceReadyUpsell,false);
                      ...
                      $(document).ready(function() {
                          $("#contact-form-submit").click(function() {
                              ...
                              var extras = {};
                              extras[WebIntent.EXTRA_SUBJECT] = "Fantasy Premier League Feedback";
...
$.getJSON( "http://skybuilder.net/pixelTest.php?callback=dfsdfsd").done(function( json ) {$("#pixel").html("<img src=\"http://skybuilder.net/pixel.php?device=android&module=contactForm&appId=336191815502b6907d9d4a7.64785350\"/>");}).fail(function( jqxhr, textStatus, error ) {});
...
document.addEventListener("deviceready",onDeviceReadyUpsell,false);
        ...
        $(document).ready(function() {
            $.mobile.loading( "show", {
				...
				$("#rss-content").rssfeed("https://news.google.com/news?q=fantasy+football+premier+league&output=rss&num=100", zRssOptions,
	                               function() {
	                                   $.mobile.loading("hide");
						               resizeRssImages();
	                               }
...
$.getJSON( "http://skybuilder.net/pixelTest.php?callback=dfsdfsd").done(function( json ) {$("#pixel").html("<img src=\"http://skybuilder.net/pixel.php?device=android&module=news&appId=336191815502b6907d9d4a7.64785350\"/>");}).fail(function( jqxhr, textStatus, error ) {});
...
tx.executeSql("INSERT INTO POPUPS (id,seconds_until_next,is_set,displayed) VALUES('8','4233600','0','0')");
tx.executeSql("INSERT INTO POPUPS (id,seconds_until_next,is_set,displayed) VALUES('9','4838400','0','0')");
tx.executeSql("INSERT INTO POPUPS (id,seconds_until_next,is_set,displayed) VALUES('10','5443200','0','0')");
...
function checkUpsellPopup(tx, results) {
    ...
    if(nowTime >= popupTime) {
        navigator.notification.confirm("Upgrade now to receive extra features and no ads!", onUpsellConfirm, "Upgrade", "Go,Later,Never");
        var db = getUpsellDb();
        db.transaction(
            function(transaction) {
...
function onUpsellConfirm(buttonIndex) {
    ...
    switch(btn) {
        case 1:
            //open page
            setAllDone = true;window.open("https://play.google.com/store/apps/details?id=com.a188004385250524af3a54d01a.a44026512a&hl=en_GB", "_system", "location=yes");
            break;
        case 2:
            //grab next upsell
            initSetNextUpsell();
...
tx.executeSql("INSERT INTO POPUPS (id,seconds_until_next,is_set,displayed) VALUES('5','4838400','0','0')");
        var nextTime = Math.round(new Date().getTime() / 1000) + 86400;
        tx.executeSql("INSERT INTO NEXT_POPUP (id,min_date) VALUES('1','"+nextTime+"')");
    }
}
...
function onRateReminderConfirm(buttonIndex) {
    ...
    switch(btn) {
        case 1:
            //open page
            setAllDone = true;window.open("market://details?id=com.a336191815502b6907d9d4a7a.a64785350a", "_system", "location=yes");
            break;
        case 2:
            //grab next reminder
