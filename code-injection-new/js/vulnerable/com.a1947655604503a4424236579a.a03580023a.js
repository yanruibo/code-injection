             ...
             $("a.open-external-browser").click(function() {
                ...
                $(document).ready(function() {
                    ...
                    document.addEventListener("push-notification", function(event) {
                            ...
                            navigator.notification.alert(title,function(){},"What Is Real Estate","OK");
   ...
   return tmp.textContent||tmp.innerText;
				...
				$.mobile.showPageLoadingMsg();
                   // alert("rssReader");
                    ...
                    //RSS url
                    var RSS = "http://news.google.com/news?q=what+is+real+estate+real+estate+Investment+Real++Real+Estate+Investor+Home+Sell+Selling+A+House+Houses+For+Sale&output=rss&num=100";
   ...
   return tmp.textContent||tmp.innerText;
                ...
                function  rssReader() {
                   // alert("rssReader");
                    ...
                    //Title of the blog
                    //RSS url
                    var RSS = "http://ESHORTTERMLOAN.INFO/feed/";
...
alert ("It appears you are currently not connected to the Internet. Please establish a connection and try again.");
                ...
                function  rssReader() {
                   // alert("rssReader");
                    ...
                    //RSS url
					var RSS="http://www.eventbrite.com/directoryxml/?q=what+is+real+estate+real+estate+Investment+Real++Real+Estate+Investor+Home+Sell+Selling+A+House+Houses+For+Sale";
                    //Stores entries
                    var entries = [];
                    var selectedEntry = "";
                    //alert("1");
