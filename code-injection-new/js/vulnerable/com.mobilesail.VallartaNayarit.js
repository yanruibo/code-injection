            ...
            $(function(){
                var _lastRImgIndex = 0;
                
                var _lastRImgIndexTemp = getCookie('lastRImgIndex');
                
                if(isset(_lastRImgIndexTemp)) _lastRImgIndex = parseInt(_lastRImgIndexTemp);
                
                if(_lastRImgIndex >= 4) _lastRImgIndex = 1; else _lastRImgIndex = _lastRImgIndex + 1;  
                
                setCookie('lastRImgIndex', _lastRImgIndex, 100);
                
                $('#RImg').attr('src', 'VallartaNayarit/img/rotating' + _lastRImgIndex + '.png');
            ...
            $(function(){
                ...
                $('.uimainbody').css('background-image', 'url("VallartaNayarit/img/rotating' + _lastRImgIndex + '.png")');
                
            });
            
            $(document).bind("mobileinit", function(){
                
                //$('.ui-Main-Body').css('background-image', 'url("VallartaNayarit/img/rotating' + _lastRImgIndex + '.png")');
