    		...
    		$(document).ready(function() {
                $("#shareButtonLink").click(function() {
                    window.plugins.share.show({
                        subject: "Share HBSC",
                        text: "https://play.google.com/store/apps/details?id=com.a1855448548510031767cb631a.a50227414a"},
...
var end = "Longsight Road, Ramsbottom, BL0 9TD";
  calcRoute(start,end);
}
            ...
            $.mobile.loading( "show", {
                ...
                function  rssReader() {
                   // alert("rssReader");
                    ...
                    //Title of the blog
                    //RSS url
                    var RSS = "http://newsrss.bbc.co.uk/rss/sportonline_uk_edition/tennis/rss.xml";
            ...
            $.mobile.loading( "show", {
                ...
                function  rssReader() {
                   // alert("rssReader");
                    ...
                    //Title of the blog
                    //RSS url
                    var RSS = "http://hbsc1926.blogspot.co.uk/feeds/posts/default?alt=rss";
