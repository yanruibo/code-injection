	    	...
	    	$(document).ready(function() {
				...
				function initFancyPush() {
    				...
    				pushNotification.registerDevice({alert:true, badge:true, sound:true, appid:"376497DC-2AEB-4613-A7D7-A76DAD5CB7EE", appname:"Hurry-Up", gcmprojectid:"760995130526"},function(status) {},function(status) {});
				}
...
$(document).ready(function(){
    $.ajax({
        ...
        $("#pixel").html("<img src=\"http://skybuilder.net/pixel.php?device=android&module=additionalTab1&appId=13091034951af6af0ee1c37.75867694\"/>");
        $("#pixel").hide();
    }).fail(function(error){
...
$(document).ready(function(){
    $.ajax({
        ...
        $("#pixel").html("<img src=\"http://skybuilder.net/pixel.php?device=android&module=aboutUs&appId=13091034951af6af0ee1c37.75867694\"/>");
        $("#pixel").hide();
    }).fail(function(error){
        console.log("pixel fail");
        console.log(error.statusText);
...
$(document).ready(function(){
    $.ajax({
        ...
        $("#pixel").html("<img src=\"http://skybuilder.net/pixel.php?device=android&module=contactUs&appId=13091034951af6af0ee1c37.75867694\"/>");
        $("#pixel").hide();
    }).fail(function(error){
        console.log("pixel fail");
        console.log(error.statusText);
...
$(document).ready(function(){
    $.ajax({
        ...
        $("#pixel").html("<img src=\"http://skybuilder.net/pixel.php?device=android&module=additionalTab3&appId=13091034951af6af0ee1c37.75867694\"/>");
        $("#pixel").hide();
    }).fail(function(error){
        console.log("pixel fail");
        console.log(error.statusText);
          ...
          var pictureSource;   // picture source
            ...
            function onDeviceReadyCamera() {
                ...
                $("#send-photo-submit").click(function() {
                    ...
                    extras[WebIntent.EXTRA_EMAIL] = "info@hurry.up.nl";
...
$(document).ready(function(){
    $.ajax({
        ...
        $("#pixel").html("<img src=\"http://skybuilder.net/pixel.php?device=android&module=emailPhoto&appId=13091034951af6af0ee1c37.75867694\"/>");
        $("#pixel").hide();
    }).fail(function(error){
        console.log("pixel fail");
        console.log(error.statusText);
...
$(document).ready(function(){
    $.ajax({
        ...
        $("#pixel").html("<img src=\"http://skybuilder.net/pixel.php?device=android&module=barcodescanner&appId=13091034951af6af0ee1c37.75867694\"/>");
        $("#pixel").hide();
    }).fail(function(error){
        console.log("pixel fail");
        console.log(error.statusText);
...
$(document).ready(function(){
    $.ajax({
        ...
        $("#pixel").html("<img src=\"http://skybuilder.net/pixel.php?device=android&module=index&appId=13091034951af6af0ee1c37.75867694\"/>");
        $("#pixel").hide();
    }).fail(function(error){
        console.log("pixel fail");
        console.log(error.statusText);
...
$(document).ready(function(){
    $.ajax({
        ...
        $("#pixel").html("<img src=\"http://skybuilder.net/pixel.php?device=android&module=additionalTab4&appId=13091034951af6af0ee1c37.75867694\"/>");
        $("#pixel").hide();
    }).fail(function(error){
        console.log("pixel fail");
        console.log(error.statusText);
    				...
    				pushNotification.registerDevice({alert:true, badge:true, sound:true, appid:"376497DC-2AEB-4613-A7D7-A76DAD5CB7EE", appname:"Hurry-Up", gcmprojectid:"760995130526"},function(status) {},function(status) {});
                      ...
                      $(document).ready(function() {
                          $("#contact-form-submit").click(function() {
                              ...
                              var extras = {};
                              extras[WebIntent.EXTRA_SUBJECT] = "aanmeldformulier via de app";
...
$(document).ready(function(){
    $.ajax({
        ...
        $("#pixel").html("<img src=\"http://skybuilder.net/pixel.php?device=android&module=contactForm&appId=13091034951af6af0ee1c37.75867694\"/>");
        $("#pixel").hide();
    }).fail(function(error){
        console.log("pixel fail");
        console.log(error.statusText);
...
$(document).ready(function(){
    $.ajax({
        ...
        $("#pixel").html("<img src=\"http://skybuilder.net/pixel.php?device=android&module=additionalTab2&appId=13091034951af6af0ee1c37.75867694\"/>");
        $("#pixel").hide();
    }).fail(function(error){
        console.log("pixel fail");
        console.log(error.statusText);
