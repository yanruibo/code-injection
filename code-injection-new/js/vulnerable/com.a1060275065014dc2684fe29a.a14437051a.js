             ...
             $("a.open-external-browser").click(function() {
                ...
                $(document).ready(function() {
                    ...
                    document.addEventListener("push-notification", function(event) {
                            ...
                            navigator.notification.alert(title,function(){},"ArcticMed allt om Omega3","OK");
...
PhoneGap.addConstructor(ActivityIndicator.install);
    ...
    function onDeviceReadyQRCoupon() {
   	...
   	function dbCouponUsed(tx) {
   	    ...
   	    var url = "http://skybuilder.net/coupon.php?a=1060275065014dc2684fe29.14437051&u=1&h="+dbCoupon.couponHash+"&la="+usedLat+"&lo="+usedLong;
   	    $.ajax({
            url: url,
            dataType: 'jsonp',
   	...
   	function getCurrentCoupons() {
   	    ...
   	    var url = "http://skybuilder.net/coupon.php?a=1060275065014dc2684fe29.14437051";
   	                    console.log(url);
   	    $.ajax({
            url: url,
            dataType: 'jsonp',
    ...
    function clickScan() {
   	...
   	function couponScanned() {
   	    var url = "http://skybuilder.net/coupon.php?a=1060275065014dc2684fe29.14437051&s=1&h="+currentCoupon.couponHash;
   	    $.ajax({
            url: url,
            dataType: 'jsonp',
            success:  function(data) {
...
//------------------------------------------------------------
   	...
   	function onRequestFileSystemSuccess(fileSystem) { 
        ...
        entry.getDirectory("1060275065014dc2684fe29.14437051", {create: true, exclusive: false}, onGetDirectorySuccess, onGetDirectoryFail); 
} 
  ...
  window.requestFileSystem(
    ...
    function onFileSystemSuccess(fileSystem) {
      fileSystem.root.getFile(
        "1060275065014dc2684fe29.14437051.html", {create: true, exclusive: false}, 
        function gotFileEntry(fileEntry) {
          var sPath = fileEntry.fullPath.replace("1060275065014dc2684fe29.14437051.html","1060275065014dc2684fe29.14437051/");
...
alert ("It appears you are currently not connected to the Internet. Please establish a connection and try again.");
      ...
      var destination = 'Lidalsbacken 7, 51158 Kinna, sweden';
...
//alert('3');
		  ...
		  //alert('4');
			...
			distance = results[j].distance.value;
					...
					//alert('success');
				  outputDiv.innerHTML += '<h1><span style=\"color: #0000ff; font-family: verdana, geneva;\"><strong><span style=\"background-color: #ffffff;\"><span style=\"background-color: #ffffff;\">V&auml;lkommen till Kinna!</span></span></strong></span></h1><p><span style=\"background-color: #ffffff;\"><span style=\"color: #ff0000;\"><span style=\"color: #000000;\"><span style=\"background-color: #ff0000;\"><strong>10% rabatt</strong></span> p&aring; ArcticMed Omega-3 Premium n&auml;r</span></span> du kommer f&ouml;rbi och handlar direkt hos oss!</span></p><p>Arctic Health AB &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; Lidalsbacken 7&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;&nbsp; 511 58 Kinna</p><p>031-360 88 40</p>';
				  }
				  else{
				  //alert('fail');
				  outputDiv.innerHTML += '<p><span style=\"font-size: small;\"><span style=\"font-size: medium;\"><strong>H&auml;lsa p&aring; hos oss i Kinna!</strong></span><strong> H&auml;r dyker det upp olika erbjudanden n&auml;r du n&auml;rmar dig v&aring;rt Kinna kontor</strong></span></p>';
				  }
            }
          }
        }
...
var end = "Lidalsbacken 7, 51158 Kinna";
  calcRoute(start,end);
}
...
function calcRoute(start,end){
  ...
  directionsService.route(request, function(result, status) {
    ...
    $(window).load(function() {
        $(".ui-page").css("background","transparent url(Default.png)");
   ...
   return tmp.textContent||tmp.innerText;
				...
				$.mobile.showPageLoadingMsg();
                   // alert("rssReader");
                    ...
                    //RSS url
                    var RSS = "http://news.google.com/news?q=Omega-3+fatty+acid+ratio+omega-6+Omega-3+index&output=rss";
				 ...
				 s += '<li style="white-space:normal;word-wrap: break-word;">' + articleImage + '<h2 style="white-space:normal;word-wrap: break-word;">' + articleTitle + '</h2><p style="white-space:normal;word-wrap: break-word;">' + articleSource + ' - ' + articleBody + '</p><p><a rel="external" href="' + articleLink + '" data-gourl="'+ articleLink + '" class="open-external-browser">Read Entry On Site</a></p></li>';});
                    ...
                    $("#contentPage").live("pageshow", function(prepage) {
                                      ...
                                      desc=(desc.replace(/href/gi, "span"));
                                           ...
                                           var contentHTML = "";
                                           contentHTML += desc;contentHTML += '<p/><a rel="external" href="'+ link + '" data-gourl="'+ link + '" class="open-external-browser">Read Entry on Site</a>';$("#entryText",this).html(contentHTML);
                                           });
   ...
   return tmp.textContent||tmp.innerText;
                ...
                function  rssReader() {
                   // alert("rssReader");
                    ...
                    //Title of the blog
                    //RSS url
                    var RSS = "http://blogg.passagen.se/sannaehdin/feed/entries/rss";
                                        ...
                                        //  alert("5");
											 ...
											 pulledDescription=v.description;
													...
													imageSource='<' + scraped + ' style="max-width:80%;"><br><br>';
                                                     ...
                                                     itemLink=v.link;							   
							   s += '<li data-icon="false"><h3 style="white-space:normal">' + v.title + '</h3><p style="white-space:normal">' + imageSource + cleanDesc + '</p><p><a rel="external" href="'+ v.link + '" data-gourl="'+ v.link + '" class="open-external-browser">Read Entry on Site</a></p></li>';});
							//	alert("6");
                                              $("#linksList").append(s);
                                              $("#linksList").listview("refresh");
                                              });
