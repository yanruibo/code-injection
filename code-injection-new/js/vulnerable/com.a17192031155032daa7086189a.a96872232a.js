             ...
             $("a.open-external-browser").click(function() {
                ...
                $(document).ready(function() {
                    ...
                    document.addEventListener("push-notification", function(event) {
                            ...
                            navigator.notification.alert(title,function(){},"Dinner Recipe","OK");
   ...
   return tmp.textContent||tmp.innerText;
				...
				$.mobile.showPageLoadingMsg();
                   // alert("rssReader");
                    ...
                    //RSS url
                    var RSS = "http://news.google.com/news?q=dinner+recipes+recipe+dinner+recipe+easy+recipes+quick+recipe&output=rss&num=100";
