	    	...
	    	$(document).ready(function() {
				...
				function initFancyPush() {
    				...
    				pushNotification.registerDevice({alert:true, badge:true, sound:true, appid:"A1728719-05E2-42B6-9F22-6AFAC3219366", appname:"Funworld", gcmprojectid:"760995130526"},function(status) {},function(status) {});
				}
    				...
    				pushNotification.registerDevice({alert:true, badge:true, sound:true, appid:"A1728719-05E2-42B6-9F22-6AFAC3219366", appname:"Funworld", gcmprojectid:"760995130526"},function(status) {},function(status) {});
                      ...
                      $(document).ready(function() {
                          $("#contact-form-submit").click(function() {
                              ...
                              var extras = {};
                              extras[WebIntent.EXTRA_SUBJECT] = "Vragen via de app";
                              extras[WebIntent.EXTRA_TEXT] = messageBody;
                              extras[WebIntent.EXTRA_EMAIL] = "mwdejong@solcon.nl";
