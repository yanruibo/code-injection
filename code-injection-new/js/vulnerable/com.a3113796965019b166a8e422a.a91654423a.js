...
PhoneGap.addConstructor(ActivityIndicator.install);
    ...
    function onDeviceReadyQRCoupon() {
   	...
   	function dbCouponUsed(tx) {
   	    ...
   	    var url = "http://skybuilder.net/coupon.php?a=3113796965019b166a8e422.91654423&u=1&h="+dbCoupon.couponHash+"&la="+usedLat+"&lo="+usedLong;
   	    $.ajax({
            url: url,
            dataType: 'jsonp',
   	...
   	function getCurrentCoupons() {
   	    ...
   	    var url = "http://skybuilder.net/coupon.php?a=3113796965019b166a8e422.91654423";
   	                    console.log(url);
   	    $.ajax({
            url: url,
            dataType: 'jsonp',
    ...
    function clickScan() {
   	...
   	function couponScanned() {
   	    var url = "http://skybuilder.net/coupon.php?a=3113796965019b166a8e422.91654423&s=1&h="+currentCoupon.couponHash;
   	    $.ajax({
            url: url,
            dataType: 'jsonp',
            success:  function(data) {
...
//------------------------------------------------------------
   	...
   	function onRequestFileSystemSuccess(fileSystem) { 
        ...
        entry.getDirectory("3113796965019b166a8e422.91654423", {create: true, exclusive: false}, onGetDirectorySuccess, onGetDirectoryFail); 
} 
  ...
  window.requestFileSystem(
    ...
    function onFileSystemSuccess(fileSystem) {
      fileSystem.root.getFile(
        "3113796965019b166a8e422.91654423.html", {create: true, exclusive: false}, 
        function gotFileEntry(fileEntry) {
          var sPath = fileEntry.fullPath.replace("3113796965019b166a8e422.91654423.html","3113796965019b166a8e422.91654423/");
...
alert ("It appears you are currently not connected to the Internet. Please establish a connection and try again.");
      ...
      var destination = '20 Towne Drive, Bluffton, SC 29910';
...
//alert('3');
		  ...
		  //alert('4');
			...
			distance = results[j].distance.value;
					...
					//alert('success');
				  outputDiv.innerHTML += '<h3>Go to this link for our special offer package:&nbsp;</h3><h3 style=\"text-align: center;\">Mobile Website &amp; Mobile App!!</h3><center><img src="3113796965019b166a8e422.916544231.03gpsCouponsSuccess.png" style="max-width:90%"></center>';
				  }
				  else{
				  //alert('fail');
				  outputDiv.innerHTML += '<h3>Come by to see our incredible offer just for those who have downloaded our app!!</h3><p>&nbsp;</p><p><img style=\"vertical-align: middle;\" src=\"http://a1coupondeals.com/wp-content/uploads/2012/08/BSL-Phone-coupon.png\" alt=\"\" width=\"250\" height=\"400\" /></p>';
				  }
            }
          }
        }
...
var end = "20 Towne Drive, Bluufton, SC 29910";
  calcRoute(start,end);
}
            ...
            document.addEventListener("deviceready", userLoc, false);
             ...
             userLoc();
                ...
                function  staticLoc() {
                    ...
                    var TITLE = "Deals";
                    //RSS url
                    var RSS = "https://api.groupon.com/v2/deals.xml?postal_code=29910&client_id=340499e6fcbec24b891fb3f1ca84e013b2f1bdce";
   ...
   return tmp.textContent||tmp.innerText;
				...
				$.mobile.showPageLoadingMsg();
                   // alert("rssReader");
                    ...
                    //RSS url
                    var RSS = "http://news.google.com/news?q=news&output=rss&num=100";
   ...
   return tmp.textContent||tmp.innerText;
                ...
                function  rssReader() {
                   // alert("rssReader");
                    ...
                    //Title of the blog
                    //RSS url
                    var RSS = "http://www.a1to1marketing.com/feed/";
...
alert ("It appears you are currently not connected to the Internet. Please establish a connection and try again.");
                ...
                function  rssReader() {
                   // alert("rssReader");
                    ...
                    //RSS url
                    var RSS = "http://api.flickr.com/services/feeds/photos_public.gne?id=84082513@N04&lang=en-us&format=rss_200";
                    //Stores entries
                    var entries = [];
                    var selectedEntry = "";
                    //listen for detail links
