...
alert ("It appears you are currently not connected to the Internet. Please establish a connection and try again.");
  ...
  return string;
      ...
      var destination = '1410 E Las Olas Blvd Fort Lauderdale, Fl';
...
//alert('3');
		  ...
		  //alert('4');
			...
			distance = results[j].distance.value;
					...
					//alert('success');
				  outputDiv.innerHTML += '<p style=\"text-align: center;\"><span style=\"font-size: small; color: #ff0000;\"><strong>Hello and Please Visit </strong></span></p><p style=\"text-align: center;\"><span style=\"font-size: small; color: #ff0000;\"><strong>Ft Lauderdale Soon!</strong></span></p>';
				  }
				  else{
				  //alert('fail');
				  outputDiv.innerHTML += '<p style=\"text-align: center;\"><strong><span style=\"color: #ff0000;\">Hello and Please Visit Ft Lauderdale Soon!</span></strong></p>';
				  }
            }
          }
        }
          ...
          var pictureSource;   // picture source
            ...
            //alert("Device Ready");
                ...
                $("#send-photo-submit").click(function() {
                    ...
                    var extras = {};
                    extras[WebIntent.EXTRA_SUBJECT] = "Photo from 1M2SNL FtLauderdaleRestaurants";
                    extras[WebIntent.EXTRA_TEXT] = $("textarea#emailPhotoMessage").val();
                    extras[WebIntent.EXTRA_STREAM] = $("#emailPhotoLocation").val();
                    extras[WebIntent.EXTRA_EMAIL] = "ftlauderdalerestaurants@m2snl.com";
