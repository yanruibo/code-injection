...
var end = "N Shoreline Blvd Corpus Christi, TX 78401";
  calcRoute(start,end);
}
            ...
            document.addEventListener("deviceready", userLoc, false);
             ...
             userLoc();
                ...
                function  staticLoc() {
                    ...
                    var TITLE = "Deals";
                    //RSS url
                    var RSS = "https://api.groupon.com/v2/deals.xml?postal_code=78401&client_id=340499e6fcbec24b891fb3f1ca84e013b2f1bdce";
...
function initialize(){
	  rssReader("Corpus+Christi+Texas");
	  }
...
alert ("It appears you are currently not connected to the Internet. Please establish a connection and try again.");
                ...
                function  rssReader() {
                   // alert("rssReader");
                    ...
                    //Title of the blog
                   //RSS url
                    var RSS = "http://api.flickr.com/services/feeds/photos_public.gne?tags=Corpus+Christi+Texas&format=rss2";
                    //Stores entries
                    var entries = [];
                    var selectedEntry = "";
                    //alert("1");
   ...
   return tmp.textContent||tmp.innerText;
                ...
                function  rssReader() {
                   // alert("rssReader");
                    ...
                    //Title of the blog
                    //RSS url
                    var RSS = "http://rss.weather.com/weather/rss/local/USTX0294?cm_ven=LWO&cm_cat=rss&par=LWO_rss";
