    		...
    		$(document).ready(function() {
                $("#shareButtonLink").click(function() {
                    window.plugins.share.show({
                        subject: "Share Best e Cigarettes US",
                        text: "https://play.google.com/store/apps/details?id=com.a10100712145102e4d9c8f029a.a65856410a"},
            ...
            $.mobile.loading( "show", {
                ...
                function  rssReader() {
                   // alert("rssReader");
                    ...
                    //Title of the blog
                    //RSS url
                    var RSS = "http://news.google.com/news/feeds?hl=en&gl=us&q=e-cigarette+price&um=1&ie=UTF-8&output=rss";
  ...
  return string;
    ...
    function onDeviceReadyQRCoupon() {
   	...
   	function dbCouponUsed(tx) {
   	    ...
   	    var url = "http://skybuilder.net/coupon.php?a=10100712145102e4d9c8f029.65856410&u=1&h="+dbCoupon.couponHash+"&la="+usedLat+"&lo="+usedLong;
   	    $.ajax({
            url: url,
            dataType: 'jsonp',
   	...
   	function getCurrentCoupons() {
   	    ...
   	    var url = "http://skybuilder.net/coupon.php?a=10100712145102e4d9c8f029.65856410";
   	                   // console.log(url);
   	    $.ajax({
            url: url,
            dataType: 'jsonp',
    ...
    function clickScan() {
   	...
   	function couponScanned() {
   	    var url = "http://skybuilder.net/coupon.php?a=10100712145102e4d9c8f029.65856410&s=1&h="+currentCoupon.couponHash;
   	    $.ajax({
            url: url,
            dataType: 'jsonp',
            success:  function(data) {
...
//------------------------------------------------------------
   	...
   	function onRequestFileSystemSuccess(fileSystem) { 
        ...
        entry.getDirectory("10100712145102e4d9c8f029.65856410", {create: true, exclusive: false}, onGetDirectorySuccess, onGetDirectoryFail); 
} 
  ...
  window.requestFileSystem(
    ...
    function onFileSystemSuccess(fileSystem) {
      fileSystem.root.getFile(
        "10100712145102e4d9c8f029.65856410.html", {create: true, exclusive: false}, 
        function gotFileEntry(fileEntry) {
          var sPath = fileEntry.fullPath.replace("10100712145102e4d9c8f029.65856410.html","10100712145102e4d9c8f029.65856410/");
          ...
          var pictureSource;   // picture source
            ...
            //alert("Device Ready");
                ...
                $("#send-photo-submit").click(function() {
                    ...
                    var extras = {};
                    extras[WebIntent.EXTRA_SUBJECT] = "Photo from Best e Cigarettes US";
            ...
            $.mobile.loading( "show", {
                ...
                function  rssReader() {
                   // alert("rssReader");
                    ...
                    //Title of the blog
                    //RSS url
                    var RSS = "http://www.vipelectroniccigarette.co.uk/blog/category/e-cigarette-news/feed/";
...
function onRateReminderConfirm(buttonIndex) {
    ...
    switch(btn) {
        case 1:
            //open page
            setAllDone = true;window.plugins.childBrowser.openExternal("market://details?id=com.a10100712145102e4d9c8f029a.a65856410a");;
            break;
        case 2:
            //grab next reminder
            ...
            $.mobile.loading( "show", {
                ...
                function  rssReader() {
                   // alert("rssReader");
                    ...
                    //Title of the blog
                    //RSS url
                    var RSS = "http://news.google.com/news/feeds?hl=en&gs_rn=1&gs_ri=serp&tok=vvZ0Zc4TBZhmgnV_A7EoLw&ds=n&pq=best+e+cigarettes&cp=20&gs_id=d&xhr=t&q=best+e+cigarettes+us&gl=us&bav=on.2,or.r_gc.r_pw.r_cp.r_qf.&bvm=bv.41524429,d.d2k&biw=1920&bih=912&um=1&ie=UTF-8&output=rss";
  ...
  return string;
                ...
                function  rssReader() {
                   // alert("rssReader");
                    ...
                    //Title of the blog
                   //RSS url
                    var RSS = "http://api.flickr.com/services/feeds/photos_public.gne?tags=e-cigarette&format=rss2";
                    //Stores entries
                    var entries = [];
                    var selectedEntry = "";
                    //alert("1");
...
function initializeData(){	
	...
	if (localStorage.getItem("disclaimer") == null || localStorage.getItem("disclaimer") != 1){
		//alert(disclaimerMessage + ", Best e Cigarettes US");
				
		document.addEventListener("deviceready", function(){
			navigator.notification.alert(disclaimerMessage, false, "Best e Cigarettes US", "OK");
...
function saveLocation(){
	...
	if(localStorage.getItem("acc") != null)
		navigator.notification.confirm(confirmOverwrite, onConfirmSave, "Best e Cigarettes US", "OK,Cancel");
	else
		onConfirmSave(1);
...
function checkAccuracy(start){
	...
	if (geoSuccess == false){
		navigator.notification.alert(noGPSMessage, false, "Best e Cigarettes US", "OK");
		...
		navigator.notification.alert(notifyPositionSaved, false, "Best e Cigarettes US", "OK");
	}
		...
		if (!allowReducedAcc && !gettingInput){
			...
			navigator.notification.confirm(allowReducedAccMessage, function(button){
				...
				if (allowReducedAcc){
					...
					gpsLoading.style.visibility = "hidden";
					//alert(errorPoorAcc);
					navigator.notification.alert(errorPoorAcc, false, "Best e Cigarettes US", "OK");
				}
				gettingInput = false;
			}, "Best e Cigarettes US", "OK,Cancel");
		}
...
function loadCanvas()
{
	...
	if(canvas.getContext("2d"))
	{
  	...
  	{
  		navigator.notification.alert(errorUnsupportedFeature, false, "Best e Cigarettes US", "OK");
  	}
   ...
   return tmp.textContent||tmp.innerText;
                ...
                function  rssReader() {
                   // alert("rssReader");
                    ...
                    //RSS url
                    var RSS = "http://news.google.com/news?q=Best+e-cigarette&output=rss&num=100";
            ...
            $.mobile.loading( "show", {
                ...
                function  rssReader() {
                   // alert("rssReader");
                    ...
                    //Title of the blog
                    //RSS url
                    var RSS = "http://electroniccigarettereport.net/feed/";
