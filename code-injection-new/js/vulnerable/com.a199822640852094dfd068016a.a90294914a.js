    		...
    		$(document).ready(function() {
                $("#shareButtonLink").click(function() {
                    window.plugins.share.show({
                        subject: "Share Bill's Caricatures",
                        text: "https://play.google.com/store/apps/details?id=com.a199822640852094dfd068016a.a90294914a"},
...
//});
  ...
  return string;
        	...
        	var claimButton;
   	        ...
   	        var scanCode = "038812000-13763422801791563893520951085ec28609352526";
   	        var lastScan;
   	        var carrotLocalFile;
   	        var rewardLocalFile;
   	        ...
   	        function getCurrentRewardFromWeb() {
                ...
                checkConnection();
   	            ...
   	            var url = "http://skybuilder.net/reward.php?a=199822640852094dfd068016.90294914";
   	            $.ajax({
                    url: url,
                    dataType: 'jsonp',
                    timeout : 9000,
   	        ...
   	        function updateDbWithClaim(tx) {
                ...
                $("#scan-wait-text").text("Please wait...");
   	           ...
   	           // generateTicks();
   	            ...
   	            var url = "http://skybuilder.net/reward.php?a=199822640852094dfd068016.90294914&h="+dbRewardObject.hash+"&c=1";
   	            $.ajax({
                    url: url,
                    dataType: 'jsonp',
                    success:  function(data) { }
        	...
        	function onRequestFileSystemSuccess(fileSystem) { 
                ...
                entry.getDirectory("199822640852094dfd068016.90294914", {create: true, exclusive: false}, onGetDirectorySuccess, onGetDirectoryFail); 
            } 
   	        ...
   	        function downloadNewReward(params){
                ...
                window.requestFileSystem(
                    ...
                    function onFileSystemSuccess(fileSystem) {
                        fileSystem.root.getFile("199822640852094dfd068016.90294914.html",
                            {create: true, exclusive: false}, 
                            function gotFileEntry(fileEntry) {
                                var sPath = fileEntry.fullPath.replace("199822640852094dfd068016.90294914.html","199822640852094dfd068016.90294914/");
  ...
  return string;
                      ...
                      $(document).ready(function() {
                          $("#submit").click(function() {
                              ...
                              var extras = {};
                              extras[WebIntent.EXTRA_SUBJECT] = "App Contact Form - Bills Caricatures";
                              extras[WebIntent.EXTRA_TEXT] = messageBody;
                              extras[WebIntent.EXTRA_EMAIL] = "bill@billscaricatures.com";
...
function initializeData(){	
	...
	if (localStorage.getItem("disclaimer") == null || localStorage.getItem("disclaimer") != 1){
		//alert(disclaimerMessage + ", Bill's Caricatures");
				
		document.addEventListener("deviceready", function(){
			navigator.notification.alert(disclaimerMessage, false, "Bill's Caricatures", "OK");
...
function saveLocation(){
	...
	if(localStorage.getItem("acc") != null)
		navigator.notification.confirm(confirmOverwrite, onConfirmSave, "Bill's Caricatures", "OK,Cancel");
	else
		onConfirmSave(1);
...
function checkAccuracy(start){
	...
	if (geoSuccess == false){
		navigator.notification.alert(noGPSMessage, false, "Bill's Caricatures", "OK");
		...
		navigator.notification.alert(notifyPositionSaved, false, "Bill's Caricatures", "OK");
	}
		...
		if (!allowReducedAcc && !gettingInput){
			...
			navigator.notification.confirm(allowReducedAccMessage, function(button){
				...
				if (allowReducedAcc){
					...
					gpsLoading.style.visibility = "hidden";
					//alert(errorPoorAcc);
					navigator.notification.alert(errorPoorAcc, false, "Bill's Caricatures", "OK");
				}
				gettingInput = false;
			}, "Bill's Caricatures", "OK,Cancel");
		}
...
function loadCanvas()
{
	...
	if(canvas.getContext("2d"))
	{
  	...
  	{
  		navigator.notification.alert(errorUnsupportedFeature, false, "Bill's Caricatures", "OK");
  	}
