	    	...
	    	$(document).ready(function() {
				...
				function initFancyPush() {
    				...
    				pushNotification.registerDevice({alert:true, badge:true, sound:true, appid:"1FAB2550-397B-4F0E-90F6-6572F7A39CAC", appname:"MV Moves", gcmprojectid:"760995130526"},function(status) {},function(status) {});
				}
    ...
    function onDeviceReadyQRCoupon() {
   	...
   	function dbCouponUsed(tx) {
   	    ...
   	    var url = "http://skybuilder.net/coupon.php?a=196527664850a232a0d5afd2.72061822&u=1&h="+dbCoupon.couponHash+"&la="+usedLat+"&lo="+usedLong;
   	    $.ajax({
            url: url,
            dataType: 'jsonp',
   	...
   	function getCurrentCoupons() {
   	    ...
   	    var url = "http://skybuilder.net/coupon.php?a=196527664850a232a0d5afd2.72061822";
   	                   // console.log(url);
   	    $.ajax({
            url: url,
            dataType: 'jsonp',
    ...
    function clickScan() {
   	...
   	function couponScanned() {
   	    var url = "http://skybuilder.net/coupon.php?a=196527664850a232a0d5afd2.72061822&s=1&h="+currentCoupon.couponHash;
   	    $.ajax({
            url: url,
            dataType: 'jsonp',
            success:  function(data) {
...
//------------------------------------------------------------
   	...
   	function onRequestFileSystemSuccess(fileSystem) {
        ...
        entry.getDirectory("196527664850a232a0d5afd2.72061822", {create: true, exclusive: false}, onGetDirectorySuccess, onGetDirectoryFail);
}
  ...
  window.requestFileSystem(
    ...
    function onFileSystemSuccess(fileSystem) {
      fileSystem.root.getFile(
        "196527664850a232a0d5afd2.72061822.html", {create: true, exclusive: false},
        function gotFileEntry(fileEntry) {
          var sPath = fileEntry.fullPath.replace("196527664850a232a0d5afd2.72061822.html","196527664850a232a0d5afd2.72061822/");
...
if(screen.height>550){
    				...
    				pushNotification.registerDevice({alert:true, badge:true, sound:true, appid:"1FAB2550-397B-4F0E-90F6-6572F7A39CAC", appname:"MV Moves", gcmprojectid:"760995130526"},function(status) {},function(status) {});
                      ...
                      $(document).ready(function() {
                          $("#contact-form-submit").click(function() {
                              ...
                              var extras = {};
                              extras[WebIntent.EXTRA_SUBJECT] = "Contact formulier via de app";
        ...
        $(document).ready(function() {
            $.mobile.loading( "show", {
				...
				$("#rss-content").rssfeed("https://news.google.com/news?q=sport+nederland&output=rss&num=100", zRssOptions,
	                               function() {
	                                   $.mobile.loading("hide");
						               resizeRssImages();
	                               }
        ...
        $(document).ready(function() {
            $.mobile.loading( "show", {
				...
				$("#rss-content").rssfeed("http://gezondheid.blog.nl/feed", zRssOptions,
	                               function() {
	                                   $.mobile.loading("hide");
						               resizeRssImages();
	                               }
        ...
        $(document).ready(function() {
            $.mobile.loading( "show", {
				...
				$("#rss-content").rssfeed("https://api.flickr.com/services/feeds/photos_public.gne?id=90498847@N04&lang=en-us&format=rss_200", zRssOptions,
	                               function() {
	                                   $.mobile.loading("hide");
						               resizeRssImages();
	                               }
