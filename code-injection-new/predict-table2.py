...
def cv_crnn(method, frequency, normalization, k_folds, log_tag, lstm_num):
    ...
    log_file = "log_cv_" + log_tag + "_" + method + "_frequency_" + str(frequency) + "_normalization_" \
        + str(normalization) + "_crnn_" + otherStyleTime + "_table2_" + str(lstm_num)
    ...
    for i in range(k_folds):
        ...
        model.add(LSTM(output_dim=lstm_num, activation='sigmoid'))
...
if __name__ == '__main__':
    ...
    cv_crnn(method="infogain_five_add", frequency=False, normalization=False, k_folds=5, log_tag="",lstm_num=50)
    cv_crnn(method="infogain_five_add", frequency=False, normalization=False, k_folds=5, log_tag="",lstm_num=100)
    cv_crnn(method="infogain_five_add", frequency=False, normalization=False, k_folds=5, log_tag="",lstm_num=150)
    cv_crnn(method="infogain_five_add", frequency=False, normalization=False, k_folds=5, log_tag="",lstm_num=200)
    cv_crnn(method="infogain_five_add", frequency=False, normalization=False, k_folds=5, log_tag="",lstm_num=250)
    cv_crnn(method="infogain_five_add", frequency=False, normalization=False, k_folds=5, log_tag="",lstm_num=300)
    cv_crnn(method="infogain_five_add", frequency=False, normalization=False, k_folds=5, log_tag="",lstm_num=350)
    cv_crnn(method="infogain_five_add", frequency=False, normalization=False, k_folds=5, log_tag="",lstm_num=400)
    cv_crnn(method="infogain_five_add", frequency=False, normalization=False, k_folds=5, log_tag="",lstm_num=450)
    cv_crnn(method="infogain_five_add", frequency=False, normalization=False, k_folds=5, log_tag="",lstm_num=500)
    cv_crnn(method="infogain_five_add", frequency=False, normalization=False, k_folds=5, log_tag="",lstm_num=550)
    cv_crnn(method="infogain_five_add", frequency=False, normalization=False, k_folds=5, log_tag="",lstm_num=600)
