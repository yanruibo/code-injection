...
def batchDecode(method):
    ...
    if(method == 'original'):
        ...
        savedatadir = "/home/yanruibo/code-injection/process-info/normal/normal.dat"
        ...
        savedatadir = "/home/yanruibo/code-injection/process-info/normal/normal-infogain.dat"
    
    elif(method == 'chi'): 
        #chi
        functions = config.functions_chi    
        savedatadir = "/home/yanruibo/code-injection/process-info/normal/normal-chi.dat"
    
    elif(method == 'allinfogain'): 
        #chi
        functions = config.function_all_infogain    
        savedatadir = "/home/yanruibo/code-injection/process-info/normal/normal-allinfogain.dat"
    
    elif(method == 'allchi'): 
        #chi
        functions = config.function_all_chi
        savedatadir = "/home/yanruibo/code-injection/process-info/normal/normal-allchi.dat"
    ...
    fu = open("/home/yanruibo/code-injection/process-info/normal/normal-peprocessed-unscess-"+str(method), "w")
    # fz = open("/home/yanruibo/code-injection/process-info/normal/normal-peprocessed-uzip-info.txt","w")
    
    dirname = "/home/yanruibo/code-injection/normal-apks"
    #apknames = os.listdir(dirname)
    apknames = get_function_list("./dataset/train_normal");
    print "len apknames",len(apknames)
    apknames.extend(get_function_list("./dataset/test_normal"))
    print "len apknames",len(apknames)
    ...
    for apkname in apknames:
        ...
        tmp = os.popen('aapt dump permissions /home/yanruibo/code-injection/normal-apks/' + apkname+".apk").read()
        # fz.write(tmp)
        # print tmp
        ...
        freadjs = open(normal_js_dir+apkname+".js")
...
if __name__ == "__main__":
    ...
    ft = open("/home/yanruibo/code-injection/process-info/normal/normal-peprocessed-total-time-"+method, "w")
