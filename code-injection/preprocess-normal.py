...
def batchDecodeNormal():
    
    fu = open("/home/yanruibo/code-injection/process-info/normal/normal-peprocessed-info-unscess.txt","w")
    
    dirname = "/home/yanruibo/code-injection/normal-apks"
    apknames = os.listdir(dirname)
    function_dict = {}
    ff = open("/home/yanruibo/code-injection/process-info/normal/normal.dat","a")
    for item in apknames:
        #packagename = item[:-4]
        #解析AndroidManifest.xml 获取权限信息
        tmp = os.popen('aapt dump permissions /home/yanruibo/code-injection/normal-apks/'+item).read()
        ...
        os.system("unzip -o -d "+"/home/yanruibo/code-injection/normal-decoded-apks/"+item[:-4]+" /home/yanruibo/code-injection/normal-apks/"+item)
        rootDir = "/home/yanruibo/code-injection/normal-decoded-apks/"+item[:-4]
...
if __name__ == "__main__":
    ...
    ft = open("/home/yanruibo/code-injection/process-info/normal/normal-peprocessed-info-total_time.txt","w")
