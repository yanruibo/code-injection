...
def batchDecode():
    ...
    fu = open("/home/yanruibo/code-injection/process-info/normal/normal-peprocessed-info-unscess-bag.txt", "w")
    ...
    ff = open("/home/yanruibo/code-injection/process-info/normal/normal-bag.dat", "a")
    counter = 0
    for apkname in apknames:
        ...
        tmp = os.popen('aapt dump permissions /home/yanruibo/code-injection/normal-apks/' + apkname).read()
        #fz.write(tmp)
...
if __name__ == "__main__":
    ...
    ft = open("/home/yanruibo/code-injection/process-info/normal/normal-peprocessed-info-bag-total-time.txt", "w")
